...
/*    */ 
/*    */ public class LNPBonusInfoSet extends SchemaSet
/*    */ {
/*    */   public boolean add(LNPBonusInfoSchema aSchema)
/*    */   {
/* 17 */     return super.add(aSchema);
/*    */   }
/*    */ 
/*    */   public boolean add(LNPBonusInfoSet aSet)
/*    */   {
/* 22 */     return super.add(aSet);
/*    */   }
/*    */ 
/*    */   public boolean remove(LNPBonusInfoSchema aSchema)
/*    */   {
/* 27 */     return super.remove(aSchema);
/*    */   }
/*    */ 
/*    */   public LNPBonusInfoSchema get(int index)
/*    */   {
/* 32 */     LNPBonusInfoSchema tSchema = (LNPBonusInfoSchema)super.getObj(index);
/* 33 */     return tSchema;
/*    */   }
/*    */ 
/*    */   public boolean set(int index, LNPBonusInfoSchema aSchema)
/*    */   {
/* 38 */     return super.set(index, aSchema);
/*    */   }
/*    */ 
/*    */   public boolean set(LNPBonusInfoSet aSet)
/*    */   {
...
/*    */     {
/* 53 */       LNPBonusInfoSchema aSchema = get(i);
...
/* 68 */     while (nEndPos != -1)
/*    */     {
/* 70 */       LNPBonusInfoSchema aSchema = new LNPBonusInfoSchema();
...
/*    */       }
/*    */     }
/* 84 */     LNPBonusInfoSchema tSchema = new LNPBonusInfoSchema();
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.vschema.LNPBonusInfoSet
