...
/*    */ 
/*    */ public class LNPRiskRelaSet extends SchemaSet
/*    */ {
/*    */   public boolean add(LNPRiskRelaSchema aSchema)
/*    */   {
/* 17 */     return super.add(aSchema);
/*    */   }
/*    */ 
/*    */   public boolean add(LNPRiskRelaSet aSet)
/*    */   {
/* 22 */     return super.add(aSet);
/*    */   }
/*    */ 
/*    */   public boolean remove(LNPRiskRelaSchema aSchema)
/*    */   {
/* 27 */     return super.remove(aSchema);
/*    */   }
/*    */ 
/*    */   public LNPRiskRelaSchema get(int index)
/*    */   {
/* 32 */     LNPRiskRelaSchema tSchema = (LNPRiskRelaSchema)super.getObj(index);
/* 33 */     return tSchema;
/*    */   }
/*    */ 
/*    */   public boolean set(int index, LNPRiskRelaSchema aSchema)
/*    */   {
/* 38 */     return super.set(index, aSchema);
/*    */   }
/*    */ 
/*    */   public boolean set(LNPRiskRelaSet aSet)
/*    */   {
...
/*    */     {
/* 53 */       LNPRiskRelaSchema aSchema = get(i);
...
/* 68 */     while (nEndPos != -1)
/*    */     {
/* 70 */       LNPRiskRelaSchema aSchema = new LNPRiskRelaSchema();
...
/*    */       }
/*    */     }
/* 84 */     LNPRiskRelaSchema tSchema = new LNPRiskRelaSchema();
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.vschema.LNPRiskRelaSet
