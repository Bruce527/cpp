...
/*    */ 
/*    */ public class LAComSet extends SchemaSet
/*    */ {
/*    */   public boolean add(LAComSchema aSchema)
/*    */   {
/* 19 */     return super.add(aSchema);
/*    */   }
/*    */ 
/*    */   public boolean add(LAComSet aSet)
/*    */   {
/* 24 */     return super.add(aSet);
/*    */   }
/*    */ 
/*    */   public boolean remove(LAComSchema aSchema)
/*    */   {
/* 29 */     return super.remove(aSchema);
/*    */   }
/*    */ 
/*    */   public LAComSchema get(int index)
/*    */   {
/* 34 */     LAComSchema tSchema = (LAComSchema)super.getObj(index);
/* 35 */     return tSchema;
/*    */   }
/*    */ 
/*    */   public boolean set(int index, LAComSchema aSchema)
/*    */   {
/* 40 */     return super.set(index, aSchema);
/*    */   }
/*    */ 
/*    */   public boolean set(LAComSet aSet)
/*    */   {
...
/* 70 */     while (nEndPos != -1)
/*    */     {
/* 72 */       LAComSchema aSchema = new LAComSchema();
...
/*    */     }
/* 83 */     LAComSchema tSchema = new LAComSchema();
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.vschema.LAComSet
