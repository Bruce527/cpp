...
/*  31 */     this.db = new DBOper(this.con, "LNPInsuredB");
/*  32 */     this.mflag = true;
/*     */   }
/*     */ 
...
/*     */   {
/*  37 */     this.con = null;
/*  38 */     this.db = new DBOper("LNPInsuredB");
/*  39 */     this.mflag = false;
/*     */   }
/*     */ 
/*     */   public boolean insert()
/*     */   {
/*  45 */     LNPInsuredBSchema tSchema = getSchema();
/*  46 */     if (!this.db.insert(tSchema))
/*     */     {
/*  49 */       this.mErrors.copyAllErrors(this.db.mErrors);
/*  50 */       CError tError = new CError();
/*  51 */       tError.moduleName = "LNPInsuredBDB";
...
/*     */   public int getCount()
/*     */   {
/* 121 */     LNPInsuredBSchema tSchema = getSchema();
/*     */ 
...
/* 129 */       tError.moduleName = "LNPInsuredBDB";
...
/* 152 */       SQLString sqlObj = new SQLString("LNPInsuredB");
/* 153 */       LNPInsuredBSchema aSchema = getSchema();
...
/* 166 */           tError.moduleName = "LNPInsuredBDB";
...
/* 193 */         tError.moduleName = "LNPInsuredBDB";
...
/* 213 */       tError.moduleName = "LNPInsuredBDB";
...
/* 248 */     LNPInsuredBSet aLNPInsuredBSet = new LNPInsuredBSet();
/*     */ 
/* 250 */     if (!this.mflag) {
...
/* 257 */       SQLString sqlObj = new SQLString("LNPInsuredB");
/* 258 */       LNPInsuredBSchema aSchema = getSchema();
...
/*     */       {
/* 266 */         i++;
/* 267 */         LNPInsuredBSchema s1 = new LNPInsuredBSchema();
/* 268 */         s1.setSchema(rs, i);
/* 269 */         aLNPInsuredBSet.add(s1);
/*     */       }try {
...
/* 278 */       tError.moduleName = "LNPInsuredBDB";
...
/* 312 */     LNPInsuredBSet aLNPInsuredBSet = new LNPInsuredBSet();
/*     */ 
/* 314 */     if (!this.mflag) {
...
/*     */       {
/* 326 */         i++;
/* 327 */         LNPInsuredBSchema s1 = new LNPInsuredBSchema();
/* 328 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 331 */           CError tError = new CError();
/* 332 */           tError.moduleName = "LNPInsuredBDB";
...
/* 346 */       tError.moduleName = "LNPInsuredBDB";
...
/* 380 */     LNPInsuredBSet aLNPInsuredBSet = new LNPInsuredBSet();
/*     */ 
/* 382 */     if (!this.mflag) {
...
/* 389 */       SQLString sqlObj = new SQLString("LNPInsuredB");
/* 390 */       LNPInsuredBSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 408 */         LNPInsuredBSchema s1 = new LNPInsuredBSchema();
/* 409 */         s1.setSchema(rs, i);
/* 410 */         aLNPInsuredBSet.add(s1);
/*     */       }try {
...
/* 419 */       tError.moduleName = "LNPInsuredBDB";
...
/* 453 */     LNPInsuredBSet aLNPInsuredBSet = new LNPInsuredBSet();
/*     */ 
/* 455 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 477 */         LNPInsuredBSchema s1 = new LNPInsuredBSchema();
/* 478 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 481 */           CError tError = new CError();
/* 482 */           tError.moduleName = "LNPInsuredBDB";
...
/* 496 */       tError.moduleName = "LNPInsuredBDB";
...
/* 537 */       SQLString sqlObj = new SQLString("LNPInsuredB");
/* 538 */       LNPInsuredBSchema aSchema = getSchema();
/* 539 */       sqlObj.setSQL(2, aSchema);
/* 540 */       String sql = "update LNPInsuredB " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 542 */       int operCount = stmt.executeUpdate(sql);
/* 543 */       if (operCount == 0)
/*     */       {
/* 546 */         CError tError = new CError();
/* 547 */         tError.moduleName = "LNPInsuredBDB";
...
/* 567 */       tError.moduleName = "LNPInsuredBDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPInsuredBDB
