...
/*  33 */     this.db = new DBOper(this.con, "LNPDutyPayRela");
/*  34 */     this.mflag = true;
/*     */   }
/*     */ 
...
/*     */   {
/*  39 */     this.con = null;
/*  40 */     this.db = new DBOper("LNPDutyPayRela");
/*  41 */     this.mflag = false;
/*     */   }
/*     */ 
/*     */   public boolean deleteSQL()
/*     */   {
/*  47 */     LNPDutyPayRelaSchema tSchema = getSchema();
...
/*  57 */     tError.moduleName = "LNPDutyPayRelaDB";
...
/*     */   public int getCount()
/*     */   {
/*  67 */     LNPDutyPayRelaSchema tSchema = getSchema();
/*     */ 
...
/*  75 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/*     */     try
/*     */     {
/*  96 */       pstmt = this.con.prepareStatement("DELETE FROM LNPDutyPayRela WHERE  DutyCode = ? AND PayPlanCode = ?");
/*  97 */       if ((getDutyCode() == null) || (getDutyCode().equals("null")))
/*  98 */         pstmt.setNull(1, 12);
/*     */       else {
/* 100 */         pstmt.setString(1, getDutyCode());
/*     */       }
/* 102 */       if ((getPayPlanCode() == null) || (getPayPlanCode().equals("null")))
/* 103 */         pstmt.setNull(2, 12);
/*     */       else {
/* 105 */         pstmt.setString(2, getPayPlanCode());
/*     */       }
...
/* 113 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/*     */     try
/*     */     {
/* 150 */       pstmt = this.con.prepareStatement("UPDATE LNPDutyPayRela SET  DutyCode = ? , PayPlanCode = ? , PayPlanName = ? WHERE  DutyCode = ? AND PayPlanCode = ?");
/* 151 */       if ((getDutyCode() == null) || (getDutyCode().equals("null")))
/* 152 */         pstmt.setNull(1, 12);
/*     */       else {
/* 154 */         pstmt.setString(1, getDutyCode());
/*     */       }
/* 156 */       if ((getPayPlanCode() == null) || (getPayPlanCode().equals("null")))
/* 157 */         pstmt.setNull(2, 12);
/*     */       else {
/* 159 */         pstmt.setString(2, getPayPlanCode());
/*     */       }
/* 161 */       if ((getPayPlanName() == null) || (getPayPlanName().equals("null")))
/* 162 */         pstmt.setNull(3, 12);
/*     */       else {
/* 164 */         pstmt.setString(3, getPayPlanName());
/*     */       }
/*     */ 
...
/*     */       }
/* 172 */       if ((getPayPlanCode() == null) || (getPayPlanCode().equals("null")))
/* 173 */         pstmt.setNull(5, 12);
/*     */       else {
/* 175 */         pstmt.setString(5, getPayPlanCode());
/*     */       }
...
/* 183 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/*     */     try
/*     */     {
/* 220 */       pstmt = this.con.prepareStatement("INSERT INTO LNPDutyPayRela VALUES( ? , ? , ?)");
/* 221 */       if ((getDutyCode() == null) || (getDutyCode().equals("null")))
/* 222 */         pstmt.setNull(1, 12);
/*     */       else {
/* 224 */         pstmt.setString(1, getDutyCode());
/*     */       }
/* 226 */       if ((getPayPlanCode() == null) || (getPayPlanCode().equals("null")))
/* 227 */         pstmt.setNull(2, 12);
/*     */       else {
/* 229 */         pstmt.setString(2, getPayPlanCode());
/*     */       }
/* 231 */       if ((getPayPlanName() == null) || (getPayPlanName().equals("null")))
/* 232 */         pstmt.setNull(3, 12);
/*     */       else {
/* 234 */         pstmt.setString(3, getPayPlanName());
/*     */       }
/*     */ 
...
/* 243 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/*     */     try
/*     */     {
/* 281 */       pstmt = this.con.prepareStatement("SELECT * FROM LNPDutyPayRela WHERE  DutyCode = ? AND PayPlanCode = ?", 
/* 282 */         1003, 1007);
...
/*     */       }
/* 288 */       if ((getPayPlanCode() == null) || (getPayPlanCode().equals("null")))
/* 289 */         pstmt.setNull(2, 12);
/*     */       else {
/* 291 */         pstmt.setString(2, getPayPlanCode());
/*     */       }
...
/* 302 */           tError.moduleName = "LNPDutyPayRelaDB";
...
/* 342 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/* 377 */     LNPDutyPayRelaSet aLNPDutyPayRelaSet = new LNPDutyPayRelaSet();
/*     */ 
/* 379 */     if (!this.mflag) {
...
/* 386 */       SQLString sqlObj = new SQLString("LNPDutyPayRela");
/* 387 */       LNPDutyPayRelaSchema aSchema = getSchema();
...
/*     */       {
/* 395 */         i++;
/* 396 */         LNPDutyPayRelaSchema s1 = new LNPDutyPayRelaSchema();
/* 397 */         s1.setSchema(rs, i);
/* 398 */         aLNPDutyPayRelaSet.add(s1);
/*     */       }try {
...
/* 407 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/* 441 */     LNPDutyPayRelaSet aLNPDutyPayRelaSet = new LNPDutyPayRelaSet();
/*     */ 
/* 443 */     if (!this.mflag) {
...
/*     */       {
/* 455 */         i++;
/* 456 */         LNPDutyPayRelaSchema s1 = new LNPDutyPayRelaSchema();
/* 457 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 460 */           CError tError = new CError();
/* 461 */           tError.moduleName = "LNPDutyPayRelaDB";
...
/* 475 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/* 509 */     LNPDutyPayRelaSet aLNPDutyPayRelaSet = new LNPDutyPayRelaSet();
/*     */ 
/* 511 */     if (!this.mflag) {
...
/* 518 */       SQLString sqlObj = new SQLString("LNPDutyPayRela");
/* 519 */       LNPDutyPayRelaSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 537 */         LNPDutyPayRelaSchema s1 = new LNPDutyPayRelaSchema();
/* 538 */         s1.setSchema(rs, i);
/* 539 */         aLNPDutyPayRelaSet.add(s1);
/*     */       }try {
...
/* 548 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/* 582 */     LNPDutyPayRelaSet aLNPDutyPayRelaSet = new LNPDutyPayRelaSet();
/*     */ 
/* 584 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 606 */         LNPDutyPayRelaSchema s1 = new LNPDutyPayRelaSchema();
/* 607 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 610 */           CError tError = new CError();
/* 611 */           tError.moduleName = "LNPDutyPayRelaDB";
...
/* 625 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/* 666 */       SQLString sqlObj = new SQLString("LNPDutyPayRela");
/* 667 */       LNPDutyPayRelaSchema aSchema = getSchema();
/* 668 */       sqlObj.setSQL(2, aSchema);
/* 669 */       String sql = "update LNPDutyPayRela " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 671 */       int operCount = stmt.executeUpdate(sql);
/* 672 */       if (operCount == 0)
/*     */       {
/* 675 */         CError tError = new CError();
/* 676 */         tError.moduleName = "LNPDutyPayRelaDB";
...
/* 696 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/* 733 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/* 753 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/* 800 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/* 813 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/*     */   {
/* 847 */     int tCount = 0;
/* 848 */     LNPDutyPayRelaSet tLNPDutyPayRelaSet = new LNPDutyPayRelaSet();
/* 849 */     LNPDutyPayRelaSchema tLNPDutyPayRelaSchema = null;
/* 850 */     if (this.mResultSet == null)
/*     */     {
/* 852 */       CError tError = new CError();
/* 853 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/*     */     {
/* 861 */       tCount = 1;
/* 862 */       tLNPDutyPayRelaSchema = new LNPDutyPayRelaSchema();
/* 863 */       tLNPDutyPayRelaSchema.setSchema(this.mResultSet, 1);
/* 864 */       tLNPDutyPayRelaSet.add(tLNPDutyPayRelaSchema);
/*     */ 
/* 866 */       while (tCount++ < 5000)
/*     */       {
/* 868 */         if (!this.mResultSet.next())
/*     */           continue;
/* 870 */         tLNPDutyPayRelaSchema = new LNPDutyPayRelaSchema();
/* 871 */         tLNPDutyPayRelaSchema.setSchema(this.mResultSet, 1);
/* 872 */         tLNPDutyPayRelaSet.add(tLNPDutyPayRelaSchema);
/*     */       }
/*     */ 
/*     */     }
/*     */     catch (Exception ex)
...
/* 879 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/* 919 */         tError.moduleName = "LNPDutyPayRelaDB";
...
/* 934 */       tError.moduleName = "LNPDutyPayRelaDB";
...
/* 945 */         tError.moduleName = "LNPDutyPayRelaDB";
...
/* 960 */       tError.moduleName = "LNPDutyPayRelaDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPDutyPayRelaDB
