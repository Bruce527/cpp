...
/*   33 */     this.db = new DBOper(this.con, "LNPAgentIImpOption");
/*   34 */     this.mflag = true;
/*      */   }
/*      */ 
...
/*      */   {
/*   39 */     this.con = null;
/*   40 */     this.db = new DBOper("LNPAgentIImpOption");
/*   41 */     this.mflag = false;
/*      */   }
/*      */ 
/*      */   public boolean deleteSQL()
/*      */   {
/*   47 */     LNPAgentIImpOptionSchema tSchema = getSchema();
...
/*   57 */     tError.moduleName = "LNPAgentIImpOptionDB";
...
/*      */   public int getCount()
/*      */   {
/*   67 */     LNPAgentIImpOptionSchema tSchema = getSchema();
/*      */ 
...
/*   75 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/*      */     try
/*      */     {
/*   96 */       pstmt = this.con.prepareStatement("DELETE FROM LNPAgentIImpOption WHERE  OptionId = ?");
...
/*  108 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/*      */     try
/*      */     {
/*  145 */       pstmt = this.con.prepareStatement("UPDATE LNPAgentIImpOption SET  ImpartId = ? , QuestionId = ? , OptionId = ? , OptionOrder = ? , OptionContent = ? , Operator = ? , ManageCom = ? , MakeDate = ? , MakeTime = ? , ModifyDate = ? , ModifyTime = ? WHERE  OptionId = ?");
...
/*  213 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/*      */     try
/*      */     {
/*  250 */       pstmt = this.con.prepareStatement("INSERT INTO LNPAgentIImpOption VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/*  313 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/*      */     try
/*      */     {
/*  351 */       pstmt = this.con.prepareStatement("SELECT * FROM LNPAgentIImpOption WHERE  OptionId = ?", 
/*  352 */         1003, 1007);
...
/*  367 */           tError.moduleName = "LNPAgentIImpOptionDB";
...
/*  407 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/*  442 */     LNPAgentIImpOptionSet aLNPAgentIImpOptionSet = new LNPAgentIImpOptionSet();
/*      */ 
/*  444 */     if (!this.mflag) {
...
/*  451 */       SQLString sqlObj = new SQLString("LNPAgentIImpOption");
/*  452 */       LNPAgentIImpOptionSchema aSchema = getSchema();
...
/*      */       {
/*  460 */         i++;
/*  461 */         LNPAgentIImpOptionSchema s1 = new LNPAgentIImpOptionSchema();
/*  462 */         s1.setSchema(rs, i);
/*  463 */         aLNPAgentIImpOptionSet.add(s1);
/*      */       }try {
...
/*  472 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/*      */       }
/*      */     }
/*  499 */     return aLNPAgentIImpOptionSet;
/*      */   }
/*      */ 
...
/*  506 */     LNPAgentIImpOptionSet aLNPAgentIImpOptionSet = new LNPAgentIImpOptionSet();
/*      */ 
/*  508 */     if (!this.mflag) {
...
/*      */       {
/*  520 */         i++;
/*  521 */         LNPAgentIImpOptionSchema s1 = new LNPAgentIImpOptionSchema();
/*  522 */         if (!s1.setSchema(rs, i))
/*      */         {
/*  525 */           CError tError = new CError();
/*  526 */           tError.moduleName = "LNPAgentIImpOptionDB";
...
/*      */         }
/*  531 */         aLNPAgentIImpOptionSet.add(s1);
/*      */       }try {
...
/*  540 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/*      */       }
/*      */     }
/*  567 */     return aLNPAgentIImpOptionSet;
/*      */   }
/*      */ 
...
/*  574 */     LNPAgentIImpOptionSet aLNPAgentIImpOptionSet = new LNPAgentIImpOptionSet();
/*      */ 
/*  576 */     if (!this.mflag) {
...
/*  583 */       SQLString sqlObj = new SQLString("LNPAgentIImpOption");
/*  584 */       LNPAgentIImpOptionSchema aSchema = getSchema();
...
/*      */           break;
/*      */         }
/*  602 */         LNPAgentIImpOptionSchema s1 = new LNPAgentIImpOptionSchema();
/*  603 */         s1.setSchema(rs, i);
/*  604 */         aLNPAgentIImpOptionSet.add(s1);
/*      */       }try {
...
/*  613 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/*      */       }
/*      */     }
/*  640 */     return aLNPAgentIImpOptionSet;
/*      */   }
/*      */ 
...
/*  647 */     LNPAgentIImpOptionSet aLNPAgentIImpOptionSet = new LNPAgentIImpOptionSet();
/*      */ 
/*  649 */     if (!this.mflag) {
...
/*      */           break;
/*      */         }
/*  671 */         LNPAgentIImpOptionSchema s1 = new LNPAgentIImpOptionSchema();
/*  672 */         if (!s1.setSchema(rs, i))
/*      */         {
/*  675 */           CError tError = new CError();
/*  676 */           tError.moduleName = "LNPAgentIImpOptionDB";
...
/*      */         }
/*  681 */         aLNPAgentIImpOptionSet.add(s1);
/*      */       }try {
...
/*  690 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/*      */       }
/*      */     }
/*  717 */     return aLNPAgentIImpOptionSet;
/*      */   }
/*      */ 
...
/*  731 */       SQLString sqlObj = new SQLString("LNPAgentIImpOption");
/*  732 */       LNPAgentIImpOptionSchema aSchema = getSchema();
/*  733 */       sqlObj.setSQL(2, aSchema);
/*  734 */       String sql = "update LNPAgentIImpOption " + sqlObj.getUpdPart() + " where " + strWherePart;
/*      */ 
/*  736 */       int operCount = stmt.executeUpdate(sql);
/*  737 */       if (operCount == 0)
/*      */       {
/*  740 */         CError tError = new CError();
/*  741 */         tError.moduleName = "LNPAgentIImpOptionDB";
...
/*  761 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/*  798 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/*  818 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/*  865 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/*  878 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/*      */   {
/*  912 */     int tCount = 0;
/*  913 */     LNPAgentIImpOptionSet tLNPAgentIImpOptionSet = new LNPAgentIImpOptionSet();
/*  914 */     LNPAgentIImpOptionSchema tLNPAgentIImpOptionSchema = null;
/*  915 */     if (this.mResultSet == null)
/*      */     {
/*  917 */       CError tError = new CError();
/*  918 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/*      */     {
/*  926 */       tCount = 1;
/*  927 */       tLNPAgentIImpOptionSchema = new LNPAgentIImpOptionSchema();
/*  928 */       tLNPAgentIImpOptionSchema.setSchema(this.mResultSet, 1);
/*  929 */       tLNPAgentIImpOptionSet.add(tLNPAgentIImpOptionSchema);
/*      */ 
/*  931 */       while (tCount++ < 5000)
/*      */       {
/*  933 */         if (!this.mResultSet.next())
/*      */           continue;
/*  935 */         tLNPAgentIImpOptionSchema = new LNPAgentIImpOptionSchema();
/*  936 */         tLNPAgentIImpOptionSchema.setSchema(this.mResultSet, 1);
/*  937 */         tLNPAgentIImpOptionSet.add(tLNPAgentIImpOptionSchema);
/*      */       }
/*      */ 
/*      */     }
/*      */     catch (Exception ex)
...
/*  944 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/*  971 */       return null;
/*      */     }
/*  973 */     return tLNPAgentIImpOptionSet;
/*      */   }
/*      */ 
...
/*  984 */         tError.moduleName = "LNPAgentIImpOptionDB";
...
/*  999 */       tError.moduleName = "LNPAgentIImpOptionDB";
...
/* 1010 */         tError.moduleName = "LNPAgentIImpOptionDB";
...
/* 1025 */       tError.moduleName = "LNPAgentIImpOptionDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPAgentIImpOptionDB
