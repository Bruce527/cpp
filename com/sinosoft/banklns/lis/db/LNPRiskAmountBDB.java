...
/*  31 */     this.db = new DBOper(this.con, "LNPRiskAmountB");
/*  32 */     this.mflag = true;
/*     */   }
/*     */ 
...
/*     */   {
/*  37 */     this.con = null;
/*  38 */     this.db = new DBOper("LNPRiskAmountB");
/*  39 */     this.mflag = false;
/*     */   }
/*     */ 
/*     */   public boolean insert()
/*     */   {
/*  45 */     LNPRiskAmountBSchema tSchema = getSchema();
/*  46 */     if (!this.db.insert(tSchema))
/*     */     {
/*  49 */       this.mErrors.copyAllErrors(this.db.mErrors);
/*  50 */       CError tError = new CError();
/*  51 */       tError.moduleName = "LNPRiskAmountBDB";
...
/*     */   public int getCount()
/*     */   {
/* 121 */     LNPRiskAmountBSchema tSchema = getSchema();
/*     */ 
...
/* 129 */       tError.moduleName = "LNPRiskAmountBDB";
...
/* 152 */       SQLString sqlObj = new SQLString("LNPRiskAmountB");
/* 153 */       LNPRiskAmountBSchema aSchema = getSchema();
...
/* 166 */           tError.moduleName = "LNPRiskAmountBDB";
...
/* 193 */         tError.moduleName = "LNPRiskAmountBDB";
...
/* 213 */       tError.moduleName = "LNPRiskAmountBDB";
...
/* 248 */     LNPRiskAmountBSet aLNPRiskAmountBSet = new LNPRiskAmountBSet();
/*     */ 
/* 250 */     if (!this.mflag) {
...
/* 257 */       SQLString sqlObj = new SQLString("LNPRiskAmountB");
/* 258 */       LNPRiskAmountBSchema aSchema = getSchema();
...
/*     */       {
/* 266 */         i++;
/* 267 */         LNPRiskAmountBSchema s1 = new LNPRiskAmountBSchema();
/* 268 */         s1.setSchema(rs, i);
/* 269 */         aLNPRiskAmountBSet.add(s1);
/*     */       }try {
...
/* 278 */       tError.moduleName = "LNPRiskAmountBDB";
...
/* 312 */     LNPRiskAmountBSet aLNPRiskAmountBSet = new LNPRiskAmountBSet();
/*     */ 
/* 314 */     if (!this.mflag) {
...
/*     */       {
/* 326 */         i++;
/* 327 */         LNPRiskAmountBSchema s1 = new LNPRiskAmountBSchema();
/* 328 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 331 */           CError tError = new CError();
/* 332 */           tError.moduleName = "LNPRiskAmountBDB";
...
/* 346 */       tError.moduleName = "LNPRiskAmountBDB";
...
/* 380 */     LNPRiskAmountBSet aLNPRiskAmountBSet = new LNPRiskAmountBSet();
/*     */ 
/* 382 */     if (!this.mflag) {
...
/* 389 */       SQLString sqlObj = new SQLString("LNPRiskAmountB");
/* 390 */       LNPRiskAmountBSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 408 */         LNPRiskAmountBSchema s1 = new LNPRiskAmountBSchema();
/* 409 */         s1.setSchema(rs, i);
/* 410 */         aLNPRiskAmountBSet.add(s1);
/*     */       }try {
...
/* 419 */       tError.moduleName = "LNPRiskAmountBDB";
...
/* 453 */     LNPRiskAmountBSet aLNPRiskAmountBSet = new LNPRiskAmountBSet();
/*     */ 
/* 455 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 477 */         LNPRiskAmountBSchema s1 = new LNPRiskAmountBSchema();
/* 478 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 481 */           CError tError = new CError();
/* 482 */           tError.moduleName = "LNPRiskAmountBDB";
...
/* 496 */       tError.moduleName = "LNPRiskAmountBDB";
...
/* 537 */       SQLString sqlObj = new SQLString("LNPRiskAmountB");
/* 538 */       LNPRiskAmountBSchema aSchema = getSchema();
/* 539 */       sqlObj.setSQL(2, aSchema);
/* 540 */       String sql = "update LNPRiskAmountB " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 542 */       int operCount = stmt.executeUpdate(sql);
/* 543 */       if (operCount == 0)
/*     */       {
/* 546 */         CError tError = new CError();
/* 547 */         tError.moduleName = "LNPRiskAmountBDB";
...
/* 567 */       tError.moduleName = "LNPRiskAmountBDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPRiskAmountBDB
