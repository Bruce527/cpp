...
/*     */ 
/*     */ public class LNPDutyGetRelaDB extends LNPDutyGetRelaSchema
/*     */ {
...
/*     */ 
/*     */   public LNPDutyGetRelaDB(Connection tConnection)
/*     */   {
/*  32 */     this.con = tConnection;
/*  33 */     this.db = new DBOper(this.con, "LNPDutyGetRela");
/*  34 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPDutyGetRelaDB()
/*     */   {
/*  39 */     this.con = null;
/*  40 */     this.db = new DBOper("LNPDutyGetRela");
/*  41 */     this.mflag = false;
/*     */   }
/*     */ 
/*     */   public boolean deleteSQL()
/*     */   {
/*  47 */     LNPDutyGetRelaSchema tSchema = getSchema();
...
/*  57 */     tError.moduleName = "LNPDutyGetRelaDB";
...
/*     */   public int getCount()
/*     */   {
/*  67 */     LNPDutyGetRelaSchema tSchema = getSchema();
/*     */ 
...
/*  75 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/*     */     try
/*     */     {
/*  96 */       pstmt = this.con.prepareStatement("DELETE FROM LNPDutyGetRela WHERE  DutyCode = ? AND GetDutyCode = ?");
/*  97 */       if ((getDutyCode() == null) || (getDutyCode().equals("null")))
/*  98 */         pstmt.setNull(1, 12);
/*     */       else {
/* 100 */         pstmt.setString(1, getDutyCode());
/*     */       }
/* 102 */       if ((getGetDutyCode() == null) || (getGetDutyCode().equals("null")))
/* 103 */         pstmt.setNull(2, 12);
/*     */       else {
/* 105 */         pstmt.setString(2, getGetDutyCode());
/*     */       }
...
/* 113 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/*     */     try
/*     */     {
/* 150 */       pstmt = this.con.prepareStatement("UPDATE LNPDutyGetRela SET  DutyCode = ? , GetDutyCode = ? , GetDutyName = ? WHERE  DutyCode = ? AND GetDutyCode = ?");
/* 151 */       if ((getDutyCode() == null) || (getDutyCode().equals("null")))
/* 152 */         pstmt.setNull(1, 12);
/*     */       else {
/* 154 */         pstmt.setString(1, getDutyCode());
/*     */       }
/* 156 */       if ((getGetDutyCode() == null) || (getGetDutyCode().equals("null")))
/* 157 */         pstmt.setNull(2, 12);
/*     */       else {
/* 159 */         pstmt.setString(2, getGetDutyCode());
/*     */       }
/* 161 */       if ((getGetDutyName() == null) || (getGetDutyName().equals("null")))
/* 162 */         pstmt.setNull(3, 12);
/*     */       else {
/* 164 */         pstmt.setString(3, getGetDutyName());
/*     */       }
/*     */ 
/* 167 */       if ((getDutyCode() == null) || (getDutyCode().equals("null")))
/* 168 */         pstmt.setNull(4, 12);
/*     */       else {
/* 170 */         pstmt.setString(4, getDutyCode());
/*     */       }
/* 172 */       if ((getGetDutyCode() == null) || (getGetDutyCode().equals("null")))
/* 173 */         pstmt.setNull(5, 12);
/*     */       else {
/* 175 */         pstmt.setString(5, getGetDutyCode());
/*     */       }
...
/* 183 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/*     */     try
/*     */     {
/* 220 */       pstmt = this.con.prepareStatement("INSERT INTO LNPDutyGetRela VALUES( ? , ? , ?)");
/* 221 */       if ((getDutyCode() == null) || (getDutyCode().equals("null")))
/* 222 */         pstmt.setNull(1, 12);
/*     */       else {
/* 224 */         pstmt.setString(1, getDutyCode());
/*     */       }
/* 226 */       if ((getGetDutyCode() == null) || (getGetDutyCode().equals("null")))
/* 227 */         pstmt.setNull(2, 12);
/*     */       else {
/* 229 */         pstmt.setString(2, getGetDutyCode());
/*     */       }
/* 231 */       if ((getGetDutyName() == null) || (getGetDutyName().equals("null")))
/* 232 */         pstmt.setNull(3, 12);
/*     */       else {
/* 234 */         pstmt.setString(3, getGetDutyName());
/*     */       }
/*     */ 
...
/* 243 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/*     */     try
/*     */     {
/* 281 */       pstmt = this.con.prepareStatement("SELECT * FROM LNPDutyGetRela WHERE  DutyCode = ? AND GetDutyCode = ?", 
/* 282 */         1003, 1007);
/* 283 */       if ((getDutyCode() == null) || (getDutyCode().equals("null")))
/* 284 */         pstmt.setNull(1, 12);
/*     */       else {
/* 286 */         pstmt.setString(1, getDutyCode());
/*     */       }
/* 288 */       if ((getGetDutyCode() == null) || (getGetDutyCode().equals("null")))
/* 289 */         pstmt.setNull(2, 12);
/*     */       else {
/* 291 */         pstmt.setString(2, getGetDutyCode());
/*     */       }
...
/* 302 */           tError.moduleName = "LNPDutyGetRelaDB";
...
/* 342 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/*     */   }
/*     */ 
/*     */   public LNPDutyGetRelaSet query()
/*     */   {
/* 375 */     Statement stmt = null;
/* 376 */     ResultSet rs = null;
/* 377 */     LNPDutyGetRelaSet aLNPDutyGetRelaSet = new LNPDutyGetRelaSet();
/*     */ 
/* 379 */     if (!this.mflag) {
...
/* 386 */       SQLString sqlObj = new SQLString("LNPDutyGetRela");
/* 387 */       LNPDutyGetRelaSchema aSchema = getSchema();
...
/*     */       {
/* 395 */         i++;
/* 396 */         LNPDutyGetRelaSchema s1 = new LNPDutyGetRelaSchema();
/* 397 */         s1.setSchema(rs, i);
/* 398 */         aLNPDutyGetRelaSet.add(s1);
/*     */       }try {
...
/* 407 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/*     */       }
/*     */     }
/* 434 */     return aLNPDutyGetRelaSet;
/*     */   }
/*     */ 
/*     */   public LNPDutyGetRelaSet executeQuery(String sql)
/*     */   {
/* 439 */     Statement stmt = null;
/* 440 */     ResultSet rs = null;
/* 441 */     LNPDutyGetRelaSet aLNPDutyGetRelaSet = new LNPDutyGetRelaSet();
/*     */ 
/* 443 */     if (!this.mflag) {
...
/*     */       {
/* 455 */         i++;
/* 456 */         LNPDutyGetRelaSchema s1 = new LNPDutyGetRelaSchema();
/* 457 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 460 */           CError tError = new CError();
/* 461 */           tError.moduleName = "LNPDutyGetRelaDB";
...
/* 475 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/*     */       }
/*     */     }
/* 502 */     return aLNPDutyGetRelaSet;
/*     */   }
/*     */ 
/*     */   public LNPDutyGetRelaSet query(int nStart, int nCount)
/*     */   {
/* 507 */     Statement stmt = null;
/* 508 */     ResultSet rs = null;
/* 509 */     LNPDutyGetRelaSet aLNPDutyGetRelaSet = new LNPDutyGetRelaSet();
/*     */ 
/* 511 */     if (!this.mflag) {
...
/* 518 */       SQLString sqlObj = new SQLString("LNPDutyGetRela");
/* 519 */       LNPDutyGetRelaSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 537 */         LNPDutyGetRelaSchema s1 = new LNPDutyGetRelaSchema();
/* 538 */         s1.setSchema(rs, i);
/* 539 */         aLNPDutyGetRelaSet.add(s1);
/*     */       }try {
...
/* 548 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/*     */       }
/*     */     }
/* 575 */     return aLNPDutyGetRelaSet;
/*     */   }
/*     */ 
/*     */   public LNPDutyGetRelaSet executeQuery(String sql, int nStart, int nCount)
/*     */   {
/* 580 */     Statement stmt = null;
/* 581 */     ResultSet rs = null;
/* 582 */     LNPDutyGetRelaSet aLNPDutyGetRelaSet = new LNPDutyGetRelaSet();
/*     */ 
/* 584 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 606 */         LNPDutyGetRelaSchema s1 = new LNPDutyGetRelaSchema();
/* 607 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 610 */           CError tError = new CError();
/* 611 */           tError.moduleName = "LNPDutyGetRelaDB";
...
/* 625 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/* 666 */       SQLString sqlObj = new SQLString("LNPDutyGetRela");
/* 667 */       LNPDutyGetRelaSchema aSchema = getSchema();
/* 668 */       sqlObj.setSQL(2, aSchema);
/* 669 */       String sql = "update LNPDutyGetRela " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 671 */       int operCount = stmt.executeUpdate(sql);
/* 672 */       if (operCount == 0)
/*     */       {
/* 675 */         CError tError = new CError();
/* 676 */         tError.moduleName = "LNPDutyGetRelaDB";
...
/* 696 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/* 733 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/* 753 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/* 800 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/* 813 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/*     */   }
/*     */ 
/*     */   public LNPDutyGetRelaSet getData()
/*     */   {
/* 847 */     int tCount = 0;
/* 848 */     LNPDutyGetRelaSet tLNPDutyGetRelaSet = new LNPDutyGetRelaSet();
/* 849 */     LNPDutyGetRelaSchema tLNPDutyGetRelaSchema = null;
/* 850 */     if (this.mResultSet == null)
/*     */     {
/* 852 */       CError tError = new CError();
/* 853 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/*     */     {
/* 861 */       tCount = 1;
/* 862 */       tLNPDutyGetRelaSchema = new LNPDutyGetRelaSchema();
/* 863 */       tLNPDutyGetRelaSchema.setSchema(this.mResultSet, 1);
/* 864 */       tLNPDutyGetRelaSet.add(tLNPDutyGetRelaSchema);
/*     */ 
/* 866 */       while (tCount++ < 5000)
/*     */       {
/* 868 */         if (!this.mResultSet.next())
/*     */           continue;
/* 870 */         tLNPDutyGetRelaSchema = new LNPDutyGetRelaSchema();
/* 871 */         tLNPDutyGetRelaSchema.setSchema(this.mResultSet, 1);
/* 872 */         tLNPDutyGetRelaSet.add(tLNPDutyGetRelaSchema);
/*     */       }
/*     */ 
/*     */     }
/*     */     catch (Exception ex)
...
/* 879 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/* 919 */         tError.moduleName = "LNPDutyGetRelaDB";
...
/* 934 */       tError.moduleName = "LNPDutyGetRelaDB";
...
/* 945 */         tError.moduleName = "LNPDutyGetRelaDB";
...
/* 960 */       tError.moduleName = "LNPDutyGetRelaDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPDutyGetRelaDB
