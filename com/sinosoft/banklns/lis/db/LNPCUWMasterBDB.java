...
/*     */   {
/*  37 */     this.con = null;
/*  38 */     this.db = new DBOper("LNPCUWMasterB");
/*  39 */     this.mflag = false;
/*     */   }
/*     */ 
/*     */   public boolean insert()
/*     */   {
/*  45 */     LNPCUWMasterBSchema tSchema = getSchema();
/*  46 */     if (!this.db.insert(tSchema))
/*     */     {
/*  49 */       this.mErrors.copyAllErrors(this.db.mErrors);
/*  50 */       CError tError = new CError();
/*  51 */       tError.moduleName = "LNPCUWMasterBDB";
...
/*     */   public int getCount()
/*     */   {
/* 121 */     LNPCUWMasterBSchema tSchema = getSchema();
/*     */ 
...
/* 129 */       tError.moduleName = "LNPCUWMasterBDB";
...
/* 152 */       SQLString sqlObj = new SQLString("LNPCUWMasterB");
/* 153 */       LNPCUWMasterBSchema aSchema = getSchema();
...
/* 166 */           tError.moduleName = "LNPCUWMasterBDB";
...
/* 193 */         tError.moduleName = "LNPCUWMasterBDB";
...
/* 213 */       tError.moduleName = "LNPCUWMasterBDB";
...
/* 248 */     LNPCUWMasterBSet aLNPCUWMasterBSet = new LNPCUWMasterBSet();
/*     */ 
/* 250 */     if (!this.mflag) {
...
/* 257 */       SQLString sqlObj = new SQLString("LNPCUWMasterB");
/* 258 */       LNPCUWMasterBSchema aSchema = getSchema();
...
/*     */       {
/* 266 */         i++;
/* 267 */         LNPCUWMasterBSchema s1 = new LNPCUWMasterBSchema();
/* 268 */         s1.setSchema(rs, i);
/* 269 */         aLNPCUWMasterBSet.add(s1);
/*     */       }try {
...
/* 278 */       tError.moduleName = "LNPCUWMasterBDB";
...
/* 312 */     LNPCUWMasterBSet aLNPCUWMasterBSet = new LNPCUWMasterBSet();
/*     */ 
/* 314 */     if (!this.mflag) {
...
/*     */       {
/* 326 */         i++;
/* 327 */         LNPCUWMasterBSchema s1 = new LNPCUWMasterBSchema();
/* 328 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 331 */           CError tError = new CError();
/* 332 */           tError.moduleName = "LNPCUWMasterBDB";
...
/* 346 */       tError.moduleName = "LNPCUWMasterBDB";
...
/* 380 */     LNPCUWMasterBSet aLNPCUWMasterBSet = new LNPCUWMasterBSet();
/*     */ 
/* 382 */     if (!this.mflag) {
...
/* 389 */       SQLString sqlObj = new SQLString("LNPCUWMasterB");
/* 390 */       LNPCUWMasterBSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 408 */         LNPCUWMasterBSchema s1 = new LNPCUWMasterBSchema();
/* 409 */         s1.setSchema(rs, i);
/* 410 */         aLNPCUWMasterBSet.add(s1);
/*     */       }try {
...
/* 419 */       tError.moduleName = "LNPCUWMasterBDB";
...
/* 453 */     LNPCUWMasterBSet aLNPCUWMasterBSet = new LNPCUWMasterBSet();
/*     */ 
/* 455 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 477 */         LNPCUWMasterBSchema s1 = new LNPCUWMasterBSchema();
/* 478 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 481 */           CError tError = new CError();
/* 482 */           tError.moduleName = "LNPCUWMasterBDB";
...
/* 496 */       tError.moduleName = "LNPCUWMasterBDB";
...
/* 537 */       SQLString sqlObj = new SQLString("LNPCUWMasterB");
/* 538 */       LNPCUWMasterBSchema aSchema = getSchema();
/* 539 */       sqlObj.setSQL(2, aSchema);
/* 540 */       String sql = "update LNPCUWMasterB " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 542 */       int operCount = stmt.executeUpdate(sql);
/* 543 */       if (operCount == 0)
/*     */       {
/* 546 */         CError tError = new CError();
/* 547 */         tError.moduleName = "LNPCUWMasterBDB";
...
/* 567 */       tError.moduleName = "LNPCUWMasterBDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPCUWMasterBDB
