...
/*     */ 
/*     */ public class LNPContBDB extends LNPContBSchema
/*     */ {
...
/*     */ 
/*     */   public LNPContBDB(Connection tConnection)
/*     */   {
...
/*     */   public int getCount()
/*     */   {
/* 121 */     LNPContBSchema tSchema = getSchema();
/*     */ 
...
/* 129 */       tError.moduleName = "LNPContBDB";
...
/* 152 */       SQLString sqlObj = new SQLString("LNPContB");
/* 153 */       LNPContBSchema aSchema = getSchema();
...
/* 166 */           tError.moduleName = "LNPContBDB";
...
/* 193 */         tError.moduleName = "LNPContBDB";
...
/* 213 */       tError.moduleName = "LNPContBDB";
...
/*     */   }
/*     */ 
/*     */   public LNPContBSet query()
/*     */   {
/* 246 */     Statement stmt = null;
/* 247 */     ResultSet rs = null;
/* 248 */     LNPContBSet aLNPContBSet = new LNPContBSet();
/*     */ 
/* 250 */     if (!this.mflag) {
...
/* 257 */       SQLString sqlObj = new SQLString("LNPContB");
/* 258 */       LNPContBSchema aSchema = getSchema();
...
/*     */       {
/* 266 */         i++;
/* 267 */         LNPContBSchema s1 = new LNPContBSchema();
/* 268 */         s1.setSchema(rs, i);
/* 269 */         aLNPContBSet.add(s1);
/*     */       }try {
...
/* 278 */       tError.moduleName = "LNPContBDB";
...
/*     */       }
/*     */     }
/* 305 */     return aLNPContBSet;
/*     */   }
/*     */ 
/*     */   public LNPContBSet executeQuery(String sql)
/*     */   {
/* 310 */     Statement stmt = null;
/* 311 */     ResultSet rs = null;
/* 312 */     LNPContBSet aLNPContBSet = new LNPContBSet();
/*     */ 
/* 314 */     if (!this.mflag) {
...
/*     */       {
/* 326 */         i++;
/* 327 */         LNPContBSchema s1 = new LNPContBSchema();
/* 328 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 331 */           CError tError = new CError();
/* 332 */           tError.moduleName = "LNPContBDB";
...
/* 346 */       tError.moduleName = "LNPContBDB";
...
/*     */       }
/*     */     }
/* 373 */     return aLNPContBSet;
/*     */   }
/*     */ 
/*     */   public LNPContBSet query(int nStart, int nCount)
/*     */   {
/* 378 */     Statement stmt = null;
/* 379 */     ResultSet rs = null;
/* 380 */     LNPContBSet aLNPContBSet = new LNPContBSet();
/*     */ 
/* 382 */     if (!this.mflag) {
...
/* 389 */       SQLString sqlObj = new SQLString("LNPContB");
/* 390 */       LNPContBSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 408 */         LNPContBSchema s1 = new LNPContBSchema();
/* 409 */         s1.setSchema(rs, i);
/* 410 */         aLNPContBSet.add(s1);
/*     */       }try {
...
/* 419 */       tError.moduleName = "LNPContBDB";
...
/*     */       }
/*     */     }
/* 446 */     return aLNPContBSet;
/*     */   }
/*     */ 
/*     */   public LNPContBSet executeQuery(String sql, int nStart, int nCount)
/*     */   {
/* 451 */     Statement stmt = null;
/* 452 */     ResultSet rs = null;
/* 453 */     LNPContBSet aLNPContBSet = new LNPContBSet();
/*     */ 
/* 455 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 477 */         LNPContBSchema s1 = new LNPContBSchema();
/* 478 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 481 */           CError tError = new CError();
/* 482 */           tError.moduleName = "LNPContBDB";
...
/* 496 */       tError.moduleName = "LNPContBDB";
...
/* 537 */       SQLString sqlObj = new SQLString("LNPContB");
/* 538 */       LNPContBSchema aSchema = getSchema();
/* 539 */       sqlObj.setSQL(2, aSchema);
/* 540 */       String sql = "update LNPContB " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 542 */       int operCount = stmt.executeUpdate(sql);
/* 543 */       if (operCount == 0)
/*     */       {
/* 546 */         CError tError = new CError();
/* 547 */         tError.moduleName = "LNPContBDB";
...
/* 567 */       tError.moduleName = "LNPContBDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPContBDB
