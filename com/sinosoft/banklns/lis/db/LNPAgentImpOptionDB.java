...
/*   33 */     this.db = new DBOper(this.con, "LNPAgentImpOption");
/*   34 */     this.mflag = true;
/*      */   }
/*      */ 
...
/*      */   {
/*   39 */     this.con = null;
/*   40 */     this.db = new DBOper("LNPAgentImpOption");
/*   41 */     this.mflag = false;
/*      */   }
/*      */ 
/*      */   public boolean deleteSQL()
/*      */   {
/*   47 */     LNPAgentImpOptionSchema tSchema = getSchema();
...
/*   57 */     tError.moduleName = "LNPAgentImpOptionDB";
...
/*      */   public int getCount()
/*      */   {
/*   67 */     LNPAgentImpOptionSchema tSchema = getSchema();
/*      */ 
...
/*   75 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/*      */     try
/*      */     {
/*   96 */       pstmt = this.con.prepareStatement("DELETE FROM LNPAgentImpOption WHERE  OptionId = ?");
...
/*  108 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/*      */     try
/*      */     {
/*  145 */       pstmt = this.con.prepareStatement("UPDATE LNPAgentImpOption SET  ImpartId = ? , QuestionId = ? , OptionId = ? , OptionOrder = ? , OptionContent = ? , Operator = ? , ManageCom = ? , MakeDate = ? , MakeTime = ? , ModifyDate = ? , ModifyTime = ? WHERE  OptionId = ?");
...
/*  213 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/*      */     try
/*      */     {
/*  250 */       pstmt = this.con.prepareStatement("INSERT INTO LNPAgentImpOption VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/*  313 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/*      */     try
/*      */     {
/*  351 */       pstmt = this.con.prepareStatement("SELECT * FROM LNPAgentImpOption WHERE  OptionId = ?", 
/*  352 */         1003, 1007);
...
/*  367 */           tError.moduleName = "LNPAgentImpOptionDB";
...
/*  407 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/*  442 */     LNPAgentImpOptionSet aLNPAgentImpOptionSet = new LNPAgentImpOptionSet();
/*      */ 
/*  444 */     if (!this.mflag) {
...
/*  451 */       SQLString sqlObj = new SQLString("LNPAgentImpOption");
/*  452 */       LNPAgentImpOptionSchema aSchema = getSchema();
...
/*      */       {
/*  460 */         i++;
/*  461 */         LNPAgentImpOptionSchema s1 = new LNPAgentImpOptionSchema();
/*  462 */         s1.setSchema(rs, i);
/*  463 */         aLNPAgentImpOptionSet.add(s1);
/*      */       }try {
...
/*  472 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/*      */       }
/*      */     }
/*  499 */     return aLNPAgentImpOptionSet;
/*      */   }
/*      */ 
...
/*  506 */     LNPAgentImpOptionSet aLNPAgentImpOptionSet = new LNPAgentImpOptionSet();
/*      */ 
/*  508 */     if (!this.mflag) {
...
/*      */       {
/*  520 */         i++;
/*  521 */         LNPAgentImpOptionSchema s1 = new LNPAgentImpOptionSchema();
/*  522 */         if (!s1.setSchema(rs, i))
/*      */         {
/*  525 */           CError tError = new CError();
/*  526 */           tError.moduleName = "LNPAgentImpOptionDB";
...
/*      */         }
/*  531 */         aLNPAgentImpOptionSet.add(s1);
/*      */       }try {
...
/*  540 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/*      */       }
/*      */     }
/*  567 */     return aLNPAgentImpOptionSet;
/*      */   }
/*      */ 
...
/*  574 */     LNPAgentImpOptionSet aLNPAgentImpOptionSet = new LNPAgentImpOptionSet();
/*      */ 
/*  576 */     if (!this.mflag) {
...
/*  583 */       SQLString sqlObj = new SQLString("LNPAgentImpOption");
/*  584 */       LNPAgentImpOptionSchema aSchema = getSchema();
...
/*      */           break;
/*      */         }
/*  602 */         LNPAgentImpOptionSchema s1 = new LNPAgentImpOptionSchema();
/*  603 */         s1.setSchema(rs, i);
/*  604 */         aLNPAgentImpOptionSet.add(s1);
/*      */       }try {
...
/*  613 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/*      */       }
/*      */     }
/*  640 */     return aLNPAgentImpOptionSet;
/*      */   }
/*      */ 
...
/*  647 */     LNPAgentImpOptionSet aLNPAgentImpOptionSet = new LNPAgentImpOptionSet();
/*      */ 
/*  649 */     if (!this.mflag) {
...
/*      */           break;
/*      */         }
/*  671 */         LNPAgentImpOptionSchema s1 = new LNPAgentImpOptionSchema();
/*  672 */         if (!s1.setSchema(rs, i))
/*      */         {
/*  675 */           CError tError = new CError();
/*  676 */           tError.moduleName = "LNPAgentImpOptionDB";
...
/*      */         }
/*  681 */         aLNPAgentImpOptionSet.add(s1);
/*      */       }try {
...
/*  690 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/*      */       }
/*      */     }
/*  717 */     return aLNPAgentImpOptionSet;
/*      */   }
/*      */ 
...
/*  731 */       SQLString sqlObj = new SQLString("LNPAgentImpOption");
/*  732 */       LNPAgentImpOptionSchema aSchema = getSchema();
/*  733 */       sqlObj.setSQL(2, aSchema);
/*  734 */       String sql = "update LNPAgentImpOption " + sqlObj.getUpdPart() + " where " + strWherePart;
/*      */ 
/*  736 */       int operCount = stmt.executeUpdate(sql);
/*  737 */       if (operCount == 0)
/*      */       {
/*  740 */         CError tError = new CError();
/*  741 */         tError.moduleName = "LNPAgentImpOptionDB";
...
/*  761 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/*  798 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/*  818 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/*  865 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/*  878 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/*      */   {
/*  912 */     int tCount = 0;
/*  913 */     LNPAgentImpOptionSet tLNPAgentImpOptionSet = new LNPAgentImpOptionSet();
/*  914 */     LNPAgentImpOptionSchema tLNPAgentImpOptionSchema = null;
/*  915 */     if (this.mResultSet == null)
/*      */     {
/*  917 */       CError tError = new CError();
/*  918 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/*      */     {
/*  926 */       tCount = 1;
/*  927 */       tLNPAgentImpOptionSchema = new LNPAgentImpOptionSchema();
/*  928 */       tLNPAgentImpOptionSchema.setSchema(this.mResultSet, 1);
/*  929 */       tLNPAgentImpOptionSet.add(tLNPAgentImpOptionSchema);
/*      */ 
/*  931 */       while (tCount++ < 5000)
/*      */       {
/*  933 */         if (!this.mResultSet.next())
/*      */           continue;
/*  935 */         tLNPAgentImpOptionSchema = new LNPAgentImpOptionSchema();
/*  936 */         tLNPAgentImpOptionSchema.setSchema(this.mResultSet, 1);
/*  937 */         tLNPAgentImpOptionSet.add(tLNPAgentImpOptionSchema);
/*      */       }
/*      */ 
/*      */     }
/*      */     catch (Exception ex)
...
/*  944 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/*  971 */       return null;
/*      */     }
/*  973 */     return tLNPAgentImpOptionSet;
/*      */   }
/*      */ 
...
/*  984 */         tError.moduleName = "LNPAgentImpOptionDB";
...
/*  999 */       tError.moduleName = "LNPAgentImpOptionDB";
...
/* 1010 */         tError.moduleName = "LNPAgentImpOptionDB";
...
/* 1025 */       tError.moduleName = "LNPAgentImpOptionDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPAgentImpOptionDB
