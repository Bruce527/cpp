...
/*  31 */     this.db = new DBOper(this.con, "LNPPersonB");
/*  32 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPPersonBDB()
...
/*     */   public int getCount()
/*     */   {
/* 121 */     LNPPersonBSchema tSchema = getSchema();
/*     */ 
...
/* 129 */       tError.moduleName = "LNPPersonBDB";
...
/* 152 */       SQLString sqlObj = new SQLString("LNPPersonB");
/* 153 */       LNPPersonBSchema aSchema = getSchema();
...
/* 166 */           tError.moduleName = "LNPPersonBDB";
...
/* 193 */         tError.moduleName = "LNPPersonBDB";
...
/* 213 */       tError.moduleName = "LNPPersonBDB";
...
/* 248 */     LNPPersonBSet aLNPPersonBSet = new LNPPersonBSet();
/*     */ 
/* 250 */     if (!this.mflag) {
...
/* 257 */       SQLString sqlObj = new SQLString("LNPPersonB");
/* 258 */       LNPPersonBSchema aSchema = getSchema();
...
/*     */       {
/* 266 */         i++;
/* 267 */         LNPPersonBSchema s1 = new LNPPersonBSchema();
/* 268 */         s1.setSchema(rs, i);
/* 269 */         aLNPPersonBSet.add(s1);
/*     */       }try {
...
/* 278 */       tError.moduleName = "LNPPersonBDB";
...
/* 312 */     LNPPersonBSet aLNPPersonBSet = new LNPPersonBSet();
/*     */ 
/* 314 */     if (!this.mflag) {
...
/*     */       {
/* 326 */         i++;
/* 327 */         LNPPersonBSchema s1 = new LNPPersonBSchema();
/* 328 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 331 */           CError tError = new CError();
/* 332 */           tError.moduleName = "LNPPersonBDB";
...
/* 346 */       tError.moduleName = "LNPPersonBDB";
...
/* 380 */     LNPPersonBSet aLNPPersonBSet = new LNPPersonBSet();
/*     */ 
/* 382 */     if (!this.mflag) {
...
/* 389 */       SQLString sqlObj = new SQLString("LNPPersonB");
/* 390 */       LNPPersonBSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 408 */         LNPPersonBSchema s1 = new LNPPersonBSchema();
/* 409 */         s1.setSchema(rs, i);
/* 410 */         aLNPPersonBSet.add(s1);
/*     */       }try {
...
/* 419 */       tError.moduleName = "LNPPersonBDB";
...
/* 453 */     LNPPersonBSet aLNPPersonBSet = new LNPPersonBSet();
/*     */ 
/* 455 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 477 */         LNPPersonBSchema s1 = new LNPPersonBSchema();
/* 478 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 481 */           CError tError = new CError();
/* 482 */           tError.moduleName = "LNPPersonBDB";
...
/* 496 */       tError.moduleName = "LNPPersonBDB";
...
/* 537 */       SQLString sqlObj = new SQLString("LNPPersonB");
/* 538 */       LNPPersonBSchema aSchema = getSchema();
/* 539 */       sqlObj.setSQL(2, aSchema);
/* 540 */       String sql = "update LNPPersonB " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 542 */       int operCount = stmt.executeUpdate(sql);
/* 543 */       if (operCount == 0)
/*     */       {
/* 546 */         CError tError = new CError();
/* 547 */         tError.moduleName = "LNPPersonBDB";
...
/* 567 */       tError.moduleName = "LNPPersonBDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPPersonBDB
