...
/*  31 */     this.db = new DBOper(this.con, "LNPInvestmentAccountInfoB");
/*  32 */     this.mflag = true;
/*     */   }
/*     */ 
...
/*     */   {
/*  37 */     this.con = null;
/*  38 */     this.db = new DBOper("LNPInvestmentAccountInfoB");
/*  39 */     this.mflag = false;
/*     */   }
/*     */ 
/*     */   public boolean insert()
/*     */   {
/*  45 */     LNPInvestmentAccountInfoBSchema tSchema = getSchema();
/*  46 */     if (!this.db.insert(tSchema))
/*     */     {
/*  49 */       this.mErrors.copyAllErrors(this.db.mErrors);
/*  50 */       CError tError = new CError();
/*  51 */       tError.moduleName = "LNPInvestmentAccountInfoBDB";
...
/*     */   {
/*  64 */     LNPInvestmentAccountInfoBSchema tSchema = getSchema();
/*  65 */     if (!this.db.update(tSchema))
/*     */     {
/*  68 */       this.mErrors.copyAllErrors(this.db.mErrors);
/*  69 */       CError tError = new CError();
/*  70 */       tError.moduleName = "LNPInvestmentAccountInfoBDB";
...
/*     */   public int getCount()
/*     */   {
/* 121 */     LNPInvestmentAccountInfoBSchema tSchema = getSchema();
/*     */ 
...
/* 129 */       tError.moduleName = "LNPInvestmentAccountInfoBDB";
...
/* 152 */       SQLString sqlObj = new SQLString("LNPInvestmentAccountInfoB");
/* 153 */       LNPInvestmentAccountInfoBSchema aSchema = getSchema();
...
/* 166 */           tError.moduleName = "LNPInvestmentAccountInfoBDB";
...
/* 193 */         tError.moduleName = "LNPInvestmentAccountInfoBDB";
...
/* 213 */       tError.moduleName = "LNPInvestmentAccountInfoBDB";
...
/* 248 */     LNPInvestmentAccountInfoBSet aLNPInvestmentAccountInfoBSet = new LNPInvestmentAccountInfoBSet();
/*     */ 
/* 250 */     if (!this.mflag) {
...
/* 257 */       SQLString sqlObj = new SQLString("LNPInvestmentAccountInfoB");
/* 258 */       LNPInvestmentAccountInfoBSchema aSchema = getSchema();
...
/*     */       {
/* 266 */         i++;
/* 267 */         LNPInvestmentAccountInfoBSchema s1 = new LNPInvestmentAccountInfoBSchema();
/* 268 */         s1.setSchema(rs, i);
/* 269 */         aLNPInvestmentAccountInfoBSet.add(s1);
/*     */       }try {
...
/* 278 */       tError.moduleName = "LNPInvestmentAccountInfoBDB";
...
/*     */       }
/*     */     }
/* 305 */     return aLNPInvestmentAccountInfoBSet;
/*     */   }
/*     */ 
...
/* 312 */     LNPInvestmentAccountInfoBSet aLNPInvestmentAccountInfoBSet = new LNPInvestmentAccountInfoBSet();
/*     */ 
/* 314 */     if (!this.mflag) {
...
/*     */       {
/* 326 */         i++;
/* 327 */         LNPInvestmentAccountInfoBSchema s1 = new LNPInvestmentAccountInfoBSchema();
/* 328 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 331 */           CError tError = new CError();
/* 332 */           tError.moduleName = "LNPInvestmentAccountInfoBDB";
...
/*     */         }
/* 337 */         aLNPInvestmentAccountInfoBSet.add(s1);
/*     */       }try {
...
/* 346 */       tError.moduleName = "LNPInvestmentAccountInfoBDB";
...
/*     */       }
/*     */     }
/* 373 */     return aLNPInvestmentAccountInfoBSet;
/*     */   }
/*     */ 
...
/* 380 */     LNPInvestmentAccountInfoBSet aLNPInvestmentAccountInfoBSet = new LNPInvestmentAccountInfoBSet();
/*     */ 
/* 382 */     if (!this.mflag) {
...
/* 389 */       SQLString sqlObj = new SQLString("LNPInvestmentAccountInfoB");
/* 390 */       LNPInvestmentAccountInfoBSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 408 */         LNPInvestmentAccountInfoBSchema s1 = new LNPInvestmentAccountInfoBSchema();
/* 409 */         s1.setSchema(rs, i);
/* 410 */         aLNPInvestmentAccountInfoBSet.add(s1);
/*     */       }try {
...
/* 419 */       tError.moduleName = "LNPInvestmentAccountInfoBDB";
...
/*     */       }
/*     */     }
/* 446 */     return aLNPInvestmentAccountInfoBSet;
/*     */   }
/*     */ 
...
/* 453 */     LNPInvestmentAccountInfoBSet aLNPInvestmentAccountInfoBSet = new LNPInvestmentAccountInfoBSet();
/*     */ 
/* 455 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 477 */         LNPInvestmentAccountInfoBSchema s1 = new LNPInvestmentAccountInfoBSchema();
/* 478 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 481 */           CError tError = new CError();
/* 482 */           tError.moduleName = "LNPInvestmentAccountInfoBDB";
...
/*     */         }
/* 487 */         aLNPInvestmentAccountInfoBSet.add(s1);
/*     */       }try {
...
/* 496 */       tError.moduleName = "LNPInvestmentAccountInfoBDB";
...
/*     */       }
/*     */     }
/* 523 */     return aLNPInvestmentAccountInfoBSet;
/*     */   }
/*     */ 
...
/* 537 */       SQLString sqlObj = new SQLString("LNPInvestmentAccountInfoB");
/* 538 */       LNPInvestmentAccountInfoBSchema aSchema = getSchema();
/* 539 */       sqlObj.setSQL(2, aSchema);
/* 540 */       String sql = "update LNPInvestmentAccountInfoB " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 542 */       int operCount = stmt.executeUpdate(sql);
/* 543 */       if (operCount == 0)
/*     */       {
/* 546 */         CError tError = new CError();
/* 547 */         tError.moduleName = "LNPInvestmentAccountInfoBDB";
...
/* 567 */       tError.moduleName = "LNPInvestmentAccountInfoBDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPInvestmentAccountInfoBDB
