...
/*   33 */     this.db = new DBOper(this.con, "LNPOperatorTrace");
/*   34 */     this.mflag = true;
/*      */   }
/*      */ 
...
/*      */   {
/*   39 */     this.con = null;
/*   40 */     this.db = new DBOper("LNPOperatorTrace");
/*   41 */     this.mflag = false;
/*      */   }
/*      */ 
/*      */   public boolean deleteSQL()
/*      */   {
/*   47 */     LNPOperatorTraceSchema tSchema = getSchema();
...
/*   57 */     tError.moduleName = "LNPOperatorTraceDB";
...
/*      */   public int getCount()
/*      */   {
/*   67 */     LNPOperatorTraceSchema tSchema = getSchema();
/*      */ 
...
/*   75 */       tError.moduleName = "LNPOperatorTraceDB";
...
/*      */     try
/*      */     {
/*   96 */       pstmt = this.con.prepareStatement("DELETE FROM LNPOperatorTrace WHERE  ID = ?");
...
/*  108 */       tError.moduleName = "LNPOperatorTraceDB";
...
/*      */     try
/*      */     {
/*  145 */       pstmt = this.con.prepareStatement("UPDATE LNPOperatorTrace SET  ID = ? , Contno = ? , Operator = ? , OperatorDate = ? , OperatorTime = ? , OperatorType = ? , Int1 = ? , Int2 = ? , Varc1 = ? , Varc2 = ? , Varc5 = ? , Varc3 = ? , Varc4 = ? , Varc6 = ? , Date1 = ? , Date2 = ? WHERE  ID = ?");
...
/*  230 */       tError.moduleName = "LNPOperatorTraceDB";
...
/*      */     try
/*      */     {
/*  267 */       pstmt = this.con.prepareStatement("INSERT INTO LNPOperatorTrace VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/*  347 */       tError.moduleName = "LNPOperatorTraceDB";
...
/*      */     try
/*      */     {
/*  385 */       pstmt = this.con.prepareStatement("SELECT * FROM LNPOperatorTrace WHERE  ID = ?", 
/*  386 */         1003, 1007);
...
/*  401 */           tError.moduleName = "LNPOperatorTraceDB";
...
/*  441 */       tError.moduleName = "LNPOperatorTraceDB";
...
/*  476 */     LNPOperatorTraceSet aLNPOperatorTraceSet = new LNPOperatorTraceSet();
/*      */ 
/*  478 */     if (!this.mflag) {
...
/*  485 */       SQLString sqlObj = new SQLString("LNPOperatorTrace");
/*  486 */       LNPOperatorTraceSchema aSchema = getSchema();
...
/*      */       {
/*  494 */         i++;
/*  495 */         LNPOperatorTraceSchema s1 = new LNPOperatorTraceSchema();
/*  496 */         s1.setSchema(rs, i);
/*  497 */         aLNPOperatorTraceSet.add(s1);
/*      */       }try {
...
/*  506 */       tError.moduleName = "LNPOperatorTraceDB";
...
/*      */       }
/*      */     }
/*  533 */     return aLNPOperatorTraceSet;
/*      */   }
/*      */ 
...
/*  540 */     LNPOperatorTraceSet aLNPOperatorTraceSet = new LNPOperatorTraceSet();
/*      */ 
/*  542 */     if (!this.mflag) {
...
/*      */       {
/*  554 */         i++;
/*  555 */         LNPOperatorTraceSchema s1 = new LNPOperatorTraceSchema();
/*  556 */         if (!s1.setSchema(rs, i))
/*      */         {
/*  559 */           CError tError = new CError();
/*  560 */           tError.moduleName = "LNPOperatorTraceDB";
...
/*      */         }
/*  565 */         aLNPOperatorTraceSet.add(s1);
/*      */       }try {
...
/*  574 */       tError.moduleName = "LNPOperatorTraceDB";
...
/*      */       }
/*      */     }
/*  601 */     return aLNPOperatorTraceSet;
/*      */   }
/*      */ 
...
/*  608 */     LNPOperatorTraceSet aLNPOperatorTraceSet = new LNPOperatorTraceSet();
/*      */ 
/*  610 */     if (!this.mflag) {
...
/*  617 */       SQLString sqlObj = new SQLString("LNPOperatorTrace");
/*  618 */       LNPOperatorTraceSchema aSchema = getSchema();
...
/*      */           break;
/*      */         }
/*  636 */         LNPOperatorTraceSchema s1 = new LNPOperatorTraceSchema();
/*  637 */         s1.setSchema(rs, i);
/*  638 */         aLNPOperatorTraceSet.add(s1);
/*      */       }try {
...
/*  647 */       tError.moduleName = "LNPOperatorTraceDB";
...
/*      */       }
/*      */     }
/*  674 */     return aLNPOperatorTraceSet;
/*      */   }
/*      */ 
...
/*  681 */     LNPOperatorTraceSet aLNPOperatorTraceSet = new LNPOperatorTraceSet();
/*      */ 
/*  683 */     if (!this.mflag) {
...
/*      */           break;
/*      */         }
/*  705 */         LNPOperatorTraceSchema s1 = new LNPOperatorTraceSchema();
/*  706 */         if (!s1.setSchema(rs, i))
/*      */         {
/*  709 */           CError tError = new CError();
/*  710 */           tError.moduleName = "LNPOperatorTraceDB";
...
/*      */         }
/*  715 */         aLNPOperatorTraceSet.add(s1);
/*      */       }try {
...
/*  724 */       tError.moduleName = "LNPOperatorTraceDB";
...
/*      */       }
/*      */     }
/*  751 */     return aLNPOperatorTraceSet;
/*      */   }
/*      */ 
...
/*  765 */       SQLString sqlObj = new SQLString("LNPOperatorTrace");
/*  766 */       LNPOperatorTraceSchema aSchema = getSchema();
/*  767 */       sqlObj.setSQL(2, aSchema);
/*  768 */       String sql = "update LNPOperatorTrace " + sqlObj.getUpdPart() + " where " + strWherePart;
/*      */ 
/*  770 */       int operCount = stmt.executeUpdate(sql);
/*  771 */       if (operCount == 0)
/*      */       {
/*  774 */         CError tError = new CError();
/*  775 */         tError.moduleName = "LNPOperatorTraceDB";
...
/*  795 */       tError.moduleName = "LNPOperatorTraceDB";
...
/*  832 */       tError.moduleName = "LNPOperatorTraceDB";
...
/*  852 */       tError.moduleName = "LNPOperatorTraceDB";
...
/*  899 */       tError.moduleName = "LNPOperatorTraceDB";
...
/*  912 */       tError.moduleName = "LNPOperatorTraceDB";
...
/*      */   {
/*  946 */     int tCount = 0;
/*  947 */     LNPOperatorTraceSet tLNPOperatorTraceSet = new LNPOperatorTraceSet();
/*  948 */     LNPOperatorTraceSchema tLNPOperatorTraceSchema = null;
/*  949 */     if (this.mResultSet == null)
/*      */     {
/*  951 */       CError tError = new CError();
/*  952 */       tError.moduleName = "LNPOperatorTraceDB";
...
/*      */     {
/*  960 */       tCount = 1;
/*  961 */       tLNPOperatorTraceSchema = new LNPOperatorTraceSchema();
/*  962 */       tLNPOperatorTraceSchema.setSchema(this.mResultSet, 1);
/*  963 */       tLNPOperatorTraceSet.add(tLNPOperatorTraceSchema);
/*      */ 
/*  965 */       while (tCount++ < 5000)
/*      */       {
/*  967 */         if (!this.mResultSet.next())
/*      */           continue;
/*  969 */         tLNPOperatorTraceSchema = new LNPOperatorTraceSchema();
/*  970 */         tLNPOperatorTraceSchema.setSchema(this.mResultSet, 1);
/*  971 */         tLNPOperatorTraceSet.add(tLNPOperatorTraceSchema);
/*      */       }
/*      */ 
/*      */     }
/*      */     catch (Exception ex)
...
/*  978 */       tError.moduleName = "LNPOperatorTraceDB";
...
/* 1005 */       return null;
/*      */     }
/* 1007 */     return tLNPOperatorTraceSet;
/*      */   }
/*      */ 
...
/* 1018 */         tError.moduleName = "LNPOperatorTraceDB";
...
/* 1033 */       tError.moduleName = "LNPOperatorTraceDB";
...
/* 1044 */         tError.moduleName = "LNPOperatorTraceDB";
...
/* 1059 */       tError.moduleName = "LNPOperatorTraceDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPOperatorTraceDB
