...
/*     */   {
/*  37 */     this.con = null;
/*  38 */     this.db = new DBOper("LNPBonusInfoB");
/*  39 */     this.mflag = false;
/*     */   }
/*     */ 
/*     */   public boolean insert()
/*     */   {
/*  45 */     LNPBonusInfoBSchema tSchema = getSchema();
/*  46 */     if (!this.db.insert(tSchema))
/*     */     {
/*  49 */       this.mErrors.copyAllErrors(this.db.mErrors);
/*  50 */       CError tError = new CError();
/*  51 */       tError.moduleName = "LNPBonusInfoBDB";
...
/*     */   public int getCount()
/*     */   {
/* 121 */     LNPBonusInfoBSchema tSchema = getSchema();
/*     */ 
...
/* 129 */       tError.moduleName = "LNPBonusInfoBDB";
...
/* 152 */       SQLString sqlObj = new SQLString("LNPBonusInfoB");
/* 153 */       LNPBonusInfoBSchema aSchema = getSchema();
...
/* 166 */           tError.moduleName = "LNPBonusInfoBDB";
...
/* 193 */         tError.moduleName = "LNPBonusInfoBDB";
...
/* 213 */       tError.moduleName = "LNPBonusInfoBDB";
...
/* 248 */     LNPBonusInfoBSet aLNPBonusInfoBSet = new LNPBonusInfoBSet();
/*     */ 
/* 250 */     if (!this.mflag) {
...
/* 257 */       SQLString sqlObj = new SQLString("LNPBonusInfoB");
/* 258 */       LNPBonusInfoBSchema aSchema = getSchema();
...
/*     */       {
/* 266 */         i++;
/* 267 */         LNPBonusInfoBSchema s1 = new LNPBonusInfoBSchema();
/* 268 */         s1.setSchema(rs, i);
/* 269 */         aLNPBonusInfoBSet.add(s1);
/*     */       }try {
...
/* 278 */       tError.moduleName = "LNPBonusInfoBDB";
...
/* 312 */     LNPBonusInfoBSet aLNPBonusInfoBSet = new LNPBonusInfoBSet();
/*     */ 
/* 314 */     if (!this.mflag) {
...
/*     */       {
/* 326 */         i++;
/* 327 */         LNPBonusInfoBSchema s1 = new LNPBonusInfoBSchema();
/* 328 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 331 */           CError tError = new CError();
/* 332 */           tError.moduleName = "LNPBonusInfoBDB";
...
/* 346 */       tError.moduleName = "LNPBonusInfoBDB";
...
/* 380 */     LNPBonusInfoBSet aLNPBonusInfoBSet = new LNPBonusInfoBSet();
/*     */ 
/* 382 */     if (!this.mflag) {
...
/* 389 */       SQLString sqlObj = new SQLString("LNPBonusInfoB");
/* 390 */       LNPBonusInfoBSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 408 */         LNPBonusInfoBSchema s1 = new LNPBonusInfoBSchema();
/* 409 */         s1.setSchema(rs, i);
/* 410 */         aLNPBonusInfoBSet.add(s1);
/*     */       }try {
...
/* 419 */       tError.moduleName = "LNPBonusInfoBDB";
...
/* 453 */     LNPBonusInfoBSet aLNPBonusInfoBSet = new LNPBonusInfoBSet();
/*     */ 
/* 455 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 477 */         LNPBonusInfoBSchema s1 = new LNPBonusInfoBSchema();
/* 478 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 481 */           CError tError = new CError();
/* 482 */           tError.moduleName = "LNPBonusInfoBDB";
...
/* 496 */       tError.moduleName = "LNPBonusInfoBDB";
...
/* 537 */       SQLString sqlObj = new SQLString("LNPBonusInfoB");
/* 538 */       LNPBonusInfoBSchema aSchema = getSchema();
/* 539 */       sqlObj.setSQL(2, aSchema);
/* 540 */       String sql = "update LNPBonusInfoB " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 542 */       int operCount = stmt.executeUpdate(sql);
/* 543 */       if (operCount == 0)
/*     */       {
/* 546 */         CError tError = new CError();
/* 547 */         tError.moduleName = "LNPBonusInfoBDB";
...
/* 567 */       tError.moduleName = "LNPBonusInfoBDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPBonusInfoBDB
