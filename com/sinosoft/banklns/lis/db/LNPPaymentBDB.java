...
/*  31 */     this.db = new DBOper(this.con, "LNPPaymentB");
/*  32 */     this.mflag = true;
/*     */   }
/*     */ 
...
/*     */   {
/*  37 */     this.con = null;
/*  38 */     this.db = new DBOper("LNPPaymentB");
/*  39 */     this.mflag = false;
/*     */   }
/*     */ 
/*     */   public boolean insert()
/*     */   {
/*  45 */     LNPPaymentBSchema tSchema = getSchema();
/*  46 */     if (!this.db.insert(tSchema))
/*     */     {
/*  49 */       this.mErrors.copyAllErrors(this.db.mErrors);
/*  50 */       CError tError = new CError();
/*  51 */       tError.moduleName = "LNPPaymentBDB";
...
/*     */   public int getCount()
/*     */   {
/* 121 */     LNPPaymentBSchema tSchema = getSchema();
/*     */ 
...
/* 129 */       tError.moduleName = "LNPPaymentBDB";
...
/* 152 */       SQLString sqlObj = new SQLString("LNPPaymentB");
/* 153 */       LNPPaymentBSchema aSchema = getSchema();
...
/* 166 */           tError.moduleName = "LNPPaymentBDB";
...
/* 193 */         tError.moduleName = "LNPPaymentBDB";
...
/* 213 */       tError.moduleName = "LNPPaymentBDB";
...
/* 248 */     LNPPaymentBSet aLNPPaymentBSet = new LNPPaymentBSet();
/*     */ 
/* 250 */     if (!this.mflag) {
...
/* 257 */       SQLString sqlObj = new SQLString("LNPPaymentB");
/* 258 */       LNPPaymentBSchema aSchema = getSchema();
...
/*     */       {
/* 266 */         i++;
/* 267 */         LNPPaymentBSchema s1 = new LNPPaymentBSchema();
/* 268 */         s1.setSchema(rs, i);
/* 269 */         aLNPPaymentBSet.add(s1);
/*     */       }try {
...
/* 278 */       tError.moduleName = "LNPPaymentBDB";
...
/* 312 */     LNPPaymentBSet aLNPPaymentBSet = new LNPPaymentBSet();
/*     */ 
/* 314 */     if (!this.mflag) {
...
/*     */       {
/* 326 */         i++;
/* 327 */         LNPPaymentBSchema s1 = new LNPPaymentBSchema();
/* 328 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 331 */           CError tError = new CError();
/* 332 */           tError.moduleName = "LNPPaymentBDB";
...
/* 346 */       tError.moduleName = "LNPPaymentBDB";
...
/* 380 */     LNPPaymentBSet aLNPPaymentBSet = new LNPPaymentBSet();
/*     */ 
/* 382 */     if (!this.mflag) {
...
/* 389 */       SQLString sqlObj = new SQLString("LNPPaymentB");
/* 390 */       LNPPaymentBSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 408 */         LNPPaymentBSchema s1 = new LNPPaymentBSchema();
/* 409 */         s1.setSchema(rs, i);
/* 410 */         aLNPPaymentBSet.add(s1);
/*     */       }try {
...
/* 419 */       tError.moduleName = "LNPPaymentBDB";
...
/* 453 */     LNPPaymentBSet aLNPPaymentBSet = new LNPPaymentBSet();
/*     */ 
/* 455 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 477 */         LNPPaymentBSchema s1 = new LNPPaymentBSchema();
/* 478 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 481 */           CError tError = new CError();
/* 482 */           tError.moduleName = "LNPPaymentBDB";
...
/* 496 */       tError.moduleName = "LNPPaymentBDB";
...
/* 537 */       SQLString sqlObj = new SQLString("LNPPaymentB");
/* 538 */       LNPPaymentBSchema aSchema = getSchema();
/* 539 */       sqlObj.setSQL(2, aSchema);
/* 540 */       String sql = "update LNPPaymentB " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 542 */       int operCount = stmt.executeUpdate(sql);
/* 543 */       if (operCount == 0)
/*     */       {
/* 546 */         CError tError = new CError();
/* 547 */         tError.moduleName = "LNPPaymentBDB";
...
/* 567 */       tError.moduleName = "LNPPaymentBDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPPaymentBDB
