...
/*     */ 
/*     */ public class LNPInvestmentInfoDB extends LNPInvestmentInfoSchema
/*     */ {
...
/*     */ 
/*     */   public LNPInvestmentInfoDB(Connection tConnection)
/*     */   {
/*  30 */     this.con = tConnection;
/*  31 */     this.db = new DBOper(this.con, "LNPInvestmentInfo");
/*  32 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPInvestmentInfoDB()
/*     */   {
/*  37 */     this.con = null;
/*  38 */     this.db = new DBOper("LNPInvestmentInfo");
/*  39 */     this.mflag = false;
/*     */   }
/*     */ 
/*     */   public boolean insert()
/*     */   {
/*  45 */     LNPInvestmentInfoSchema tSchema = getSchema();
/*  46 */     if (!this.db.insert(tSchema))
/*     */     {
/*  49 */       this.mErrors.copyAllErrors(this.db.mErrors);
/*  50 */       CError tError = new CError();
/*  51 */       tError.moduleName = "LNPInvestmentInfoDB";
...
/*     */   public int getCount()
/*     */   {
/* 121 */     LNPInvestmentInfoSchema tSchema = getSchema();
/*     */ 
...
/* 129 */       tError.moduleName = "LNPInvestmentInfoDB";
...
/* 152 */       SQLString sqlObj = new SQLString("LNPInvestmentInfo");
/* 153 */       LNPInvestmentInfoSchema aSchema = getSchema();
...
/* 166 */           tError.moduleName = "LNPInvestmentInfoDB";
...
/* 193 */         tError.moduleName = "LNPInvestmentInfoDB";
...
/* 213 */       tError.moduleName = "LNPInvestmentInfoDB";
...
/*     */   }
/*     */ 
/*     */   public LNPInvestmentInfoSet query()
/*     */   {
/* 246 */     Statement stmt = null;
/* 247 */     ResultSet rs = null;
/* 248 */     LNPInvestmentInfoSet aLNPInvestmentInfoSet = new LNPInvestmentInfoSet();
/*     */ 
/* 250 */     if (!this.mflag) {
...
/* 257 */       SQLString sqlObj = new SQLString("LNPInvestmentInfo");
/* 258 */       LNPInvestmentInfoSchema aSchema = getSchema();
...
/*     */       {
/* 266 */         i++;
/* 267 */         LNPInvestmentInfoSchema s1 = new LNPInvestmentInfoSchema();
/* 268 */         s1.setSchema(rs, i);
/* 269 */         aLNPInvestmentInfoSet.add(s1);
/*     */       }try {
...
/* 278 */       tError.moduleName = "LNPInvestmentInfoDB";
...
/*     */       }
/*     */     }
/* 305 */     return aLNPInvestmentInfoSet;
/*     */   }
/*     */ 
/*     */   public LNPInvestmentInfoSet executeQuery(String sql)
/*     */   {
/* 310 */     Statement stmt = null;
/* 311 */     ResultSet rs = null;
/* 312 */     LNPInvestmentInfoSet aLNPInvestmentInfoSet = new LNPInvestmentInfoSet();
/*     */ 
/* 314 */     if (!this.mflag) {
...
/*     */       {
/* 326 */         i++;
/* 327 */         LNPInvestmentInfoSchema s1 = new LNPInvestmentInfoSchema();
/* 328 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 331 */           CError tError = new CError();
/* 332 */           tError.moduleName = "LNPInvestmentInfoDB";
...
/*     */         }
/* 337 */         aLNPInvestmentInfoSet.add(s1);
/*     */       }try {
...
/* 346 */       tError.moduleName = "LNPInvestmentInfoDB";
...
/*     */       }
/*     */     }
/* 373 */     return aLNPInvestmentInfoSet;
/*     */   }
/*     */ 
/*     */   public LNPInvestmentInfoSet query(int nStart, int nCount)
/*     */   {
/* 378 */     Statement stmt = null;
/* 379 */     ResultSet rs = null;
/* 380 */     LNPInvestmentInfoSet aLNPInvestmentInfoSet = new LNPInvestmentInfoSet();
/*     */ 
/* 382 */     if (!this.mflag) {
...
/* 389 */       SQLString sqlObj = new SQLString("LNPInvestmentInfo");
/* 390 */       LNPInvestmentInfoSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 408 */         LNPInvestmentInfoSchema s1 = new LNPInvestmentInfoSchema();
/* 409 */         s1.setSchema(rs, i);
/* 410 */         aLNPInvestmentInfoSet.add(s1);
/*     */       }try {
...
/* 419 */       tError.moduleName = "LNPInvestmentInfoDB";
...
/*     */       }
/*     */     }
/* 446 */     return aLNPInvestmentInfoSet;
/*     */   }
/*     */ 
/*     */   public LNPInvestmentInfoSet executeQuery(String sql, int nStart, int nCount)
/*     */   {
/* 451 */     Statement stmt = null;
/* 452 */     ResultSet rs = null;
/* 453 */     LNPInvestmentInfoSet aLNPInvestmentInfoSet = new LNPInvestmentInfoSet();
/*     */ 
/* 455 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 477 */         LNPInvestmentInfoSchema s1 = new LNPInvestmentInfoSchema();
/* 478 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 481 */           CError tError = new CError();
/* 482 */           tError.moduleName = "LNPInvestmentInfoDB";
...
/*     */         }
/* 487 */         aLNPInvestmentInfoSet.add(s1);
/*     */       }try {
...
/* 496 */       tError.moduleName = "LNPInvestmentInfoDB";
...
/*     */       }
/*     */     }
/* 523 */     return aLNPInvestmentInfoSet;
/*     */   }
/*     */ 
...
/* 537 */       SQLString sqlObj = new SQLString("LNPInvestmentInfo");
/* 538 */       LNPInvestmentInfoSchema aSchema = getSchema();
/* 539 */       sqlObj.setSQL(2, aSchema);
/* 540 */       String sql = "update LNPInvestmentInfo " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 542 */       int operCount = stmt.executeUpdate(sql);
/* 543 */       if (operCount == 0)
/*     */       {
/* 546 */         CError tError = new CError();
/* 547 */         tError.moduleName = "LNPInvestmentInfoDB";
...
/* 567 */       tError.moduleName = "LNPInvestmentInfoDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPInvestmentInfoDB
