...
/*     */ 
/*     */ public class LNPInvestmentInfoBDB extends LNPInvestmentInfoBSchema
/*     */ {
...
/*     */ 
/*     */   public LNPInvestmentInfoBDB(Connection tConnection)
/*     */   {
/*  30 */     this.con = tConnection;
/*  31 */     this.db = new DBOper(this.con, "LNPInvestmentInfoB");
/*  32 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPInvestmentInfoBDB()
/*     */   {
/*  37 */     this.con = null;
/*  38 */     this.db = new DBOper("LNPInvestmentInfoB");
/*  39 */     this.mflag = false;
/*     */   }
/*     */ 
/*     */   public boolean insert()
/*     */   {
/*  45 */     LNPInvestmentInfoBSchema tSchema = getSchema();
/*  46 */     if (!this.db.insert(tSchema))
/*     */     {
/*  49 */       this.mErrors.copyAllErrors(this.db.mErrors);
/*  50 */       CError tError = new CError();
/*  51 */       tError.moduleName = "LNPInvestmentInfoBDB";
...
/*     */   public int getCount()
/*     */   {
/* 121 */     LNPInvestmentInfoBSchema tSchema = getSchema();
/*     */ 
...
/* 129 */       tError.moduleName = "LNPInvestmentInfoBDB";
...
/* 152 */       SQLString sqlObj = new SQLString("LNPInvestmentInfoB");
/* 153 */       LNPInvestmentInfoBSchema aSchema = getSchema();
...
/* 166 */           tError.moduleName = "LNPInvestmentInfoBDB";
...
/* 193 */         tError.moduleName = "LNPInvestmentInfoBDB";
...
/* 213 */       tError.moduleName = "LNPInvestmentInfoBDB";
...
/*     */   }
/*     */ 
/*     */   public LNPInvestmentInfoBSet query()
/*     */   {
/* 246 */     Statement stmt = null;
/* 247 */     ResultSet rs = null;
/* 248 */     LNPInvestmentInfoBSet aLNPInvestmentInfoBSet = new LNPInvestmentInfoBSet();
/*     */ 
/* 250 */     if (!this.mflag) {
...
/* 257 */       SQLString sqlObj = new SQLString("LNPInvestmentInfoB");
/* 258 */       LNPInvestmentInfoBSchema aSchema = getSchema();
...
/*     */       {
/* 266 */         i++;
/* 267 */         LNPInvestmentInfoBSchema s1 = new LNPInvestmentInfoBSchema();
/* 268 */         s1.setSchema(rs, i);
/* 269 */         aLNPInvestmentInfoBSet.add(s1);
/*     */       }try {
...
/* 278 */       tError.moduleName = "LNPInvestmentInfoBDB";
...
/*     */       }
/*     */     }
/* 305 */     return aLNPInvestmentInfoBSet;
/*     */   }
/*     */ 
/*     */   public LNPInvestmentInfoBSet executeQuery(String sql)
/*     */   {
/* 310 */     Statement stmt = null;
/* 311 */     ResultSet rs = null;
/* 312 */     LNPInvestmentInfoBSet aLNPInvestmentInfoBSet = new LNPInvestmentInfoBSet();
/*     */ 
/* 314 */     if (!this.mflag) {
...
/*     */       {
/* 326 */         i++;
/* 327 */         LNPInvestmentInfoBSchema s1 = new LNPInvestmentInfoBSchema();
/* 328 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 331 */           CError tError = new CError();
/* 332 */           tError.moduleName = "LNPInvestmentInfoBDB";
...
/*     */         }
/* 337 */         aLNPInvestmentInfoBSet.add(s1);
/*     */       }try {
...
/* 346 */       tError.moduleName = "LNPInvestmentInfoBDB";
...
/*     */       }
/*     */     }
/* 373 */     return aLNPInvestmentInfoBSet;
/*     */   }
/*     */ 
/*     */   public LNPInvestmentInfoBSet query(int nStart, int nCount)
/*     */   {
/* 378 */     Statement stmt = null;
/* 379 */     ResultSet rs = null;
/* 380 */     LNPInvestmentInfoBSet aLNPInvestmentInfoBSet = new LNPInvestmentInfoBSet();
/*     */ 
/* 382 */     if (!this.mflag) {
...
/* 389 */       SQLString sqlObj = new SQLString("LNPInvestmentInfoB");
/* 390 */       LNPInvestmentInfoBSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 408 */         LNPInvestmentInfoBSchema s1 = new LNPInvestmentInfoBSchema();
/* 409 */         s1.setSchema(rs, i);
/* 410 */         aLNPInvestmentInfoBSet.add(s1);
/*     */       }try {
...
/* 419 */       tError.moduleName = "LNPInvestmentInfoBDB";
...
/*     */       }
/*     */     }
/* 446 */     return aLNPInvestmentInfoBSet;
/*     */   }
/*     */ 
/*     */   public LNPInvestmentInfoBSet executeQuery(String sql, int nStart, int nCount)
/*     */   {
/* 451 */     Statement stmt = null;
/* 452 */     ResultSet rs = null;
/* 453 */     LNPInvestmentInfoBSet aLNPInvestmentInfoBSet = new LNPInvestmentInfoBSet();
/*     */ 
/* 455 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 477 */         LNPInvestmentInfoBSchema s1 = new LNPInvestmentInfoBSchema();
/* 478 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 481 */           CError tError = new CError();
/* 482 */           tError.moduleName = "LNPInvestmentInfoBDB";
...
/*     */         }
/* 487 */         aLNPInvestmentInfoBSet.add(s1);
/*     */       }try {
...
/* 496 */       tError.moduleName = "LNPInvestmentInfoBDB";
...
/*     */       }
/*     */     }
/* 523 */     return aLNPInvestmentInfoBSet;
/*     */   }
/*     */ 
...
/* 537 */       SQLString sqlObj = new SQLString("LNPInvestmentInfoB");
/* 538 */       LNPInvestmentInfoBSchema aSchema = getSchema();
/* 539 */       sqlObj.setSQL(2, aSchema);
/* 540 */       String sql = "update LNPInvestmentInfoB " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 542 */       int operCount = stmt.executeUpdate(sql);
/* 543 */       if (operCount == 0)
/*     */       {
/* 546 */         CError tError = new CError();
/* 547 */         tError.moduleName = "LNPInvestmentInfoBDB";
...
/* 567 */       tError.moduleName = "LNPInvestmentInfoBDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPInvestmentInfoBDB
