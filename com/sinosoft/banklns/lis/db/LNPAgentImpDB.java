...
/*      */ import com.sinosoft.banklns.lis.vschema.LNPAgentImpSet;
...
/*      */ 
/*      */ public class LNPAgentImpDB extends LNPAgentImpSchema
/*      */ {
...
/*      */ 
/*      */   public LNPAgentImpDB(Connection tConnection)
/*      */   {
/*   32 */     this.con = tConnection;
/*   33 */     this.db = new DBOper(this.con, "LNPAgentImp");
/*   34 */     this.mflag = true;
/*      */   }
/*      */ 
/*      */   public LNPAgentImpDB()
/*      */   {
/*   39 */     this.con = null;
/*   40 */     this.db = new DBOper("LNPAgentImp");
/*   41 */     this.mflag = false;
/*      */   }
/*      */ 
/*      */   public boolean deleteSQL()
/*      */   {
/*   47 */     LNPAgentImpSchema tSchema = getSchema();
...
/*   57 */     tError.moduleName = "LNPAgentImpDB";
...
/*      */   public int getCount()
/*      */   {
/*   67 */     LNPAgentImpSchema tSchema = getSchema();
/*      */ 
...
/*   75 */       tError.moduleName = "LNPAgentImpDB";
...
/*      */     try
/*      */     {
/*   96 */       pstmt = this.con.prepareStatement("DELETE FROM LNPAgentImp WHERE  ImpartId = ?");
...
/*  108 */       tError.moduleName = "LNPAgentImpDB";
...
/*      */     try
/*      */     {
/*  145 */       pstmt = this.con.prepareStatement("UPDATE LNPAgentImp SET  ImpartId = ? , ImpartName = ? , ImpartVer = ? , ImpartContent = ? , QuestionSum = ? , Operator = ? , ManageCom = ? , MakeTime = ? , MakeDate = ? , ModifyDate = ? , ModifyTime = ? , p1 = ? , p2 = ? , p3 = ? , p4 = ? WHERE  ImpartId = ?");
...
/*  229 */       tError.moduleName = "LNPAgentImpDB";
...
/*      */     try
/*      */     {
/*  266 */       pstmt = this.con.prepareStatement("INSERT INTO LNPAgentImp VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/*  345 */       tError.moduleName = "LNPAgentImpDB";
...
/*      */     try
/*      */     {
/*  383 */       pstmt = this.con.prepareStatement("SELECT * FROM LNPAgentImp WHERE  ImpartId = ?", 
/*  384 */         1003, 1007);
...
/*  399 */           tError.moduleName = "LNPAgentImpDB";
...
/*  439 */       tError.moduleName = "LNPAgentImpDB";
...
/*      */   }
/*      */ 
/*      */   public LNPAgentImpSet query()
/*      */   {
/*  472 */     Statement stmt = null;
/*  473 */     ResultSet rs = null;
/*  474 */     LNPAgentImpSet aLNPAgentImpSet = new LNPAgentImpSet();
/*      */ 
/*  476 */     if (!this.mflag) {
...
/*  483 */       SQLString sqlObj = new SQLString("LNPAgentImp");
/*  484 */       LNPAgentImpSchema aSchema = getSchema();
...
/*      */       {
/*  492 */         i++;
/*  493 */         LNPAgentImpSchema s1 = new LNPAgentImpSchema();
/*  494 */         s1.setSchema(rs, i);
/*  495 */         aLNPAgentImpSet.add(s1);
/*      */       }try {
...
/*  504 */       tError.moduleName = "LNPAgentImpDB";
...
/*      */       }
/*      */     }
/*  531 */     return aLNPAgentImpSet;
/*      */   }
/*      */ 
/*      */   public LNPAgentImpSet executeQuery(String sql)
/*      */   {
/*  536 */     Statement stmt = null;
/*  537 */     ResultSet rs = null;
/*  538 */     LNPAgentImpSet aLNPAgentImpSet = new LNPAgentImpSet();
/*      */ 
/*  540 */     if (!this.mflag) {
...
/*      */       {
/*  552 */         i++;
/*  553 */         LNPAgentImpSchema s1 = new LNPAgentImpSchema();
/*  554 */         if (!s1.setSchema(rs, i))
/*      */         {
/*  557 */           CError tError = new CError();
/*  558 */           tError.moduleName = "LNPAgentImpDB";
...
/*  572 */       tError.moduleName = "LNPAgentImpDB";
...
/*      */       }
/*      */     }
/*  599 */     return aLNPAgentImpSet;
/*      */   }
/*      */ 
/*      */   public LNPAgentImpSet query(int nStart, int nCount)
/*      */   {
/*  604 */     Statement stmt = null;
/*  605 */     ResultSet rs = null;
/*  606 */     LNPAgentImpSet aLNPAgentImpSet = new LNPAgentImpSet();
/*      */ 
/*  608 */     if (!this.mflag) {
...
/*  615 */       SQLString sqlObj = new SQLString("LNPAgentImp");
/*  616 */       LNPAgentImpSchema aSchema = getSchema();
...
/*      */           break;
/*      */         }
/*  634 */         LNPAgentImpSchema s1 = new LNPAgentImpSchema();
/*  635 */         s1.setSchema(rs, i);
/*  636 */         aLNPAgentImpSet.add(s1);
/*      */       }try {
...
/*  645 */       tError.moduleName = "LNPAgentImpDB";
...
/*      */       }
/*      */     }
/*  672 */     return aLNPAgentImpSet;
/*      */   }
/*      */ 
/*      */   public LNPAgentImpSet executeQuery(String sql, int nStart, int nCount)
/*      */   {
/*  677 */     Statement stmt = null;
/*  678 */     ResultSet rs = null;
/*  679 */     LNPAgentImpSet aLNPAgentImpSet = new LNPAgentImpSet();
/*      */ 
/*  681 */     if (!this.mflag) {
...
/*      */           break;
/*      */         }
/*  703 */         LNPAgentImpSchema s1 = new LNPAgentImpSchema();
/*  704 */         if (!s1.setSchema(rs, i))
/*      */         {
/*  707 */           CError tError = new CError();
/*  708 */           tError.moduleName = "LNPAgentImpDB";
...
/*  722 */       tError.moduleName = "LNPAgentImpDB";
...
/*  763 */       SQLString sqlObj = new SQLString("LNPAgentImp");
/*  764 */       LNPAgentImpSchema aSchema = getSchema();
/*  765 */       sqlObj.setSQL(2, aSchema);
/*  766 */       String sql = "update LNPAgentImp " + sqlObj.getUpdPart() + " where " + strWherePart;
/*      */ 
/*  768 */       int operCount = stmt.executeUpdate(sql);
/*  769 */       if (operCount == 0)
/*      */       {
/*  772 */         CError tError = new CError();
/*  773 */         tError.moduleName = "LNPAgentImpDB";
...
/*  793 */       tError.moduleName = "LNPAgentImpDB";
...
/*  830 */       tError.moduleName = "LNPAgentImpDB";
...
/*  850 */       tError.moduleName = "LNPAgentImpDB";
...
/*  897 */       tError.moduleName = "LNPAgentImpDB";
...
/*  910 */       tError.moduleName = "LNPAgentImpDB";
...
/*      */   }
/*      */ 
/*      */   public LNPAgentImpSet getData()
/*      */   {
/*  944 */     int tCount = 0;
/*  945 */     LNPAgentImpSet tLNPAgentImpSet = new LNPAgentImpSet();
/*  946 */     LNPAgentImpSchema tLNPAgentImpSchema = null;
/*  947 */     if (this.mResultSet == null)
/*      */     {
/*  949 */       CError tError = new CError();
/*  950 */       tError.moduleName = "LNPAgentImpDB";
...
/*      */     {
/*  958 */       tCount = 1;
/*  959 */       tLNPAgentImpSchema = new LNPAgentImpSchema();
/*  960 */       tLNPAgentImpSchema.setSchema(this.mResultSet, 1);
/*  961 */       tLNPAgentImpSet.add(tLNPAgentImpSchema);
/*      */ 
/*  963 */       while (tCount++ < 5000)
/*      */       {
/*  965 */         if (!this.mResultSet.next())
/*      */           continue;
/*  967 */         tLNPAgentImpSchema = new LNPAgentImpSchema();
/*  968 */         tLNPAgentImpSchema.setSchema(this.mResultSet, 1);
/*  969 */         tLNPAgentImpSet.add(tLNPAgentImpSchema);
/*      */       }
/*      */ 
/*      */     }
/*      */     catch (Exception ex)
...
/*  976 */       tError.moduleName = "LNPAgentImpDB";
...
/* 1016 */         tError.moduleName = "LNPAgentImpDB";
...
/* 1031 */       tError.moduleName = "LNPAgentImpDB";
...
/* 1042 */         tError.moduleName = "LNPAgentImpDB";
...
/* 1057 */       tError.moduleName = "LNPAgentImpDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPAgentImpDB
