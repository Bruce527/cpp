...
/*     */ 
/*     */ public class LNPOperationRecordDB extends LNPOperationRecordSchema
/*     */ {
...
/*     */ 
/*     */   public LNPOperationRecordDB(Connection tConnection)
/*     */   {
/*  30 */     this.con = tConnection;
/*  31 */     this.db = new DBOper(this.con, "LNPOperationRecord");
/*  32 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPOperationRecordDB()
/*     */   {
/*  37 */     this.con = null;
/*  38 */     this.db = new DBOper("LNPOperationRecord");
/*  39 */     this.mflag = false;
/*     */   }
/*     */ 
/*     */   public boolean insert()
/*     */   {
/*  45 */     LNPOperationRecordSchema tSchema = getSchema();
/*  46 */     if (!this.db.insert(tSchema))
/*     */     {
/*  49 */       this.mErrors.copyAllErrors(this.db.mErrors);
/*  50 */       CError tError = new CError();
/*  51 */       tError.moduleName = "LNPOperationRecordDB";
...
/*     */   public int getCount()
/*     */   {
/* 121 */     LNPOperationRecordSchema tSchema = getSchema();
/*     */ 
...
/* 129 */       tError.moduleName = "LNPOperationRecordDB";
...
/* 152 */       SQLString sqlObj = new SQLString("LNPOperationRecord");
/* 153 */       LNPOperationRecordSchema aSchema = getSchema();
...
/* 166 */           tError.moduleName = "LNPOperationRecordDB";
...
/* 193 */         tError.moduleName = "LNPOperationRecordDB";
...
/* 213 */       tError.moduleName = "LNPOperationRecordDB";
...
/*     */   }
/*     */ 
/*     */   public LNPOperationRecordSet query()
/*     */   {
/* 246 */     Statement stmt = null;
/* 247 */     ResultSet rs = null;
/* 248 */     LNPOperationRecordSet aLNPOperationRecordSet = new LNPOperationRecordSet();
/*     */ 
/* 250 */     if (!this.mflag) {
...
/* 257 */       SQLString sqlObj = new SQLString("LNPOperationRecord");
/* 258 */       LNPOperationRecordSchema aSchema = getSchema();
...
/*     */       {
/* 266 */         i++;
/* 267 */         LNPOperationRecordSchema s1 = new LNPOperationRecordSchema();
/* 268 */         s1.setSchema(rs, i);
/* 269 */         aLNPOperationRecordSet.add(s1);
/*     */       }try {
...
/* 278 */       tError.moduleName = "LNPOperationRecordDB";
...
/*     */       }
/*     */     }
/* 305 */     return aLNPOperationRecordSet;
/*     */   }
/*     */ 
/*     */   public LNPOperationRecordSet executeQuery(String sql)
/*     */   {
/* 310 */     Statement stmt = null;
/* 311 */     ResultSet rs = null;
/* 312 */     LNPOperationRecordSet aLNPOperationRecordSet = new LNPOperationRecordSet();
/*     */ 
/* 314 */     if (!this.mflag) {
...
/*     */       {
/* 326 */         i++;
/* 327 */         LNPOperationRecordSchema s1 = new LNPOperationRecordSchema();
/* 328 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 331 */           CError tError = new CError();
/* 332 */           tError.moduleName = "LNPOperationRecordDB";
...
/*     */         }
/* 337 */         aLNPOperationRecordSet.add(s1);
/*     */       }try {
...
/* 346 */       tError.moduleName = "LNPOperationRecordDB";
...
/*     */       }
/*     */     }
/* 373 */     return aLNPOperationRecordSet;
/*     */   }
/*     */ 
/*     */   public LNPOperationRecordSet query(int nStart, int nCount)
/*     */   {
/* 378 */     Statement stmt = null;
/* 379 */     ResultSet rs = null;
/* 380 */     LNPOperationRecordSet aLNPOperationRecordSet = new LNPOperationRecordSet();
/*     */ 
/* 382 */     if (!this.mflag) {
...
/* 389 */       SQLString sqlObj = new SQLString("LNPOperationRecord");
/* 390 */       LNPOperationRecordSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 408 */         LNPOperationRecordSchema s1 = new LNPOperationRecordSchema();
/* 409 */         s1.setSchema(rs, i);
/* 410 */         aLNPOperationRecordSet.add(s1);
/*     */       }try {
...
/* 419 */       tError.moduleName = "LNPOperationRecordDB";
...
/*     */       }
/*     */     }
/* 446 */     return aLNPOperationRecordSet;
/*     */   }
/*     */ 
/*     */   public LNPOperationRecordSet executeQuery(String sql, int nStart, int nCount)
/*     */   {
/* 451 */     Statement stmt = null;
/* 452 */     ResultSet rs = null;
/* 453 */     LNPOperationRecordSet aLNPOperationRecordSet = new LNPOperationRecordSet();
/*     */ 
/* 455 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 477 */         LNPOperationRecordSchema s1 = new LNPOperationRecordSchema();
/* 478 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 481 */           CError tError = new CError();
/* 482 */           tError.moduleName = "LNPOperationRecordDB";
...
/*     */         }
/* 487 */         aLNPOperationRecordSet.add(s1);
/*     */       }try {
...
/* 496 */       tError.moduleName = "LNPOperationRecordDB";
...
/*     */       }
/*     */     }
/* 523 */     return aLNPOperationRecordSet;
/*     */   }
/*     */ 
...
/* 537 */       SQLString sqlObj = new SQLString("LNPOperationRecord");
/* 538 */       LNPOperationRecordSchema aSchema = getSchema();
/* 539 */       sqlObj.setSQL(2, aSchema);
/* 540 */       String sql = "update LNPOperationRecord " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 542 */       int operCount = stmt.executeUpdate(sql);
/* 543 */       if (operCount == 0)
/*     */       {
/* 546 */         CError tError = new CError();
/* 547 */         tError.moduleName = "LNPOperationRecordDB";
...
/* 567 */       tError.moduleName = "LNPOperationRecordDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPOperationRecordDB
