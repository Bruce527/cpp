...
/*     */   {
/*  37 */     this.con = null;
/*  38 */     this.db = new DBOper("LNPAgentInfoB");
/*  39 */     this.mflag = false;
/*     */   }
/*     */ 
/*     */   public boolean insert()
/*     */   {
/*  45 */     LNPAgentInfoBSchema tSchema = getSchema();
/*  46 */     if (!this.db.insert(tSchema))
/*     */     {
/*  49 */       this.mErrors.copyAllErrors(this.db.mErrors);
/*  50 */       CError tError = new CError();
/*  51 */       tError.moduleName = "LNPAgentInfoBDB";
...
/*     */   public int getCount()
/*     */   {
/* 121 */     LNPAgentInfoBSchema tSchema = getSchema();
/*     */ 
...
/* 129 */       tError.moduleName = "LNPAgentInfoBDB";
...
/* 152 */       SQLString sqlObj = new SQLString("LNPAgentInfoB");
/* 153 */       LNPAgentInfoBSchema aSchema = getSchema();
...
/* 166 */           tError.moduleName = "LNPAgentInfoBDB";
...
/* 193 */         tError.moduleName = "LNPAgentInfoBDB";
...
/* 213 */       tError.moduleName = "LNPAgentInfoBDB";
...
/* 248 */     LNPAgentInfoBSet aLNPAgentInfoBSet = new LNPAgentInfoBSet();
/*     */ 
/* 250 */     if (!this.mflag) {
...
/* 257 */       SQLString sqlObj = new SQLString("LNPAgentInfoB");
/* 258 */       LNPAgentInfoBSchema aSchema = getSchema();
...
/*     */       {
/* 266 */         i++;
/* 267 */         LNPAgentInfoBSchema s1 = new LNPAgentInfoBSchema();
/* 268 */         s1.setSchema(rs, i);
/* 269 */         aLNPAgentInfoBSet.add(s1);
/*     */       }try {
...
/* 278 */       tError.moduleName = "LNPAgentInfoBDB";
...
/* 312 */     LNPAgentInfoBSet aLNPAgentInfoBSet = new LNPAgentInfoBSet();
/*     */ 
/* 314 */     if (!this.mflag) {
...
/*     */       {
/* 326 */         i++;
/* 327 */         LNPAgentInfoBSchema s1 = new LNPAgentInfoBSchema();
/* 328 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 331 */           CError tError = new CError();
/* 332 */           tError.moduleName = "LNPAgentInfoBDB";
...
/* 346 */       tError.moduleName = "LNPAgentInfoBDB";
...
/* 380 */     LNPAgentInfoBSet aLNPAgentInfoBSet = new LNPAgentInfoBSet();
/*     */ 
/* 382 */     if (!this.mflag) {
...
/* 389 */       SQLString sqlObj = new SQLString("LNPAgentInfoB");
/* 390 */       LNPAgentInfoBSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 408 */         LNPAgentInfoBSchema s1 = new LNPAgentInfoBSchema();
/* 409 */         s1.setSchema(rs, i);
/* 410 */         aLNPAgentInfoBSet.add(s1);
/*     */       }try {
...
/* 419 */       tError.moduleName = "LNPAgentInfoBDB";
...
/* 453 */     LNPAgentInfoBSet aLNPAgentInfoBSet = new LNPAgentInfoBSet();
/*     */ 
/* 455 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 477 */         LNPAgentInfoBSchema s1 = new LNPAgentInfoBSchema();
/* 478 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 481 */           CError tError = new CError();
/* 482 */           tError.moduleName = "LNPAgentInfoBDB";
...
/* 496 */       tError.moduleName = "LNPAgentInfoBDB";
...
/* 537 */       SQLString sqlObj = new SQLString("LNPAgentInfoB");
/* 538 */       LNPAgentInfoBSchema aSchema = getSchema();
/* 539 */       sqlObj.setSQL(2, aSchema);
/* 540 */       String sql = "update LNPAgentInfoB " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 542 */       int operCount = stmt.executeUpdate(sql);
/* 543 */       if (operCount == 0)
/*     */       {
/* 546 */         CError tError = new CError();
/* 547 */         tError.moduleName = "LNPAgentInfoBDB";
...
/* 567 */       tError.moduleName = "LNPAgentInfoBDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPAgentInfoBDB
