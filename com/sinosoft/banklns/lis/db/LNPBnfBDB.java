...
/*     */ 
/*     */ public class LNPBnfBDB extends LNPBnfBSchema
/*     */ {
...
/*     */ 
/*     */   public LNPBnfBDB(Connection tConnection)
/*     */   {
...
/*     */   public int getCount()
/*     */   {
/* 121 */     LNPBnfBSchema tSchema = getSchema();
/*     */ 
...
/* 129 */       tError.moduleName = "LNPBnfBDB";
...
/* 152 */       SQLString sqlObj = new SQLString("LNPBnfB");
/* 153 */       LNPBnfBSchema aSchema = getSchema();
...
/* 166 */           tError.moduleName = "LNPBnfBDB";
...
/* 193 */         tError.moduleName = "LNPBnfBDB";
...
/* 213 */       tError.moduleName = "LNPBnfBDB";
...
/*     */   }
/*     */ 
/*     */   public LNPBnfBSet query()
/*     */   {
/* 246 */     Statement stmt = null;
/* 247 */     ResultSet rs = null;
/* 248 */     LNPBnfBSet aLNPBnfBSet = new LNPBnfBSet();
/*     */ 
/* 250 */     if (!this.mflag) {
...
/* 257 */       SQLString sqlObj = new SQLString("LNPBnfB");
/* 258 */       LNPBnfBSchema aSchema = getSchema();
...
/*     */       {
/* 266 */         i++;
/* 267 */         LNPBnfBSchema s1 = new LNPBnfBSchema();
/* 268 */         s1.setSchema(rs, i);
/* 269 */         aLNPBnfBSet.add(s1);
/*     */       }try {
...
/* 278 */       tError.moduleName = "LNPBnfBDB";
...
/*     */       }
/*     */     }
/* 305 */     return aLNPBnfBSet;
/*     */   }
/*     */ 
/*     */   public LNPBnfBSet executeQuery(String sql)
/*     */   {
/* 310 */     Statement stmt = null;
/* 311 */     ResultSet rs = null;
/* 312 */     LNPBnfBSet aLNPBnfBSet = new LNPBnfBSet();
/*     */ 
/* 314 */     if (!this.mflag) {
...
/*     */       {
/* 326 */         i++;
/* 327 */         LNPBnfBSchema s1 = new LNPBnfBSchema();
/* 328 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 331 */           CError tError = new CError();
/* 332 */           tError.moduleName = "LNPBnfBDB";
...
/* 346 */       tError.moduleName = "LNPBnfBDB";
...
/*     */       }
/*     */     }
/* 373 */     return aLNPBnfBSet;
/*     */   }
/*     */ 
/*     */   public LNPBnfBSet query(int nStart, int nCount)
/*     */   {
/* 378 */     Statement stmt = null;
/* 379 */     ResultSet rs = null;
/* 380 */     LNPBnfBSet aLNPBnfBSet = new LNPBnfBSet();
/*     */ 
/* 382 */     if (!this.mflag) {
...
/* 389 */       SQLString sqlObj = new SQLString("LNPBnfB");
/* 390 */       LNPBnfBSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 408 */         LNPBnfBSchema s1 = new LNPBnfBSchema();
/* 409 */         s1.setSchema(rs, i);
/* 410 */         aLNPBnfBSet.add(s1);
/*     */       }try {
...
/* 419 */       tError.moduleName = "LNPBnfBDB";
...
/*     */       }
/*     */     }
/* 446 */     return aLNPBnfBSet;
/*     */   }
/*     */ 
/*     */   public LNPBnfBSet executeQuery(String sql, int nStart, int nCount)
/*     */   {
/* 451 */     Statement stmt = null;
/* 452 */     ResultSet rs = null;
/* 453 */     LNPBnfBSet aLNPBnfBSet = new LNPBnfBSet();
/*     */ 
/* 455 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 477 */         LNPBnfBSchema s1 = new LNPBnfBSchema();
/* 478 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 481 */           CError tError = new CError();
/* 482 */           tError.moduleName = "LNPBnfBDB";
...
/* 496 */       tError.moduleName = "LNPBnfBDB";
...
/* 537 */       SQLString sqlObj = new SQLString("LNPBnfB");
/* 538 */       LNPBnfBSchema aSchema = getSchema();
/* 539 */       sqlObj.setSQL(2, aSchema);
/* 540 */       String sql = "update LNPBnfB " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 542 */       int operCount = stmt.executeUpdate(sql);
/* 543 */       if (operCount == 0)
/*     */       {
/* 546 */         CError tError = new CError();
/* 547 */         tError.moduleName = "LNPBnfBDB";
...
/* 567 */       tError.moduleName = "LNPBnfBDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPBnfBDB
