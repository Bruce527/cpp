...
/*  33 */     this.db = new DBOper(this.con, "LNPRiskToInterface");
/*  34 */     this.mflag = true;
/*     */   }
/*     */ 
...
/*     */   {
/*  39 */     this.con = null;
/*  40 */     this.db = new DBOper("LNPRiskToInterface");
/*  41 */     this.mflag = false;
/*     */   }
/*     */ 
/*     */   public boolean deleteSQL()
/*     */   {
/*  47 */     LNPRiskToInterfaceSchema tSchema = getSchema();
...
/*  57 */     tError.moduleName = "LNPRiskToInterfaceDB";
...
/*     */   public int getCount()
/*     */   {
/*  67 */     LNPRiskToInterfaceSchema tSchema = getSchema();
/*     */ 
...
/*  75 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/*     */     try
/*     */     {
/*  96 */       pstmt = this.con.prepareStatement("DELETE FROM LNPRiskToInterface WHERE  CodeType = ? AND Code = ?");
...
/* 113 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/*     */     try
/*     */     {
/* 150 */       pstmt = this.con.prepareStatement("UPDATE LNPRiskToInterface SET  CodeType = ? , Code = ? , CodeName = ? , CodeAlias = ? , CodeBak = ? , OtherSign = ? WHERE  CodeType = ? AND Code = ?");
...
/*     */       }
/* 171 */       if ((getCodeBak() == null) || (getCodeBak().equals("null")))
/* 172 */         pstmt.setNull(5, 12);
/*     */       else {
/* 174 */         pstmt.setString(5, getCodeBak());
/*     */       }
...
/* 198 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/*     */     try
/*     */     {
/* 235 */       pstmt = this.con.prepareStatement("INSERT INTO LNPRiskToInterface VALUES( ? , ? , ? , ? , ? , ?)");
...
/*     */       }
/* 256 */       if ((getCodeBak() == null) || (getCodeBak().equals("null")))
/* 257 */         pstmt.setNull(5, 12);
/*     */       else {
/* 259 */         pstmt.setString(5, getCodeBak());
/*     */       }
...
/* 273 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/*     */     try
/*     */     {
/* 311 */       pstmt = this.con.prepareStatement("SELECT * FROM LNPRiskToInterface WHERE  CodeType = ? AND Code = ?", 
/* 312 */         1003, 1007);
...
/* 332 */           tError.moduleName = "LNPRiskToInterfaceDB";
...
/* 372 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/* 407 */     LNPRiskToInterfaceSet aLNPRiskToInterfaceSet = new LNPRiskToInterfaceSet();
/*     */ 
/* 409 */     if (!this.mflag) {
...
/* 416 */       SQLString sqlObj = new SQLString("LNPRiskToInterface");
/* 417 */       LNPRiskToInterfaceSchema aSchema = getSchema();
...
/*     */       {
/* 425 */         i++;
/* 426 */         LNPRiskToInterfaceSchema s1 = new LNPRiskToInterfaceSchema();
/* 427 */         s1.setSchema(rs, i);
/* 428 */         aLNPRiskToInterfaceSet.add(s1);
/*     */       }try {
...
/* 437 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/*     */       }
/*     */     }
/* 464 */     return aLNPRiskToInterfaceSet;
/*     */   }
/*     */ 
...
/* 471 */     LNPRiskToInterfaceSet aLNPRiskToInterfaceSet = new LNPRiskToInterfaceSet();
/*     */ 
/* 473 */     if (!this.mflag) {
...
/*     */       {
/* 485 */         i++;
/* 486 */         LNPRiskToInterfaceSchema s1 = new LNPRiskToInterfaceSchema();
/* 487 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 490 */           CError tError = new CError();
/* 491 */           tError.moduleName = "LNPRiskToInterfaceDB";
...
/*     */         }
/* 496 */         aLNPRiskToInterfaceSet.add(s1);
/*     */       }try {
...
/* 505 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/*     */       }
/*     */     }
/* 532 */     return aLNPRiskToInterfaceSet;
/*     */   }
/*     */ 
...
/* 539 */     LNPRiskToInterfaceSet aLNPRiskToInterfaceSet = new LNPRiskToInterfaceSet();
/*     */ 
/* 541 */     if (!this.mflag) {
...
/* 548 */       SQLString sqlObj = new SQLString("LNPRiskToInterface");
/* 549 */       LNPRiskToInterfaceSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 567 */         LNPRiskToInterfaceSchema s1 = new LNPRiskToInterfaceSchema();
/* 568 */         s1.setSchema(rs, i);
/* 569 */         aLNPRiskToInterfaceSet.add(s1);
/*     */       }try {
...
/* 578 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/*     */       }
/*     */     }
/* 605 */     return aLNPRiskToInterfaceSet;
/*     */   }
/*     */ 
...
/* 612 */     LNPRiskToInterfaceSet aLNPRiskToInterfaceSet = new LNPRiskToInterfaceSet();
/*     */ 
/* 614 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 636 */         LNPRiskToInterfaceSchema s1 = new LNPRiskToInterfaceSchema();
/* 637 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 640 */           CError tError = new CError();
/* 641 */           tError.moduleName = "LNPRiskToInterfaceDB";
...
/*     */         }
/* 646 */         aLNPRiskToInterfaceSet.add(s1);
/*     */       }try {
...
/* 655 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/*     */       }
/*     */     }
/* 682 */     return aLNPRiskToInterfaceSet;
/*     */   }
/*     */ 
...
/* 696 */       SQLString sqlObj = new SQLString("LNPRiskToInterface");
/* 697 */       LNPRiskToInterfaceSchema aSchema = getSchema();
/* 698 */       sqlObj.setSQL(2, aSchema);
/* 699 */       String sql = "update LNPRiskToInterface " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 701 */       int operCount = stmt.executeUpdate(sql);
/* 702 */       if (operCount == 0)
/*     */       {
/* 705 */         CError tError = new CError();
/* 706 */         tError.moduleName = "LNPRiskToInterfaceDB";
...
/* 726 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/* 763 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/* 783 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/* 830 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/* 843 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/*     */   {
/* 877 */     int tCount = 0;
/* 878 */     LNPRiskToInterfaceSet tLNPRiskToInterfaceSet = new LNPRiskToInterfaceSet();
/* 879 */     LNPRiskToInterfaceSchema tLNPRiskToInterfaceSchema = null;
/* 880 */     if (this.mResultSet == null)
/*     */     {
/* 882 */       CError tError = new CError();
/* 883 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/*     */     {
/* 891 */       tCount = 1;
/* 892 */       tLNPRiskToInterfaceSchema = new LNPRiskToInterfaceSchema();
/* 893 */       tLNPRiskToInterfaceSchema.setSchema(this.mResultSet, 1);
/* 894 */       tLNPRiskToInterfaceSet.add(tLNPRiskToInterfaceSchema);
/*     */ 
/* 896 */       while (tCount++ < 5000)
/*     */       {
/* 898 */         if (!this.mResultSet.next())
/*     */           continue;
/* 900 */         tLNPRiskToInterfaceSchema = new LNPRiskToInterfaceSchema();
/* 901 */         tLNPRiskToInterfaceSchema.setSchema(this.mResultSet, 1);
/* 902 */         tLNPRiskToInterfaceSet.add(tLNPRiskToInterfaceSchema);
/*     */       }
/*     */ 
/*     */     }
/*     */     catch (Exception ex)
...
/* 909 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/* 936 */       return null;
/*     */     }
/* 938 */     return tLNPRiskToInterfaceSet;
/*     */   }
/*     */ 
...
/* 949 */         tError.moduleName = "LNPRiskToInterfaceDB";
...
/* 964 */       tError.moduleName = "LNPRiskToInterfaceDB";
...
/* 975 */         tError.moduleName = "LNPRiskToInterfaceDB";
...
/* 990 */       tError.moduleName = "LNPRiskToInterfaceDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPRiskToInterfaceDB
