...
/*   33 */     this.db = new DBOper(this.con, "LNPAgentIImpResult");
/*   34 */     this.mflag = true;
/*      */   }
/*      */ 
...
/*      */   {
/*   39 */     this.con = null;
/*   40 */     this.db = new DBOper("LNPAgentIImpResult");
/*   41 */     this.mflag = false;
/*      */   }
/*      */ 
/*      */   public boolean deleteSQL()
/*      */   {
/*   47 */     LNPAgentIImpResultSchema tSchema = getSchema();
...
/*   57 */     tError.moduleName = "LNPAgentIImpResultDB";
...
/*      */   public int getCount()
/*      */   {
/*   67 */     LNPAgentIImpResultSchema tSchema = getSchema();
/*      */ 
...
/*   75 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/*      */     try
/*      */     {
/*   96 */       pstmt = this.con.prepareStatement("DELETE FROM LNPAgentIImpResult WHERE  ResultId = ? AND Grouporder = ?");
...
/*  113 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/*      */     try
/*      */     {
/*  150 */       pstmt = this.con.prepareStatement("UPDATE LNPAgentIImpResult SET  ResultId = ? , GrpContNo = ? , ContNo = ? , ProposalContNo = ? , ImpartId = ? , Grouporder = ? , QID01 = ? , A01 = ? , QID02 = ? , A02 = ? , QID03 = ? , A03 = ? , QID04 = ? , A04 = ? , QID05 = ? , A05 = ? , QID06 = ? , A06 = ? , Operator = ? , ManageCom = ? , MakeDate = ? , MakeTime = ? , ModifyDate = ? , ModifyTime = ? WHERE  ResultId = ? AND Grouporder = ?");
...
/*  288 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/*      */     try
/*      */     {
/*  325 */       pstmt = this.con.prepareStatement("INSERT INTO LNPAgentIImpResult VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/*  453 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/*      */     try
/*      */     {
/*  491 */       pstmt = this.con.prepareStatement("SELECT * FROM LNPAgentIImpResult WHERE  ResultId = ? AND Grouporder = ?", 
/*  492 */         1003, 1007);
...
/*  512 */           tError.moduleName = "LNPAgentIImpResultDB";
...
/*  552 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/*  587 */     LNPAgentIImpResultSet aLNPAgentIImpResultSet = new LNPAgentIImpResultSet();
/*      */ 
/*  589 */     if (!this.mflag) {
...
/*  596 */       SQLString sqlObj = new SQLString("LNPAgentIImpResult");
/*  597 */       LNPAgentIImpResultSchema aSchema = getSchema();
...
/*      */       {
/*  605 */         i++;
/*  606 */         LNPAgentIImpResultSchema s1 = new LNPAgentIImpResultSchema();
/*  607 */         s1.setSchema(rs, i);
/*  608 */         aLNPAgentIImpResultSet.add(s1);
/*      */       }try {
...
/*  617 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/*      */       }
/*      */     }
/*  644 */     return aLNPAgentIImpResultSet;
/*      */   }
/*      */ 
...
/*  651 */     LNPAgentIImpResultSet aLNPAgentIImpResultSet = new LNPAgentIImpResultSet();
/*      */ 
/*  653 */     if (!this.mflag) {
...
/*      */       {
/*  665 */         i++;
/*  666 */         LNPAgentIImpResultSchema s1 = new LNPAgentIImpResultSchema();
/*  667 */         if (!s1.setSchema(rs, i))
/*      */         {
/*  670 */           CError tError = new CError();
/*  671 */           tError.moduleName = "LNPAgentIImpResultDB";
...
/*      */         }
/*  676 */         aLNPAgentIImpResultSet.add(s1);
/*      */       }try {
...
/*  685 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/*      */       }
/*      */     }
/*  712 */     return aLNPAgentIImpResultSet;
/*      */   }
/*      */ 
...
/*  719 */     LNPAgentIImpResultSet aLNPAgentIImpResultSet = new LNPAgentIImpResultSet();
/*      */ 
/*  721 */     if (!this.mflag) {
...
/*  728 */       SQLString sqlObj = new SQLString("LNPAgentIImpResult");
/*  729 */       LNPAgentIImpResultSchema aSchema = getSchema();
...
/*      */           break;
/*      */         }
/*  747 */         LNPAgentIImpResultSchema s1 = new LNPAgentIImpResultSchema();
/*  748 */         s1.setSchema(rs, i);
/*  749 */         aLNPAgentIImpResultSet.add(s1);
/*      */       }try {
...
/*  758 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/*      */       }
/*      */     }
/*  785 */     return aLNPAgentIImpResultSet;
/*      */   }
/*      */ 
...
/*  792 */     LNPAgentIImpResultSet aLNPAgentIImpResultSet = new LNPAgentIImpResultSet();
/*      */ 
/*  794 */     if (!this.mflag) {
...
/*      */           break;
/*      */         }
/*  816 */         LNPAgentIImpResultSchema s1 = new LNPAgentIImpResultSchema();
/*  817 */         if (!s1.setSchema(rs, i))
/*      */         {
/*  820 */           CError tError = new CError();
/*  821 */           tError.moduleName = "LNPAgentIImpResultDB";
...
/*      */         }
/*  826 */         aLNPAgentIImpResultSet.add(s1);
/*      */       }try {
...
/*  835 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/*      */       }
/*      */     }
/*  862 */     return aLNPAgentIImpResultSet;
/*      */   }
/*      */ 
...
/*  876 */       SQLString sqlObj = new SQLString("LNPAgentIImpResult");
/*  877 */       LNPAgentIImpResultSchema aSchema = getSchema();
/*  878 */       sqlObj.setSQL(2, aSchema);
/*  879 */       String sql = "update LNPAgentIImpResult " + sqlObj.getUpdPart() + " where " + strWherePart;
/*      */ 
/*  881 */       int operCount = stmt.executeUpdate(sql);
/*  882 */       if (operCount == 0)
/*      */       {
/*  885 */         CError tError = new CError();
/*  886 */         tError.moduleName = "LNPAgentIImpResultDB";
...
/*  906 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/*  943 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/*  963 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/* 1010 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/* 1023 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/*      */   {
/* 1057 */     int tCount = 0;
/* 1058 */     LNPAgentIImpResultSet tLNPAgentIImpResultSet = new LNPAgentIImpResultSet();
/* 1059 */     LNPAgentIImpResultSchema tLNPAgentIImpResultSchema = null;
/* 1060 */     if (this.mResultSet == null)
/*      */     {
/* 1062 */       CError tError = new CError();
/* 1063 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/*      */     {
/* 1071 */       tCount = 1;
/* 1072 */       tLNPAgentIImpResultSchema = new LNPAgentIImpResultSchema();
/* 1073 */       tLNPAgentIImpResultSchema.setSchema(this.mResultSet, 1);
/* 1074 */       tLNPAgentIImpResultSet.add(tLNPAgentIImpResultSchema);
/*      */ 
/* 1076 */       while (tCount++ < 5000)
/*      */       {
/* 1078 */         if (!this.mResultSet.next())
/*      */           continue;
/* 1080 */         tLNPAgentIImpResultSchema = new LNPAgentIImpResultSchema();
/* 1081 */         tLNPAgentIImpResultSchema.setSchema(this.mResultSet, 1);
/* 1082 */         tLNPAgentIImpResultSet.add(tLNPAgentIImpResultSchema);
/*      */       }
/*      */ 
/*      */     }
/*      */     catch (Exception ex)
...
/* 1089 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/* 1116 */       return null;
/*      */     }
/* 1118 */     return tLNPAgentIImpResultSet;
/*      */   }
/*      */ 
...
/* 1129 */         tError.moduleName = "LNPAgentIImpResultDB";
...
/* 1144 */       tError.moduleName = "LNPAgentIImpResultDB";
...
/* 1155 */         tError.moduleName = "LNPAgentIImpResultDB";
...
/* 1170 */       tError.moduleName = "LNPAgentIImpResultDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPAgentIImpResultDB
