...
/*  31 */     this.db = new DBOper(this.con, "LNPTransRcors");
/*  32 */     this.mflag = true;
/*     */   }
/*     */ 
...
/*     */   {
/*  37 */     this.con = null;
/*  38 */     this.db = new DBOper("LNPTransRcors");
/*  39 */     this.mflag = false;
/*     */   }
/*     */ 
/*     */   public boolean insert()
/*     */   {
/*  45 */     LNPTransRcorsSchema tSchema = getSchema();
/*  46 */     if (!this.db.insert(tSchema))
/*     */     {
/*  49 */       this.mErrors.copyAllErrors(this.db.mErrors);
/*  50 */       CError tError = new CError();
/*  51 */       tError.moduleName = "LNPTransRcorsDB";
...
/*     */   public int getCount()
/*     */   {
/* 121 */     LNPTransRcorsSchema tSchema = getSchema();
/*     */ 
...
/* 129 */       tError.moduleName = "LNPTransRcorsDB";
...
/* 152 */       SQLString sqlObj = new SQLString("LNPTransRcors");
/* 153 */       LNPTransRcorsSchema aSchema = getSchema();
...
/* 166 */           tError.moduleName = "LNPTransRcorsDB";
...
/* 193 */         tError.moduleName = "LNPTransRcorsDB";
...
/* 213 */       tError.moduleName = "LNPTransRcorsDB";
...
/* 248 */     LNPTransRcorsSet aLNPTransRcorsSet = new LNPTransRcorsSet();
/*     */ 
/* 250 */     if (!this.mflag) {
...
/* 257 */       SQLString sqlObj = new SQLString("LNPTransRcors");
/* 258 */       LNPTransRcorsSchema aSchema = getSchema();
...
/*     */       {
/* 266 */         i++;
/* 267 */         LNPTransRcorsSchema s1 = new LNPTransRcorsSchema();
/* 268 */         s1.setSchema(rs, i);
/* 269 */         aLNPTransRcorsSet.add(s1);
/*     */       }try {
...
/* 278 */       tError.moduleName = "LNPTransRcorsDB";
...
/* 312 */     LNPTransRcorsSet aLNPTransRcorsSet = new LNPTransRcorsSet();
/*     */ 
/* 314 */     if (!this.mflag) {
...
/*     */       {
/* 326 */         i++;
/* 327 */         LNPTransRcorsSchema s1 = new LNPTransRcorsSchema();
/* 328 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 331 */           CError tError = new CError();
/* 332 */           tError.moduleName = "LNPTransRcorsDB";
...
/* 346 */       tError.moduleName = "LNPTransRcorsDB";
...
/* 380 */     LNPTransRcorsSet aLNPTransRcorsSet = new LNPTransRcorsSet();
/*     */ 
/* 382 */     if (!this.mflag) {
...
/* 389 */       SQLString sqlObj = new SQLString("LNPTransRcors");
/* 390 */       LNPTransRcorsSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 408 */         LNPTransRcorsSchema s1 = new LNPTransRcorsSchema();
/* 409 */         s1.setSchema(rs, i);
/* 410 */         aLNPTransRcorsSet.add(s1);
/*     */       }try {
...
/* 419 */       tError.moduleName = "LNPTransRcorsDB";
...
/* 453 */     LNPTransRcorsSet aLNPTransRcorsSet = new LNPTransRcorsSet();
/*     */ 
/* 455 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 477 */         LNPTransRcorsSchema s1 = new LNPTransRcorsSchema();
/* 478 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 481 */           CError tError = new CError();
/* 482 */           tError.moduleName = "LNPTransRcorsDB";
...
/* 496 */       tError.moduleName = "LNPTransRcorsDB";
...
/* 537 */       SQLString sqlObj = new SQLString("LNPTransRcors");
/* 538 */       LNPTransRcorsSchema aSchema = getSchema();
/* 539 */       sqlObj.setSQL(2, aSchema);
/* 540 */       String sql = "update LNPTransRcors " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 542 */       int operCount = stmt.executeUpdate(sql);
/* 543 */       if (operCount == 0)
/*     */       {
/* 546 */         CError tError = new CError();
/* 547 */         tError.moduleName = "LNPTransRcorsDB";
...
/* 567 */       tError.moduleName = "LNPTransRcorsDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPTransRcorsDB
