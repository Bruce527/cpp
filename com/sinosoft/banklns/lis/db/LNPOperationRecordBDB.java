...
/*     */ 
/*     */ public class LNPOperationRecordBDB extends LNPOperationRecordBSchema
/*     */ {
...
/*     */ 
/*     */   public LNPOperationRecordBDB(Connection tConnection)
/*     */   {
/*  30 */     this.con = tConnection;
/*  31 */     this.db = new DBOper(this.con, "LNPOperationRecordB");
/*  32 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPOperationRecordBDB()
/*     */   {
/*  37 */     this.con = null;
/*  38 */     this.db = new DBOper("LNPOperationRecordB");
/*  39 */     this.mflag = false;
/*     */   }
/*     */ 
/*     */   public boolean insert()
/*     */   {
/*  45 */     LNPOperationRecordBSchema tSchema = getSchema();
/*  46 */     if (!this.db.insert(tSchema))
/*     */     {
/*  49 */       this.mErrors.copyAllErrors(this.db.mErrors);
/*  50 */       CError tError = new CError();
/*  51 */       tError.moduleName = "LNPOperationRecordBDB";
...
/*     */   public int getCount()
/*     */   {
/* 121 */     LNPOperationRecordBSchema tSchema = getSchema();
/*     */ 
...
/* 129 */       tError.moduleName = "LNPOperationRecordBDB";
...
/* 152 */       SQLString sqlObj = new SQLString("LNPOperationRecordB");
/* 153 */       LNPOperationRecordBSchema aSchema = getSchema();
...
/* 166 */           tError.moduleName = "LNPOperationRecordBDB";
...
/* 193 */         tError.moduleName = "LNPOperationRecordBDB";
...
/* 213 */       tError.moduleName = "LNPOperationRecordBDB";
...
/*     */   }
/*     */ 
/*     */   public LNPOperationRecordBSet query()
/*     */   {
/* 246 */     Statement stmt = null;
/* 247 */     ResultSet rs = null;
/* 248 */     LNPOperationRecordBSet aLNPOperationRecordBSet = new LNPOperationRecordBSet();
/*     */ 
/* 250 */     if (!this.mflag) {
...
/* 257 */       SQLString sqlObj = new SQLString("LNPOperationRecordB");
/* 258 */       LNPOperationRecordBSchema aSchema = getSchema();
...
/*     */       {
/* 266 */         i++;
/* 267 */         LNPOperationRecordBSchema s1 = new LNPOperationRecordBSchema();
/* 268 */         s1.setSchema(rs, i);
/* 269 */         aLNPOperationRecordBSet.add(s1);
/*     */       }try {
...
/* 278 */       tError.moduleName = "LNPOperationRecordBDB";
...
/*     */       }
/*     */     }
/* 305 */     return aLNPOperationRecordBSet;
/*     */   }
/*     */ 
/*     */   public LNPOperationRecordBSet executeQuery(String sql)
/*     */   {
/* 310 */     Statement stmt = null;
/* 311 */     ResultSet rs = null;
/* 312 */     LNPOperationRecordBSet aLNPOperationRecordBSet = new LNPOperationRecordBSet();
/*     */ 
/* 314 */     if (!this.mflag) {
...
/*     */       {
/* 326 */         i++;
/* 327 */         LNPOperationRecordBSchema s1 = new LNPOperationRecordBSchema();
/* 328 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 331 */           CError tError = new CError();
/* 332 */           tError.moduleName = "LNPOperationRecordBDB";
...
/*     */         }
/* 337 */         aLNPOperationRecordBSet.add(s1);
/*     */       }try {
...
/* 346 */       tError.moduleName = "LNPOperationRecordBDB";
...
/*     */       }
/*     */     }
/* 373 */     return aLNPOperationRecordBSet;
/*     */   }
/*     */ 
/*     */   public LNPOperationRecordBSet query(int nStart, int nCount)
/*     */   {
/* 378 */     Statement stmt = null;
/* 379 */     ResultSet rs = null;
/* 380 */     LNPOperationRecordBSet aLNPOperationRecordBSet = new LNPOperationRecordBSet();
/*     */ 
/* 382 */     if (!this.mflag) {
...
/* 389 */       SQLString sqlObj = new SQLString("LNPOperationRecordB");
/* 390 */       LNPOperationRecordBSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 408 */         LNPOperationRecordBSchema s1 = new LNPOperationRecordBSchema();
/* 409 */         s1.setSchema(rs, i);
/* 410 */         aLNPOperationRecordBSet.add(s1);
/*     */       }try {
...
/* 419 */       tError.moduleName = "LNPOperationRecordBDB";
...
/*     */       }
/*     */     }
/* 446 */     return aLNPOperationRecordBSet;
/*     */   }
/*     */ 
/*     */   public LNPOperationRecordBSet executeQuery(String sql, int nStart, int nCount)
/*     */   {
/* 451 */     Statement stmt = null;
/* 452 */     ResultSet rs = null;
/* 453 */     LNPOperationRecordBSet aLNPOperationRecordBSet = new LNPOperationRecordBSet();
/*     */ 
/* 455 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 477 */         LNPOperationRecordBSchema s1 = new LNPOperationRecordBSchema();
/* 478 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 481 */           CError tError = new CError();
/* 482 */           tError.moduleName = "LNPOperationRecordBDB";
...
/*     */         }
/* 487 */         aLNPOperationRecordBSet.add(s1);
/*     */       }try {
...
/* 496 */       tError.moduleName = "LNPOperationRecordBDB";
...
/*     */       }
/*     */     }
/* 523 */     return aLNPOperationRecordBSet;
/*     */   }
/*     */ 
...
/* 537 */       SQLString sqlObj = new SQLString("LNPOperationRecordB");
/* 538 */       LNPOperationRecordBSchema aSchema = getSchema();
/* 539 */       sqlObj.setSQL(2, aSchema);
/* 540 */       String sql = "update LNPOperationRecordB " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 542 */       int operCount = stmt.executeUpdate(sql);
/* 543 */       if (operCount == 0)
/*     */       {
/* 546 */         CError tError = new CError();
/* 547 */         tError.moduleName = "LNPOperationRecordBDB";
...
/* 567 */       tError.moduleName = "LNPOperationRecordBDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPOperationRecordBDB
