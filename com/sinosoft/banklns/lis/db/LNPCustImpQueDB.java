...
/*      */ 
/*      */ public class LNPCustImpQueDB extends LNPCustImpQueSchema
/*      */ {
...
/*      */ 
/*      */   public LNPCustImpQueDB(Connection tConnection)
/*      */   {
/*   32 */     this.con = tConnection;
/*   33 */     this.db = new DBOper(this.con, "LNPCustImpQue");
/*   34 */     this.mflag = true;
/*      */   }
/*      */ 
/*      */   public LNPCustImpQueDB()
/*      */   {
/*   39 */     this.con = null;
/*   40 */     this.db = new DBOper("LNPCustImpQue");
/*   41 */     this.mflag = false;
/*      */   }
/*      */ 
/*      */   public boolean deleteSQL()
/*      */   {
/*   47 */     LNPCustImpQueSchema tSchema = getSchema();
...
/*   57 */     tError.moduleName = "LNPCustImpQueDB";
...
/*      */   public int getCount()
/*      */   {
/*   67 */     LNPCustImpQueSchema tSchema = getSchema();
/*      */ 
...
/*   75 */       tError.moduleName = "LNPCustImpQueDB";
...
/*      */     try
/*      */     {
/*   96 */       pstmt = this.con.prepareStatement("DELETE FROM LNPCustImpQue WHERE  Questionid = ? AND InnerOrder = ?");
...
/*  113 */       tError.moduleName = "LNPCustImpQueDB";
...
/*      */     try
/*      */     {
/*  150 */       pstmt = this.con.prepareStatement("UPDATE LNPCustImpQue SET  ImpartId = ? , Questionid = ? , QuestionType = ? , Content1 = ? , Content2 = ? , QueOrder = ? , InnerOrder = ? , OutQueId = ? , InnerQueNum = ? , ParentId = ? , ChildQueNum = ? , Operator = ? , ManageCom = ? , MakeDate = ? , MakeTime = ? , ModifyDate = ? , ModifyTime = ? WHERE  Questionid = ? AND InnerOrder = ?");
...
/*  253 */       tError.moduleName = "LNPCustImpQueDB";
...
/*      */     try
/*      */     {
/*  290 */       pstmt = this.con.prepareStatement("INSERT INTO LNPCustImpQue VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/*  383 */       tError.moduleName = "LNPCustImpQueDB";
...
/*      */     try
/*      */     {
/*  421 */       pstmt = this.con.prepareStatement("SELECT * FROM LNPCustImpQue WHERE  Questionid = ? AND InnerOrder = ?", 
/*  422 */         1003, 1007);
...
/*  442 */           tError.moduleName = "LNPCustImpQueDB";
...
/*  482 */       tError.moduleName = "LNPCustImpQueDB";
...
/*      */   }
/*      */ 
/*      */   public LNPCustImpQueSet query()
/*      */   {
/*  515 */     Statement stmt = null;
/*  516 */     ResultSet rs = null;
/*  517 */     LNPCustImpQueSet aLNPCustImpQueSet = new LNPCustImpQueSet();
/*      */ 
/*  519 */     if (!this.mflag) {
...
/*  526 */       SQLString sqlObj = new SQLString("LNPCustImpQue");
/*  527 */       LNPCustImpQueSchema aSchema = getSchema();
...
/*      */       {
/*  535 */         i++;
/*  536 */         LNPCustImpQueSchema s1 = new LNPCustImpQueSchema();
/*  537 */         s1.setSchema(rs, i);
/*  538 */         aLNPCustImpQueSet.add(s1);
/*      */       }try {
...
/*  547 */       tError.moduleName = "LNPCustImpQueDB";
...
/*      */       }
/*      */     }
/*  574 */     return aLNPCustImpQueSet;
/*      */   }
/*      */ 
/*      */   public LNPCustImpQueSet executeQuery(String sql)
/*      */   {
/*  579 */     Statement stmt = null;
/*  580 */     ResultSet rs = null;
/*  581 */     LNPCustImpQueSet aLNPCustImpQueSet = new LNPCustImpQueSet();
/*      */ 
/*  583 */     if (!this.mflag) {
...
/*      */       {
/*  595 */         i++;
/*  596 */         LNPCustImpQueSchema s1 = new LNPCustImpQueSchema();
/*  597 */         if (!s1.setSchema(rs, i))
/*      */         {
/*  600 */           CError tError = new CError();
/*  601 */           tError.moduleName = "LNPCustImpQueDB";
...
/*  615 */       tError.moduleName = "LNPCustImpQueDB";
...
/*      */       }
/*      */     }
/*  642 */     return aLNPCustImpQueSet;
/*      */   }
/*      */ 
/*      */   public LNPCustImpQueSet query(int nStart, int nCount)
/*      */   {
/*  647 */     Statement stmt = null;
/*  648 */     ResultSet rs = null;
/*  649 */     LNPCustImpQueSet aLNPCustImpQueSet = new LNPCustImpQueSet();
/*      */ 
/*  651 */     if (!this.mflag) {
...
/*  658 */       SQLString sqlObj = new SQLString("LNPCustImpQue");
/*  659 */       LNPCustImpQueSchema aSchema = getSchema();
...
/*      */           break;
/*      */         }
/*  677 */         LNPCustImpQueSchema s1 = new LNPCustImpQueSchema();
/*  678 */         s1.setSchema(rs, i);
/*  679 */         aLNPCustImpQueSet.add(s1);
/*      */       }try {
...
/*  688 */       tError.moduleName = "LNPCustImpQueDB";
...
/*      */       }
/*      */     }
/*  715 */     return aLNPCustImpQueSet;
/*      */   }
/*      */ 
/*      */   public LNPCustImpQueSet executeQuery(String sql, int nStart, int nCount)
/*      */   {
/*  720 */     Statement stmt = null;
/*  721 */     ResultSet rs = null;
/*  722 */     LNPCustImpQueSet aLNPCustImpQueSet = new LNPCustImpQueSet();
/*      */ 
/*  724 */     if (!this.mflag) {
...
/*      */           break;
/*      */         }
/*  746 */         LNPCustImpQueSchema s1 = new LNPCustImpQueSchema();
/*  747 */         if (!s1.setSchema(rs, i))
/*      */         {
/*  750 */           CError tError = new CError();
/*  751 */           tError.moduleName = "LNPCustImpQueDB";
...
/*  765 */       tError.moduleName = "LNPCustImpQueDB";
...
/*  806 */       SQLString sqlObj = new SQLString("LNPCustImpQue");
/*  807 */       LNPCustImpQueSchema aSchema = getSchema();
/*  808 */       sqlObj.setSQL(2, aSchema);
/*  809 */       String sql = "update LNPCustImpQue " + sqlObj.getUpdPart() + " where " + strWherePart;
/*      */ 
/*  811 */       int operCount = stmt.executeUpdate(sql);
/*  812 */       if (operCount == 0)
/*      */       {
/*  815 */         CError tError = new CError();
/*  816 */         tError.moduleName = "LNPCustImpQueDB";
...
/*  836 */       tError.moduleName = "LNPCustImpQueDB";
...
/*  873 */       tError.moduleName = "LNPCustImpQueDB";
...
/*  893 */       tError.moduleName = "LNPCustImpQueDB";
...
/*  940 */       tError.moduleName = "LNPCustImpQueDB";
...
/*  953 */       tError.moduleName = "LNPCustImpQueDB";
...
/*      */   }
/*      */ 
/*      */   public LNPCustImpQueSet getData()
/*      */   {
/*  987 */     int tCount = 0;
/*  988 */     LNPCustImpQueSet tLNPCustImpQueSet = new LNPCustImpQueSet();
/*  989 */     LNPCustImpQueSchema tLNPCustImpQueSchema = null;
/*  990 */     if (this.mResultSet == null)
/*      */     {
/*  992 */       CError tError = new CError();
/*  993 */       tError.moduleName = "LNPCustImpQueDB";
...
/*      */     {
/* 1001 */       tCount = 1;
/* 1002 */       tLNPCustImpQueSchema = new LNPCustImpQueSchema();
/* 1003 */       tLNPCustImpQueSchema.setSchema(this.mResultSet, 1);
/* 1004 */       tLNPCustImpQueSet.add(tLNPCustImpQueSchema);
/*      */ 
/* 1006 */       while (tCount++ < 5000)
/*      */       {
/* 1008 */         if (!this.mResultSet.next())
/*      */           continue;
/* 1010 */         tLNPCustImpQueSchema = new LNPCustImpQueSchema();
/* 1011 */         tLNPCustImpQueSchema.setSchema(this.mResultSet, 1);
/* 1012 */         tLNPCustImpQueSet.add(tLNPCustImpQueSchema);
/*      */       }
/*      */ 
/*      */     }
/*      */     catch (Exception ex)
...
/* 1019 */       tError.moduleName = "LNPCustImpQueDB";
...
/* 1059 */         tError.moduleName = "LNPCustImpQueDB";
...
/* 1074 */       tError.moduleName = "LNPCustImpQueDB";
...
/* 1085 */         tError.moduleName = "LNPCustImpQueDB";
...
/* 1100 */       tError.moduleName = "LNPCustImpQueDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPCustImpQueDB
