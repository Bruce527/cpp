...
/*     */ 
/*     */ public class LNPPaymentDB extends LNPPaymentSchema
/*     */ {
...
/*     */ 
/*     */   public LNPPaymentDB(Connection tConnection)
/*     */   {
/*  30 */     this.con = tConnection;
/*  31 */     this.db = new DBOper(this.con, "LNPPayment");
/*  32 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPPaymentDB()
...
/*     */   public int getCount()
/*     */   {
/* 121 */     LNPPaymentSchema tSchema = getSchema();
/*     */ 
...
/* 129 */       tError.moduleName = "LNPPaymentDB";
...
/* 152 */       SQLString sqlObj = new SQLString("LNPPayment");
/* 153 */       LNPPaymentSchema aSchema = getSchema();
...
/* 166 */           tError.moduleName = "LNPPaymentDB";
...
/* 193 */         tError.moduleName = "LNPPaymentDB";
...
/* 213 */       tError.moduleName = "LNPPaymentDB";
...
/*     */   }
/*     */ 
/*     */   public LNPPaymentSet query()
/*     */   {
/* 246 */     Statement stmt = null;
/* 247 */     ResultSet rs = null;
/* 248 */     LNPPaymentSet aLNPPaymentSet = new LNPPaymentSet();
/*     */ 
/* 250 */     if (!this.mflag) {
...
/* 257 */       SQLString sqlObj = new SQLString("LNPPayment");
/* 258 */       LNPPaymentSchema aSchema = getSchema();
...
/*     */       {
/* 266 */         i++;
/* 267 */         LNPPaymentSchema s1 = new LNPPaymentSchema();
/* 268 */         s1.setSchema(rs, i);
/* 269 */         aLNPPaymentSet.add(s1);
/*     */       }try {
...
/* 278 */       tError.moduleName = "LNPPaymentDB";
...
/*     */       }
/*     */     }
/* 305 */     return aLNPPaymentSet;
/*     */   }
/*     */ 
/*     */   public LNPPaymentSet executeQuery(String sql)
/*     */   {
/* 310 */     Statement stmt = null;
/* 311 */     ResultSet rs = null;
/* 312 */     LNPPaymentSet aLNPPaymentSet = new LNPPaymentSet();
/*     */ 
/* 314 */     if (!this.mflag) {
...
/*     */       {
/* 326 */         i++;
/* 327 */         LNPPaymentSchema s1 = new LNPPaymentSchema();
/* 328 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 331 */           CError tError = new CError();
/* 332 */           tError.moduleName = "LNPPaymentDB";
...
/* 346 */       tError.moduleName = "LNPPaymentDB";
...
/*     */       }
/*     */     }
/* 373 */     return aLNPPaymentSet;
/*     */   }
/*     */ 
/*     */   public LNPPaymentSet query(int nStart, int nCount)
/*     */   {
/* 378 */     Statement stmt = null;
/* 379 */     ResultSet rs = null;
/* 380 */     LNPPaymentSet aLNPPaymentSet = new LNPPaymentSet();
/*     */ 
/* 382 */     if (!this.mflag) {
...
/* 389 */       SQLString sqlObj = new SQLString("LNPPayment");
/* 390 */       LNPPaymentSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 408 */         LNPPaymentSchema s1 = new LNPPaymentSchema();
/* 409 */         s1.setSchema(rs, i);
/* 410 */         aLNPPaymentSet.add(s1);
/*     */       }try {
...
/* 419 */       tError.moduleName = "LNPPaymentDB";
...
/*     */       }
/*     */     }
/* 446 */     return aLNPPaymentSet;
/*     */   }
/*     */ 
/*     */   public LNPPaymentSet executeQuery(String sql, int nStart, int nCount)
/*     */   {
/* 451 */     Statement stmt = null;
/* 452 */     ResultSet rs = null;
/* 453 */     LNPPaymentSet aLNPPaymentSet = new LNPPaymentSet();
/*     */ 
/* 455 */     if (!this.mflag) {
...
/*     */           break;
/*     */         }
/* 477 */         LNPPaymentSchema s1 = new LNPPaymentSchema();
/* 478 */         if (!s1.setSchema(rs, i))
/*     */         {
/* 481 */           CError tError = new CError();
/* 482 */           tError.moduleName = "LNPPaymentDB";
...
/* 496 */       tError.moduleName = "LNPPaymentDB";
...
/* 537 */       SQLString sqlObj = new SQLString("LNPPayment");
/* 538 */       LNPPaymentSchema aSchema = getSchema();
/* 539 */       sqlObj.setSQL(2, aSchema);
/* 540 */       String sql = "update LNPPayment " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 542 */       int operCount = stmt.executeUpdate(sql);
/* 543 */       if (operCount == 0)
/*     */       {
/* 546 */         CError tError = new CError();
/* 547 */         tError.moduleName = "LNPPaymentDB";
...
/* 567 */       tError.moduleName = "LNPPaymentDB";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.db.LNPPaymentDB
