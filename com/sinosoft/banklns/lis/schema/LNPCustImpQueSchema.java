...
/*      */ 
/*      */ public class LNPCustImpQueSchema
...
/*      */   {
/*   81 */     LNPCustImpQueSchema cloned = (LNPCustImpQueSchema)super.clone();
...
/*      */   }
/*      */ 
/*      */   public void setSchema(LNPCustImpQueSchema aLNPCustImpQueSchema)
/*      */   {
/*  259 */     this.impartId = aLNPCustImpQueSchema.getImpartId();
/*  260 */     this.questionid = aLNPCustImpQueSchema.getQuestionid();
/*  261 */     this.questionType = aLNPCustImpQueSchema.getQuestionType();
/*  262 */     this.content1 = aLNPCustImpQueSchema.getContent1();
/*  263 */     this.content2 = aLNPCustImpQueSchema.getContent2();
/*  264 */     this.queOrder = aLNPCustImpQueSchema.getQueOrder();
/*  265 */     this.innerOrder = aLNPCustImpQueSchema.getInnerOrder();
/*  266 */     this.outQueId = aLNPCustImpQueSchema.getOutQueId();
/*  267 */     this.innerQueNum = aLNPCustImpQueSchema.getInnerQueNum();
/*  268 */     this.parentId = aLNPCustImpQueSchema.getParentId();
/*  269 */     this.childQueNum = aLNPCustImpQueSchema.getChildQueNum();
/*  270 */     this.operator = aLNPCustImpQueSchema.getOperator();
/*  271 */     this.manageCom = aLNPCustImpQueSchema.getManageCom();
/*  272 */     this.makeDate = this.fDate.getDate(aLNPCustImpQueSchema.getMakeDate());
/*  273 */     this.makeTime = aLNPCustImpQueSchema.getMakeTime();
/*  274 */     this.modifyDate = this.fDate.getDate(aLNPCustImpQueSchema.getModifyDate());
/*  275 */     this.modifyTime = aLNPCustImpQueSchema.getModifyTime();
/*      */   }
/*      */ 
...
/*      */     {
/*  364 */       System.out.println("\u93C1\u7248\u5D41\u6434\u64B2\u8151\u9428\u51E9NPCustImpQue\u741B\u3125\u74E7\u5A08\u5178\u91DC\u93C1\u677F\u62F0Schema\u6D93\uE160\u6B91\u701B\u6941\uE18C\u6D93\uE045\u669F\u6D93\u5D84\u7AF4\u9477\u8FBE\u7D1D\u93B4\u682C\uFFFD\u546E\u58BD\u741B\u5B92b.executeQuery\u93CC\u30E8\uE1D7\u93C3\u8235\u75C5\u93C8\u5909\u5A07\u9422\u256Felect * from tables");
/*      */ 
/*  366 */       CError tError = new CError();
/*  367 */       tError.moduleName = "LNPCustImpQueSchema";
...
/*      */   }
/*      */ 
/*      */   public LNPCustImpQueSchema getSchema()
/*      */   {
/*  378 */     LNPCustImpQueSchema aLNPCustImpQueSchema = new LNPCustImpQueSchema();
/*  379 */     aLNPCustImpQueSchema.setSchema(this);
/*  380 */     return aLNPCustImpQueSchema;
/*      */   }
/*      */ 
/*      */   public LNPCustImpQueDB getDB()
/*      */   {
/*  385 */     LNPCustImpQueDB aDBOper = new LNPCustImpQueDB();
...
/*  442 */       tError.moduleName = "LNPCustImpQueSchema";
...
/*  765 */     LNPCustImpQueSchema other = (LNPCustImpQueSchema)otherObject;
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.schema.LNPCustImpQueSchema
