...
/*     */ 
/*     */ import com.sinosoft.banklns.lis.db.LNPCustImpOptionDB;
...
/*     */ 
/*     */ public class LNPCustImpOptionSchema
...
/*     */   {
/*  68 */     LNPCustImpOptionSchema cloned = (LNPCustImpOptionSchema)super.clone();
...
/*     */   }
/*     */ 
/*     */   public void setSchema(LNPCustImpOptionSchema aLNPCustImpOptionSchema)
/*     */   {
/* 198 */     this.impartId = aLNPCustImpOptionSchema.getImpartId();
/* 199 */     this.questionId = aLNPCustImpOptionSchema.getQuestionId();
/* 200 */     this.optionId = aLNPCustImpOptionSchema.getOptionId();
/* 201 */     this.optionOrder = aLNPCustImpOptionSchema.getOptionOrder();
/* 202 */     this.optionContent = aLNPCustImpOptionSchema.getOptionContent();
/* 203 */     this.operator = aLNPCustImpOptionSchema.getOperator();
/* 204 */     this.manageCom = aLNPCustImpOptionSchema.getManageCom();
/* 205 */     this.makeDate = this.fDate.getDate(aLNPCustImpOptionSchema.getMakeDate());
/* 206 */     this.makeTime = aLNPCustImpOptionSchema.getMakeTime();
/* 207 */     this.modifyDate = this.fDate.getDate(aLNPCustImpOptionSchema.getModifyDate());
/* 208 */     this.modifyTime = aLNPCustImpOptionSchema.getModifyTime();
/*     */   }
/*     */ 
...
/*     */     {
/* 267 */       System.out.println("\u93C1\u7248\u5D41\u6434\u64B2\u8151\u9428\u51E9NPCustImpOption\u741B\u3125\u74E7\u5A08\u5178\u91DC\u93C1\u677F\u62F0Schema\u6D93\uE160\u6B91\u701B\u6941\uE18C\u6D93\uE045\u669F\u6D93\u5D84\u7AF4\u9477\u8FBE\u7D1D\u93B4\u682C\uFFFD\u546E\u58BD\u741B\u5B92b.executeQuery\u93CC\u30E8\uE1D7\u93C3\u8235\u75C5\u93C8\u5909\u5A07\u9422\u256Felect * from tables");
/*     */ 
/* 269 */       CError tError = new CError();
/* 270 */       tError.moduleName = "LNPCustImpOptionSchema";
...
/*     */   }
/*     */ 
/*     */   public LNPCustImpOptionSchema getSchema()
/*     */   {
/* 281 */     LNPCustImpOptionSchema aLNPCustImpOptionSchema = new LNPCustImpOptionSchema();
/* 282 */     aLNPCustImpOptionSchema.setSchema(this);
/* 283 */     return aLNPCustImpOptionSchema;
/*     */   }
/*     */ 
/*     */   public LNPCustImpOptionDB getDB()
/*     */   {
/* 288 */     LNPCustImpOptionDB aDBOper = new LNPCustImpOptionDB();
...
/* 333 */       tError.moduleName = "LNPCustImpOptionSchema";
...
/* 560 */     LNPCustImpOptionSchema other = (LNPCustImpOptionSchema)otherObject;
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.schema.LNPCustImpOptionSchema
