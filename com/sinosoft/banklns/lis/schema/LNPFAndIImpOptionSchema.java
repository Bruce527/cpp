...
/*     */ 
/*     */ import com.sinosoft.banklns.lis.db.LNPFAndIImpOptionDB;
...
/*     */ 
/*     */ public class LNPFAndIImpOptionSchema
...
/*     */ 
/*     */   public LNPFAndIImpOptionSchema()
/*     */   {
...
/*     */   {
/*  68 */     LNPFAndIImpOptionSchema cloned = (LNPFAndIImpOptionSchema)super.clone();
...
/*     */   }
/*     */ 
/*     */   public void setSchema(LNPFAndIImpOptionSchema aLNPFAndIImpOptionSchema)
/*     */   {
/* 198 */     this.impartId = aLNPFAndIImpOptionSchema.getImpartId();
/* 199 */     this.questionId = aLNPFAndIImpOptionSchema.getQuestionId();
/* 200 */     this.optionId = aLNPFAndIImpOptionSchema.getOptionId();
/* 201 */     this.optionOrder = aLNPFAndIImpOptionSchema.getOptionOrder();
/* 202 */     this.optionContent = aLNPFAndIImpOptionSchema.getOptionContent();
/* 203 */     this.operator = aLNPFAndIImpOptionSchema.getOperator();
/* 204 */     this.manageCom = aLNPFAndIImpOptionSchema.getManageCom();
/* 205 */     this.makeDate = this.fDate.getDate(aLNPFAndIImpOptionSchema.getMakeDate());
/* 206 */     this.makeTime = aLNPFAndIImpOptionSchema.getMakeTime();
/* 207 */     this.modifyDate = this.fDate.getDate(aLNPFAndIImpOptionSchema.getModifyDate());
/* 208 */     this.modifyTime = aLNPFAndIImpOptionSchema.getModifyTime();
/*     */   }
/*     */ 
...
/*     */     {
/* 267 */       System.out.println("\u951F\u65A4\u62F7\u83D8\u951F\u65A4\u62F7\u68B0\u951F\u7D43NPFAndIImpOption\u951F\u65A4\u62F7\u951F\u8857\u6BB5\u9769\u62F7\u951F\u65A4\u62F7\u951F\u7D4Achema\u951F\u53EB\u7889\u62F7\u951F\u8857\u6BB5\u9769\u62F7\u951F\u65A4\u62F7\u4E00\u951F\u94F0\uFF4F\u62F7\u951F\u65A4\u62F7\u951F\u65A4\u62F7\u6267\u951F\u65A4\u62F7db.executeQuery\u951F\u65A4\u62F7\u8BE2\u65F6\u6CA1\u951F\u65A4\u62F7\u4F7F\u951F\u65A4\u62F7select * from tables");
/*     */ 
/* 269 */       CError tError = new CError();
/* 270 */       tError.moduleName = "LNPFAndIImpOptionSchema";
...
/*     */   }
/*     */ 
/*     */   public LNPFAndIImpOptionSchema getSchema()
/*     */   {
/* 281 */     LNPFAndIImpOptionSchema aLNPFAndIImpOptionSchema = new LNPFAndIImpOptionSchema();
/* 282 */     aLNPFAndIImpOptionSchema.setSchema(this);
/* 283 */     return aLNPFAndIImpOptionSchema;
/*     */   }
/*     */ 
/*     */   public LNPFAndIImpOptionDB getDB()
/*     */   {
/* 288 */     LNPFAndIImpOptionDB aDBOper = new LNPFAndIImpOptionDB();
...
/* 333 */       tError.moduleName = "LNPFAndIImpOptionSchema";
...
/* 560 */     LNPFAndIImpOptionSchema other = (LNPFAndIImpOptionSchema)otherObject;
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.schema.LNPFAndIImpOptionSchema
