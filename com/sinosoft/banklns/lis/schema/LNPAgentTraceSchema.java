...
/*      */ 
/*      */ import com.sinosoft.banklns.lis.db.LNPAgentTraceDB;
...
/*      */ 
/*      */ public class LNPAgentTraceSchema
...
/*      */   {
/*   78 */     LNPAgentTraceSchema cloned = (LNPAgentTraceSchema)super.clone();
...
/*      */   }
/*      */ 
/*      */   public void setSchema(LNPAgentTraceSchema aLNPAgentTraceSchema)
/*      */   {
/*  281 */     this.iD = aLNPAgentTraceSchema.getID();
/*  282 */     this.contno = aLNPAgentTraceSchema.getContno();
/*  283 */     this.operator = aLNPAgentTraceSchema.getOperator();
/*  284 */     this.operatorDate = this.fDate.getDate(aLNPAgentTraceSchema.getOperatorDate());
/*  285 */     this.operatorTime = aLNPAgentTraceSchema.getOperatorTime();
/*  286 */     this.operatorType = aLNPAgentTraceSchema.getOperatorType();
/*  287 */     this.int1 = aLNPAgentTraceSchema.getInt1();
/*  288 */     this.int2 = aLNPAgentTraceSchema.getInt2();
/*  289 */     this.varc1 = aLNPAgentTraceSchema.getVarc1();
/*  290 */     this.varc2 = aLNPAgentTraceSchema.getVarc2();
/*  291 */     this.varc5 = aLNPAgentTraceSchema.getVarc5();
/*  292 */     this.varc3 = aLNPAgentTraceSchema.getVarc3();
/*  293 */     this.varc4 = aLNPAgentTraceSchema.getVarc4();
/*  294 */     this.varc6 = aLNPAgentTraceSchema.getVarc6();
/*  295 */     this.date1 = this.fDate.getDate(aLNPAgentTraceSchema.getDate1());
/*  296 */     this.date2 = this.fDate.getDate(aLNPAgentTraceSchema.getDate2());
/*      */   }
/*      */ 
...
/*      */     {
/*  368 */       System.out.println("\u93C1\u7248\u5D41\u6434\u64B2\u8151\u9428\u51E9NPAgentTrace\u741B\u3125\u74E7\u5A08\u5178\u91DC\u93C1\u677F\u62F0Schema\u6D93\uE160\u6B91\u701B\u6941\uE18C\u6D93\uE045\u669F\u6D93\u5D84\u7AF4\u9477\u8FBE\u7D1D\u93B4\u682C\uFFFD\u546E\u58BD\u741B\u5B92b.executeQuery\u93CC\u30E8\uE1D7\u93C3\u8235\u75C5\u93C8\u5909\u5A07\u9422\u256Felect * from tables");
/*      */ 
/*  370 */       CError tError = new CError();
/*  371 */       tError.moduleName = "LNPAgentTraceSchema";
...
/*      */   }
/*      */ 
/*      */   public LNPAgentTraceSchema getSchema()
/*      */   {
/*  382 */     LNPAgentTraceSchema aLNPAgentTraceSchema = new LNPAgentTraceSchema();
/*  383 */     aLNPAgentTraceSchema.setSchema(this);
/*  384 */     return aLNPAgentTraceSchema;
/*      */   }
/*      */ 
/*      */   public LNPAgentTraceDB getDB()
/*      */   {
/*  389 */     LNPAgentTraceDB aDBOper = new LNPAgentTraceDB();
...
/*  444 */       tError.moduleName = "LNPAgentTraceSchema";
...
/*  751 */     LNPAgentTraceSchema other = (LNPAgentTraceSchema)otherObject;
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.schema.LNPAgentTraceSchema
