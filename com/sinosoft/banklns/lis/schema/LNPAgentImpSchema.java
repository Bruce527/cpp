...
/*     */ 
/*     */ import com.sinosoft.banklns.lis.db.LNPAgentImpDB;
...
/*     */ 
/*     */ public class LNPAgentImpSchema
...
/*     */   {
/*  76 */     LNPAgentImpSchema cloned = (LNPAgentImpSchema)super.clone();
...
/*     */   }
/*     */ 
/*     */   public void setSchema(LNPAgentImpSchema aLNPAgentImpSchema)
/*     */   {
/* 248 */     this.impartId = aLNPAgentImpSchema.getImpartId();
/* 249 */     this.impartName = aLNPAgentImpSchema.getImpartName();
/* 250 */     this.impartVer = aLNPAgentImpSchema.getImpartVer();
/* 251 */     this.impartContent = aLNPAgentImpSchema.getImpartContent();
/* 252 */     this.questionSum = aLNPAgentImpSchema.getQuestionSum();
/* 253 */     this.operator = aLNPAgentImpSchema.getOperator();
/* 254 */     this.manageCom = aLNPAgentImpSchema.getManageCom();
/* 255 */     this.makeTime = aLNPAgentImpSchema.getMakeTime();
/* 256 */     this.makeDate = this.fDate.getDate(aLNPAgentImpSchema.getMakeDate());
/* 257 */     this.modifyDate = this.fDate.getDate(aLNPAgentImpSchema.getModifyDate());
/* 258 */     this.modifyTime = aLNPAgentImpSchema.getModifyTime();
/* 259 */     this.p1 = aLNPAgentImpSchema.getP1();
/* 260 */     this.p2 = aLNPAgentImpSchema.getP2();
/* 261 */     this.p3 = aLNPAgentImpSchema.getP3();
/* 262 */     this.p4 = aLNPAgentImpSchema.getP4();
/*     */   }
/*     */ 
...
/*     */     {
/* 337 */       System.out.println("\u93C1\u7248\u5D41\u6434\u64B2\u8151\u9428\u51E9NPAgentImp\u741B\u3125\u74E7\u5A08\u5178\u91DC\u93C1\u677F\u62F0Schema\u6D93\uE160\u6B91\u701B\u6941\uE18C\u6D93\uE045\u669F\u6D93\u5D84\u7AF4\u9477\u8FBE\u7D1D\u93B4\u682C\uFFFD\u546E\u58BD\u741B\u5B92b.executeQuery\u93CC\u30E8\uE1D7\u93C3\u8235\u75C5\u93C8\u5909\u5A07\u9422\u256Felect * from tables");
/*     */ 
/* 339 */       CError tError = new CError();
/* 340 */       tError.moduleName = "LNPAgentImpSchema";
...
/*     */   }
/*     */ 
/*     */   public LNPAgentImpSchema getSchema()
/*     */   {
/* 351 */     LNPAgentImpSchema aLNPAgentImpSchema = new LNPAgentImpSchema();
/* 352 */     aLNPAgentImpSchema.setSchema(this);
/* 353 */     return aLNPAgentImpSchema;
/*     */   }
/*     */ 
/*     */   public LNPAgentImpDB getDB()
/*     */   {
/* 358 */     LNPAgentImpDB aDBOper = new LNPAgentImpDB();
...
/* 411 */       tError.moduleName = "LNPAgentImpSchema";
...
/* 702 */     LNPAgentImpSchema other = (LNPAgentImpSchema)otherObject;
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.schema.LNPAgentImpSchema
