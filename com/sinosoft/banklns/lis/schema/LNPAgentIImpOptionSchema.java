...
/*     */   {
/*  68 */     LNPAgentIImpOptionSchema cloned = (LNPAgentIImpOptionSchema)super.clone();
...
/*     */   {
/* 198 */     this.impartId = aLNPAgentIImpOptionSchema.getImpartId();
/* 199 */     this.questionId = aLNPAgentIImpOptionSchema.getQuestionId();
/* 200 */     this.optionId = aLNPAgentIImpOptionSchema.getOptionId();
/* 201 */     this.optionOrder = aLNPAgentIImpOptionSchema.getOptionOrder();
/* 202 */     this.optionContent = aLNPAgentIImpOptionSchema.getOptionContent();
/* 203 */     this.operator = aLNPAgentIImpOptionSchema.getOperator();
/* 204 */     this.manageCom = aLNPAgentIImpOptionSchema.getManageCom();
/* 205 */     this.makeDate = this.fDate.getDate(aLNPAgentIImpOptionSchema.getMakeDate());
/* 206 */     this.makeTime = aLNPAgentIImpOptionSchema.getMakeTime();
/* 207 */     this.modifyDate = this.fDate.getDate(aLNPAgentIImpOptionSchema.getModifyDate());
/* 208 */     this.modifyTime = aLNPAgentIImpOptionSchema.getModifyTime();
/*     */   }
/*     */ 
...
/*     */     {
/* 267 */       System.out.println("\u93C1\u7248\u5D41\u6434\u64B2\u8151\u9428\u51E9NPAgentIImpOption\u741B\u3125\u74E7\u5A08\u5178\u91DC\u93C1\u677F\u62F0Schema\u6D93\uE160\u6B91\u701B\u6941\uE18C\u6D93\uE045\u669F\u6D93\u5D84\u7AF4\u9477\u8FBE\u7D1D\u93B4\u682C\uFFFD\u546E\u58BD\u741B\u5B92b.executeQuery\u93CC\u30E8\uE1D7\u93C3\u8235\u75C5\u93C8\u5909\u5A07\u9422\u256Felect * from tables");
/*     */ 
/* 269 */       CError tError = new CError();
/* 270 */       tError.moduleName = "LNPAgentIImpOptionSchema";
...
/*     */   {
/* 281 */     LNPAgentIImpOptionSchema aLNPAgentIImpOptionSchema = new LNPAgentIImpOptionSchema();
/* 282 */     aLNPAgentIImpOptionSchema.setSchema(this);
/* 283 */     return aLNPAgentIImpOptionSchema;
/*     */   }
/*     */ 
/*     */   public LNPAgentIImpOptionDB getDB()
/*     */   {
/* 288 */     LNPAgentIImpOptionDB aDBOper = new LNPAgentIImpOptionDB();
...
/* 333 */       tError.moduleName = "LNPAgentIImpOptionSchema";
...
/* 560 */     LNPAgentIImpOptionSchema other = (LNPAgentIImpOptionSchema)otherObject;
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.schema.LNPAgentIImpOptionSchema
