...
/*      */   {
/*   81 */     LNPFAndIImpQueSchema cloned = (LNPFAndIImpQueSchema)super.clone();
...
/*      */   {
/*  259 */     this.impartId = aLNPFAndIImpQueSchema.getImpartId();
/*  260 */     this.questionid = aLNPFAndIImpQueSchema.getQuestionid();
/*  261 */     this.questionType = aLNPFAndIImpQueSchema.getQuestionType();
/*  262 */     this.content1 = aLNPFAndIImpQueSchema.getContent1();
/*  263 */     this.content2 = aLNPFAndIImpQueSchema.getContent2();
/*  264 */     this.queOrder = aLNPFAndIImpQueSchema.getQueOrder();
/*  265 */     this.innerOrder = aLNPFAndIImpQueSchema.getInnerOrder();
/*  266 */     this.outQueId = aLNPFAndIImpQueSchema.getOutQueId();
/*  267 */     this.innerQueNum = aLNPFAndIImpQueSchema.getInnerQueNum();
/*  268 */     this.parentId = aLNPFAndIImpQueSchema.getParentId();
/*  269 */     this.childQueNum = aLNPFAndIImpQueSchema.getChildQueNum();
/*  270 */     this.operator = aLNPFAndIImpQueSchema.getOperator();
/*  271 */     this.manageCom = aLNPFAndIImpQueSchema.getManageCom();
/*  272 */     this.makeDate = this.fDate.getDate(aLNPFAndIImpQueSchema.getMakeDate());
/*  273 */     this.makeTime = aLNPFAndIImpQueSchema.getMakeTime();
/*  274 */     this.modifyDate = this.fDate.getDate(aLNPFAndIImpQueSchema.getModifyDate());
/*  275 */     this.modifyTime = aLNPFAndIImpQueSchema.getModifyTime();
/*      */   }
/*      */ 
...
/*      */     {
/*  364 */       System.out.println("\u951F\u65A4\u62F7\u83D8\u951F\u65A4\u62F7\u68B0\u951F\u7D43NPFAndIImpQue\u951F\u65A4\u62F7\u951F\u8857\u6BB5\u9769\u62F7\u951F\u65A4\u62F7\u951F\u7D4Achema\u951F\u53EB\u7889\u62F7\u951F\u8857\u6BB5\u9769\u62F7\u951F\u65A4\u62F7\u4E00\u951F\u94F0\uFF4F\u62F7\u951F\u65A4\u62F7\u951F\u65A4\u62F7\u6267\u951F\u65A4\u62F7db.executeQuery\u951F\u65A4\u62F7\u8BE2\u65F6\u6CA1\u951F\u65A4\u62F7\u4F7F\u951F\u65A4\u62F7select * from tables");
/*      */ 
/*  366 */       CError tError = new CError();
/*  367 */       tError.moduleName = "LNPFAndIImpQueSchema";
...
/*      */   {
/*  378 */     LNPFAndIImpQueSchema aLNPFAndIImpQueSchema = new LNPFAndIImpQueSchema();
/*  379 */     aLNPFAndIImpQueSchema.setSchema(this);
/*  380 */     return aLNPFAndIImpQueSchema;
/*      */   }
/*      */ 
/*      */   public LNPFAndIImpQueDB getDB()
/*      */   {
/*  385 */     LNPFAndIImpQueDB aDBOper = new LNPFAndIImpQueDB();
...
/*  442 */       tError.moduleName = "LNPFAndIImpQueSchema";
...
/*  765 */     LNPFAndIImpQueSchema other = (LNPFAndIImpQueSchema)otherObject;
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.schema.LNPFAndIImpQueSchema
