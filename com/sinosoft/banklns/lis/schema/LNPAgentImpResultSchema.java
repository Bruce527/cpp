...
/*      */   {
/*   95 */     LNPAgentImpResultSchema cloned = (LNPAgentImpResultSchema)super.clone();
...
/*      */   {
/*  329 */     this.resultId = aLNPAgentImpResultSchema.getResultId();
/*  330 */     this.grpContNo = aLNPAgentImpResultSchema.getGrpContNo();
/*  331 */     this.contNo = aLNPAgentImpResultSchema.getContNo();
/*  332 */     this.proposalContNo = aLNPAgentImpResultSchema.getProposalContNo();
/*  333 */     this.impartId = aLNPAgentImpResultSchema.getImpartId();
/*  334 */     this.grouporder = aLNPAgentImpResultSchema.getGrouporder();
/*  335 */     this.qID01 = aLNPAgentImpResultSchema.getQID01();
/*  336 */     this.a01 = aLNPAgentImpResultSchema.getA01();
/*  337 */     this.qID02 = aLNPAgentImpResultSchema.getQID02();
/*  338 */     this.a02 = aLNPAgentImpResultSchema.getA02();
/*  339 */     this.qID03 = aLNPAgentImpResultSchema.getQID03();
/*  340 */     this.a03 = aLNPAgentImpResultSchema.getA03();
/*  341 */     this.qID04 = aLNPAgentImpResultSchema.getQID04();
/*  342 */     this.a04 = aLNPAgentImpResultSchema.getA04();
/*  343 */     this.qID05 = aLNPAgentImpResultSchema.getQID05();
/*  344 */     this.a05 = aLNPAgentImpResultSchema.getA05();
/*  345 */     this.qID06 = aLNPAgentImpResultSchema.getQID06();
/*  346 */     this.a06 = aLNPAgentImpResultSchema.getA06();
/*  347 */     this.operator = aLNPAgentImpResultSchema.getOperator();
/*  348 */     this.manageCom = aLNPAgentImpResultSchema.getManageCom();
/*  349 */     this.makeDate = this.fDate.getDate(aLNPAgentImpResultSchema.getMakeDate());
/*  350 */     this.makeTime = aLNPAgentImpResultSchema.getMakeTime();
/*  351 */     this.modifyDate = this.fDate.getDate(aLNPAgentImpResultSchema.getModifyDate());
/*  352 */     this.modifyTime = aLNPAgentImpResultSchema.getModifyTime();
/*      */   }
/*      */ 
...
/*      */     {
/*  476 */       System.out.println("\u93C1\u7248\u5D41\u6434\u64B2\u8151\u9428\u51E9NPAgentImpResult\u741B\u3125\u74E7\u5A08\u5178\u91DC\u93C1\u677F\u62F0Schema\u6D93\uE160\u6B91\u701B\u6941\uE18C\u6D93\uE045\u669F\u6D93\u5D84\u7AF4\u9477\u8FBE\u7D1D\u93B4\u682C\uFFFD\u546E\u58BD\u741B\u5B92b.executeQuery\u93CC\u30E8\uE1D7\u93C3\u8235\u75C5\u93C8\u5909\u5A07\u9422\u256Felect * from tables");
/*      */ 
/*  478 */       CError tError = new CError();
/*  479 */       tError.moduleName = "LNPAgentImpResultSchema";
...
/*      */   {
/*  490 */     LNPAgentImpResultSchema aLNPAgentImpResultSchema = new LNPAgentImpResultSchema();
/*  491 */     aLNPAgentImpResultSchema.setSchema(this);
/*  492 */     return aLNPAgentImpResultSchema;
/*      */   }
/*      */ 
/*      */   public LNPAgentImpResultDB getDB()
/*      */   {
/*  497 */     LNPAgentImpResultDB aDBOper = new LNPAgentImpResultDB();
...
/*  568 */       tError.moduleName = "LNPAgentImpResultSchema";
...
/* 1003 */     LNPAgentImpResultSchema other = (LNPAgentImpResultSchema)otherObject;
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.schema.LNPAgentImpResultSchema
