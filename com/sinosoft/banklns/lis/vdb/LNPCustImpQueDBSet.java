...
/*  29 */     this.db = new DBOper(this.con, "LNPCustImpQue");
/*  30 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPCustImpQueDBSet()
/*     */   {
/*  35 */     this.db = new DBOper("LNPCustImpQue");
...
/*  50 */     tError.moduleName = "LNPCustImpQueDBSet";
...
/*     */     {
/*  69 */       int tCount = size();
/*  70 */       pstmt = this.con.prepareStatement("DELETE FROM LNPCustImpQue WHERE  Questionid = ? AND InnerOrder = ?");
...
/*  92 */       tError.moduleName = "LNPCustImpQueDBSet";
...
/*     */     {
/* 130 */       int tCount = size();
/* 131 */       pstmt = this.con.prepareStatement("UPDATE LNPCustImpQue SET  ImpartId = ? , Questionid = ? , QuestionType = ? , Content1 = ? , Content2 = ? , QueOrder = ? , InnerOrder = ? , OutQueId = ? , InnerQueNum = ? , ParentId = ? , ChildQueNum = ? , Operator = ? , ManageCom = ? , MakeDate = ? , MakeTime = ? , ModifyDate = ? , ModifyTime = ? WHERE  Questionid = ? AND InnerOrder = ?");
...
/* 239 */       tError.moduleName = "LNPCustImpQueDBSet";
...
/*     */     {
/* 277 */       int tCount = size();
/* 278 */       pstmt = this.con.prepareStatement("INSERT INTO LNPCustImpQue VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/* 375 */       tError.moduleName = "LNPCustImpQueDBSet";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.vdb.LNPCustImpQueDBSet
