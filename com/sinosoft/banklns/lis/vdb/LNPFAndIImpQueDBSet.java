...
/*     */ 
/*     */ public class LNPFAndIImpQueDBSet extends LNPFAndIImpQueSet
/*     */ {
/*     */   private Connection con;
/*     */   private DBOper db;
/*  22 */   private boolean mflag = false;
/*     */ 
/*     */   public LNPFAndIImpQueDBSet(Connection tConnection)
/*     */   {
/*  28 */     this.con = tConnection;
/*  29 */     this.db = new DBOper(this.con, "LNPFAndIImpQue");
/*  30 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPFAndIImpQueDBSet()
/*     */   {
/*  35 */     this.db = new DBOper("LNPFAndIImpQue");
...
/*  50 */     tError.moduleName = "LNPFAndIImpQueDBSet";
...
/*     */     {
/*  69 */       int tCount = size();
/*  70 */       pstmt = this.con.prepareStatement("DELETE FROM LNPFAndIImpQue WHERE  Questionid = ? AND InnerOrder = ?");
...
/*  92 */       tError.moduleName = "LNPFAndIImpQueDBSet";
...
/*     */     {
/* 130 */       int tCount = size();
/* 131 */       pstmt = this.con.prepareStatement("UPDATE LNPFAndIImpQue SET  ImpartId = ? , Questionid = ? , QuestionType = ? , Content1 = ? , Content2 = ? , QueOrder = ? , InnerOrder = ? , OutQueId = ? , InnerQueNum = ? , ParentId = ? , ChildQueNum = ? , Operator = ? , ManageCom = ? , MakeDate = ? , MakeTime = ? , ModifyDate = ? , ModifyTime = ? WHERE  Questionid = ? AND InnerOrder = ?");
...
/* 239 */       tError.moduleName = "LNPFAndIImpQueDBSet";
...
/*     */     {
/* 277 */       int tCount = size();
/* 278 */       pstmt = this.con.prepareStatement("INSERT INTO LNPFAndIImpQue VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/* 375 */       tError.moduleName = "LNPFAndIImpQueDBSet";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.vdb.LNPFAndIImpQueDBSet
