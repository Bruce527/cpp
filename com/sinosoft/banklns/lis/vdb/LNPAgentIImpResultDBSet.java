...
/*  29 */     this.db = new DBOper(this.con, "LNPAgentIImpResult");
/*  30 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPAgentIImpResultDBSet()
/*     */   {
/*  35 */     this.db = new DBOper("LNPAgentIImpResult");
...
/*  50 */     tError.moduleName = "LNPAgentIImpResultDBSet";
...
/*     */     {
/*  69 */       int tCount = size();
/*  70 */       pstmt = this.con.prepareStatement("DELETE FROM LNPAgentIImpResult WHERE  ResultId = ? AND Grouporder = ?");
...
/*  92 */       tError.moduleName = "LNPAgentIImpResultDBSet";
...
/*     */     {
/* 130 */       int tCount = size();
/* 131 */       pstmt = this.con.prepareStatement("UPDATE LNPAgentIImpResult SET  ResultId = ? , GrpContNo = ? , ContNo = ? , ProposalContNo = ? , ImpartId = ? , Grouporder = ? , QID01 = ? , A01 = ? , QID02 = ? , A02 = ? , QID03 = ? , A03 = ? , QID04 = ? , A04 = ? , QID05 = ? , A05 = ? , QID06 = ? , A06 = ? , Operator = ? , ManageCom = ? , MakeDate = ? , MakeTime = ? , ModifyDate = ? , ModifyTime = ? WHERE  ResultId = ? AND Grouporder = ?");
...
/* 274 */       tError.moduleName = "LNPAgentIImpResultDBSet";
...
/*     */     {
/* 312 */       int tCount = size();
/* 313 */       pstmt = this.con.prepareStatement("INSERT INTO LNPAgentIImpResult VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/* 445 */       tError.moduleName = "LNPAgentIImpResultDBSet";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.vdb.LNPAgentIImpResultDBSet
