...
/*  29 */     this.db = new DBOper(this.con, "LNPDutyGetRela");
/*  30 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPDutyGetRelaDBSet()
/*     */   {
/*  35 */     this.db = new DBOper("LNPDutyGetRela");
...
/*  50 */     tError.moduleName = "LNPDutyGetRelaDBSet";
...
/*     */     {
/*  69 */       int tCount = size();
/*  70 */       pstmt = this.con.prepareStatement("DELETE FROM LNPDutyGetRela WHERE  DutyCode = ? AND GetDutyCode = ?");
...
/*     */         }
/*  78 */         if ((get(i).getGetDutyCode() == null) || (get(i).getGetDutyCode().equals("null")))
/*  79 */           pstmt.setString(2, null);
/*     */         else {
/*  81 */           pstmt.setString(2, get(i).getGetDutyCode());
/*     */         }
/*  83 */         pstmt.addBatch();
/*     */       }
...
/*  92 */       tError.moduleName = "LNPDutyGetRelaDBSet";
...
/*     */     {
/* 130 */       int tCount = size();
/* 131 */       pstmt = this.con.prepareStatement("UPDATE LNPDutyGetRela SET  DutyCode = ? , GetDutyCode = ? , GetDutyName = ? WHERE  DutyCode = ? AND GetDutyCode = ?");
...
/*     */         }
/* 139 */         if ((get(i).getGetDutyCode() == null) || (get(i).getGetDutyCode().equals("null")))
/* 140 */           pstmt.setString(2, null);
/*     */         else {
/* 142 */           pstmt.setString(2, get(i).getGetDutyCode());
/*     */         }
/* 144 */         if ((get(i).getGetDutyName() == null) || (get(i).getGetDutyName().equals("null")))
/* 145 */           pstmt.setString(3, null);
/*     */         else {
/* 147 */           pstmt.setString(3, get(i).getGetDutyName());
/*     */         }
/*     */ 
...
/*     */         }
/* 155 */         if ((get(i).getGetDutyCode() == null) || (get(i).getGetDutyCode().equals("null")))
/* 156 */           pstmt.setString(5, null);
/*     */         else {
/* 158 */           pstmt.setString(5, get(i).getGetDutyCode());
/*     */         }
/* 160 */         pstmt.addBatch();
/*     */       }
...
/* 169 */       tError.moduleName = "LNPDutyGetRelaDBSet";
...
/*     */     {
/* 207 */       int tCount = size();
/* 208 */       pstmt = this.con.prepareStatement("INSERT INTO LNPDutyGetRela VALUES( ? , ? , ?)");
...
/*     */         }
/* 216 */         if ((get(i).getGetDutyCode() == null) || (get(i).getGetDutyCode().equals("null")))
/* 217 */           pstmt.setString(2, null);
/*     */         else {
/* 219 */           pstmt.setString(2, get(i).getGetDutyCode());
/*     */         }
/* 221 */         if ((get(i).getGetDutyName() == null) || (get(i).getGetDutyName().equals("null")))
/* 222 */           pstmt.setString(3, null);
/*     */         else {
/* 224 */           pstmt.setString(3, get(i).getGetDutyName());
/*     */         }
/* 226 */         pstmt.addBatch();
/*     */       }
...
/* 235 */       tError.moduleName = "LNPDutyGetRelaDBSet";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.vdb.LNPDutyGetRelaDBSet
