...
/*     */ 
/*     */ public class LNPCustImpOptionDBSet extends LNPCustImpOptionSet
/*     */ {
/*     */   private Connection con;
/*     */   private DBOper db;
/*  22 */   private boolean mflag = false;
/*     */ 
/*     */   public LNPCustImpOptionDBSet(Connection tConnection)
/*     */   {
/*  28 */     this.con = tConnection;
/*  29 */     this.db = new DBOper(this.con, "LNPCustImpOption");
/*  30 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPCustImpOptionDBSet()
/*     */   {
/*  35 */     this.db = new DBOper("LNPCustImpOption");
...
/*  50 */     tError.moduleName = "LNPCustImpOptionDBSet";
...
/*     */     {
/*  69 */       int tCount = size();
/*  70 */       pstmt = this.con.prepareStatement("DELETE FROM LNPCustImpOption WHERE  OptionId = ?");
...
/*  87 */       tError.moduleName = "LNPCustImpOptionDBSet";
...
/*     */     {
/* 125 */       int tCount = size();
/* 126 */       pstmt = this.con.prepareStatement("UPDATE LNPCustImpOption SET  ImpartId = ? , QuestionId = ? , OptionId = ? , OptionOrder = ? , OptionContent = ? , Operator = ? , ManageCom = ? , MakeDate = ? , MakeTime = ? , ModifyDate = ? , ModifyTime = ? WHERE  OptionId = ?");
...
/* 199 */       tError.moduleName = "LNPCustImpOptionDBSet";
...
/*     */     {
/* 237 */       int tCount = size();
/* 238 */       pstmt = this.con.prepareStatement("INSERT INTO LNPCustImpOption VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/* 305 */       tError.moduleName = "LNPCustImpOptionDBSet";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.vdb.LNPCustImpOptionDBSet
