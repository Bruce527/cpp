...
/*  29 */     this.db = new DBOper(this.con, "LNPRiskToInterface");
/*  30 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPRiskToInterfaceDBSet()
/*     */   {
/*  35 */     this.db = new DBOper("LNPRiskToInterface");
...
/*  50 */     tError.moduleName = "LNPRiskToInterfaceDBSet";
...
/*     */     {
/*  69 */       int tCount = size();
/*  70 */       pstmt = this.con.prepareStatement("DELETE FROM LNPRiskToInterface WHERE  CodeType = ? AND Code = ?");
...
/*  92 */       tError.moduleName = "LNPRiskToInterfaceDBSet";
...
/*     */     {
/* 130 */       int tCount = size();
/* 131 */       pstmt = this.con.prepareStatement("UPDATE LNPRiskToInterface SET  CodeType = ? , Code = ? , CodeName = ? , CodeAlias = ? , CodeBak = ? , OtherSign = ? WHERE  CodeType = ? AND Code = ?");
...
/*     */         }
/* 154 */         if ((get(i).getCodeBak() == null) || (get(i).getCodeBak().equals("null")))
/* 155 */           pstmt.setString(5, null);
/*     */         else {
/* 157 */           pstmt.setString(5, get(i).getCodeBak());
/*     */         }
...
/* 184 */       tError.moduleName = "LNPRiskToInterfaceDBSet";
...
/*     */     {
/* 222 */       int tCount = size();
/* 223 */       pstmt = this.con.prepareStatement("INSERT INTO LNPRiskToInterface VALUES( ? , ? , ? , ? , ? , ?)");
...
/*     */         }
/* 246 */         if ((get(i).getCodeBak() == null) || (get(i).getCodeBak().equals("null")))
/* 247 */           pstmt.setString(5, null);
/*     */         else {
/* 249 */           pstmt.setString(5, get(i).getCodeBak());
/*     */         }
...
/* 265 */       tError.moduleName = "LNPRiskToInterfaceDBSet";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.vdb.LNPRiskToInterfaceDBSet
