...
/*  29 */     this.db = new DBOper(this.con, "LNPOperatorTrace");
/*  30 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPOperatorTraceDBSet()
/*     */   {
/*  35 */     this.db = new DBOper("LNPOperatorTrace");
...
/*  50 */     tError.moduleName = "LNPOperatorTraceDBSet";
...
/*     */     {
/*  69 */       int tCount = size();
/*  70 */       pstmt = this.con.prepareStatement("DELETE FROM LNPOperatorTrace WHERE  ID = ?");
...
/*  87 */       tError.moduleName = "LNPOperatorTraceDBSet";
...
/*     */     {
/* 125 */       int tCount = size();
/* 126 */       pstmt = this.con.prepareStatement("UPDATE LNPOperatorTrace SET  ID = ? , Contno = ? , Operator = ? , OperatorDate = ? , OperatorTime = ? , OperatorType = ? , Int1 = ? , Int2 = ? , Varc1 = ? , Varc2 = ? , Varc5 = ? , Varc3 = ? , Varc4 = ? , Varc6 = ? , Date1 = ? , Date2 = ? WHERE  ID = ?");
...
/* 216 */       tError.moduleName = "LNPOperatorTraceDBSet";
...
/*     */     {
/* 254 */       int tCount = size();
/* 255 */       pstmt = this.con.prepareStatement("INSERT INTO LNPOperatorTrace VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/* 339 */       tError.moduleName = "LNPOperatorTraceDBSet";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.vdb.LNPOperatorTraceDBSet
