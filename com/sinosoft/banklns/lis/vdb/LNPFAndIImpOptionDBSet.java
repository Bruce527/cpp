...
/*  29 */     this.db = new DBOper(this.con, "LNPFAndIImpOption");
/*  30 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPFAndIImpOptionDBSet()
/*     */   {
/*  35 */     this.db = new DBOper("LNPFAndIImpOption");
...
/*  50 */     tError.moduleName = "LNPFAndIImpOptionDBSet";
...
/*     */     {
/*  69 */       int tCount = size();
/*  70 */       pstmt = this.con.prepareStatement("DELETE FROM LNPFAndIImpOption WHERE  OptionId = ?");
...
/*  87 */       tError.moduleName = "LNPFAndIImpOptionDBSet";
...
/*     */     {
/* 125 */       int tCount = size();
/* 126 */       pstmt = this.con.prepareStatement("UPDATE LNPFAndIImpOption SET  ImpartId = ? , QuestionId = ? , OptionId = ? , OptionOrder = ? , OptionContent = ? , Operator = ? , ManageCom = ? , MakeDate = ? , MakeTime = ? , ModifyDate = ? , ModifyTime = ? WHERE  OptionId = ?");
...
/* 199 */       tError.moduleName = "LNPFAndIImpOptionDBSet";
...
/*     */     {
/* 237 */       int tCount = size();
/* 238 */       pstmt = this.con.prepareStatement("INSERT INTO LNPFAndIImpOption VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/* 305 */       tError.moduleName = "LNPFAndIImpOptionDBSet";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.vdb.LNPFAndIImpOptionDBSet
