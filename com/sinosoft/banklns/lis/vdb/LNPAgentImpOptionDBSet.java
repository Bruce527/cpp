...
/*     */ 
/*     */ public class LNPAgentImpOptionDBSet extends LNPAgentImpOptionSet
/*     */ {
/*     */   private Connection con;
/*     */   private DBOper db;
/*  22 */   private boolean mflag = false;
/*     */ 
/*     */   public LNPAgentImpOptionDBSet(Connection tConnection)
/*     */   {
/*  28 */     this.con = tConnection;
/*  29 */     this.db = new DBOper(this.con, "LNPAgentImpOption");
/*  30 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPAgentImpOptionDBSet()
/*     */   {
/*  35 */     this.db = new DBOper("LNPAgentImpOption");
...
/*  50 */     tError.moduleName = "LNPAgentImpOptionDBSet";
...
/*     */     {
/*  69 */       int tCount = size();
/*  70 */       pstmt = this.con.prepareStatement("DELETE FROM LNPAgentImpOption WHERE  OptionId = ?");
...
/*  87 */       tError.moduleName = "LNPAgentImpOptionDBSet";
...
/*     */     {
/* 125 */       int tCount = size();
/* 126 */       pstmt = this.con.prepareStatement("UPDATE LNPAgentImpOption SET  ImpartId = ? , QuestionId = ? , OptionId = ? , OptionOrder = ? , OptionContent = ? , Operator = ? , ManageCom = ? , MakeDate = ? , MakeTime = ? , ModifyDate = ? , ModifyTime = ? WHERE  OptionId = ?");
...
/* 199 */       tError.moduleName = "LNPAgentImpOptionDBSet";
...
/*     */     {
/* 237 */       int tCount = size();
/* 238 */       pstmt = this.con.prepareStatement("INSERT INTO LNPAgentImpOption VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/* 305 */       tError.moduleName = "LNPAgentImpOptionDBSet";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.vdb.LNPAgentImpOptionDBSet
