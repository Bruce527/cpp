...
/*  29 */     this.db = new DBOper(this.con, "LNPRiskSaleGroup");
/*  30 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPRiskSaleGroupDBSet()
/*     */   {
/*  35 */     this.db = new DBOper("LNPRiskSaleGroup");
...
/*  50 */     tError.moduleName = "LNPRiskSaleGroupDBSet";
...
/*     */     {
/*  69 */       int tCount = size();
/*  70 */       pstmt = this.con.prepareStatement("DELETE FROM LNPRiskSaleGroup WHERE  GroupCode = ?");
...
/*  87 */       tError.moduleName = "LNPRiskSaleGroupDBSet";
...
/*     */     {
/* 125 */       int tCount = size();
/* 126 */       pstmt = this.con.prepareStatement("UPDATE LNPRiskSaleGroup SET  GroupCode = ? , GroupName = ? , GroupDescribe = ? WHERE  GroupCode = ?");
/* 127 */       for (int i = 1; i <= tCount; i++)
/*     */       {
/* 129 */         if ((get(i).getGroupCode() == null) || (get(i).getGroupCode().equals("null")))
/* 130 */           pstmt.setString(1, null);
/*     */         else {
/* 132 */           pstmt.setString(1, get(i).getGroupCode());
/*     */         }
/* 134 */         if ((get(i).getGroupName() == null) || (get(i).getGroupName().equals("null")))
/* 135 */           pstmt.setString(2, null);
/*     */         else {
/* 137 */           pstmt.setString(2, get(i).getGroupName());
/*     */         }
/* 139 */         if ((get(i).getGroupDescribe() == null) || (get(i).getGroupDescribe().equals("null")))
/* 140 */           pstmt.setString(3, null);
/*     */         else {
/* 142 */           pstmt.setString(3, get(i).getGroupDescribe());
/*     */         }
/*     */ 
/* 145 */         if ((get(i).getGroupCode() == null) || (get(i).getGroupCode().equals("null")))
/* 146 */           pstmt.setString(4, null);
/*     */         else {
/* 148 */           pstmt.setString(4, get(i).getGroupCode());
/*     */         }
/* 150 */         pstmt.addBatch();
/*     */       }
...
/* 159 */       tError.moduleName = "LNPRiskSaleGroupDBSet";
...
/*     */     {
/* 197 */       int tCount = size();
/* 198 */       pstmt = this.con.prepareStatement("INSERT INTO LNPRiskSaleGroup VALUES( ? , ? , ?)");
/* 199 */       for (int i = 1; i <= tCount; i++)
/*     */       {
/* 201 */         if ((get(i).getGroupCode() == null) || (get(i).getGroupCode().equals("null")))
/* 202 */           pstmt.setString(1, null);
/*     */         else {
/* 204 */           pstmt.setString(1, get(i).getGroupCode());
/*     */         }
/* 206 */         if ((get(i).getGroupName() == null) || (get(i).getGroupName().equals("null")))
/* 207 */           pstmt.setString(2, null);
/*     */         else {
/* 209 */           pstmt.setString(2, get(i).getGroupName());
/*     */         }
/* 211 */         if ((get(i).getGroupDescribe() == null) || (get(i).getGroupDescribe().equals("null")))
/* 212 */           pstmt.setString(3, null);
/*     */         else {
/* 214 */           pstmt.setString(3, get(i).getGroupDescribe());
/*     */         }
/* 216 */         pstmt.addBatch();
/*     */       }
...
/* 225 */       tError.moduleName = "LNPRiskSaleGroupDBSet";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.vdb.LNPRiskSaleGroupDBSet
