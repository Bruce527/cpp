...
/*     */ 
/*     */ public class LNPAgentImpDBSet extends LNPAgentImpSet
/*     */ {
/*     */   private Connection con;
/*     */   private DBOper db;
/*  22 */   private boolean mflag = false;
/*     */ 
/*     */   public LNPAgentImpDBSet(Connection tConnection)
/*     */   {
/*  28 */     this.con = tConnection;
/*  29 */     this.db = new DBOper(this.con, "LNPAgentImp");
/*  30 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public LNPAgentImpDBSet()
/*     */   {
/*  35 */     this.db = new DBOper("LNPAgentImp");
...
/*  50 */     tError.moduleName = "LNPAgentImpDBSet";
...
/*     */     {
/*  69 */       int tCount = size();
/*  70 */       pstmt = this.con.prepareStatement("DELETE FROM LNPAgentImp WHERE  ImpartId = ?");
...
/*  87 */       tError.moduleName = "LNPAgentImpDBSet";
...
/*     */     {
/* 125 */       int tCount = size();
/* 126 */       pstmt = this.con.prepareStatement("UPDATE LNPAgentImp SET  ImpartId = ? , ImpartName = ? , ImpartVer = ? , ImpartContent = ? , QuestionSum = ? , Operator = ? , ManageCom = ? , MakeTime = ? , MakeDate = ? , ModifyDate = ? , ModifyTime = ? , p1 = ? , p2 = ? , p3 = ? , p4 = ? WHERE  ImpartId = ?");
...
/* 215 */       tError.moduleName = "LNPAgentImpDBSet";
...
/*     */     {
/* 253 */       int tCount = size();
/* 254 */       pstmt = this.con.prepareStatement("INSERT INTO LNPAgentImp VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/* 337 */       tError.moduleName = "LNPAgentImpDBSet";
 ...
 * Qualified Name:     com.sinosoft.banklns.lis.vdb.LNPAgentImpDBSet
