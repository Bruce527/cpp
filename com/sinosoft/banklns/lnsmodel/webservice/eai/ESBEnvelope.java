...
/*     */ 
/*  92 */   private static TypeDesc typeDesc = new TypeDesc(ESBEnvelope.class, true);
/*     */ 
/*     */   static {
/*  95 */     typeDesc.setXmlType(new QName(EAIPropertiesFromDB.ESBEnvelope_ns, ">ESBEnvelope"));
/*  96 */     ElementDesc elemField = new ElementDesc();
/*  97 */     elemField.setFieldName("ESBHeader");
/*  98 */     elemField.setXmlName(new QName("", "ESBHeader"));
/*  99 */     elemField.setXmlType(new QName(EAIPropertiesFromDB.ESBEnvelope_ns, ">>ESBEnvelope>ESBHeader"));
...
/* 106 */     elemField.setXmlType(new QName(EAIPropertiesFromDB.ESBEnvelope_ns, ">>ESBEnvelope>MsgBody"));
...
/*     */   {
/*  53 */     if (!(obj instanceof ESBEnvelope)) return false;
/*  54 */     ESBEnvelope other = (ESBEnvelope)obj;
 ...
 * Qualified Name:     com.sinosoft.banklns.lnsmodel.webservice.eai.ESBEnvelope
