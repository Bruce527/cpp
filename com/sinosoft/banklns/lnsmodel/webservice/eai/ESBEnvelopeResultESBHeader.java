...
/*     */ 
/* 400 */   private static TypeDesc typeDesc = new TypeDesc(ESBEnvelopeResultESBHeader.class, true);
/*     */ 
/*     */   static {
/* 403 */     typeDesc.setXmlType(new QName(EAIPropertiesFromDB.ESBEnvelope_ns, ">>ESBEnvelopeResult>ESBHeader"));
...
/*     */   }
/*     */ 
/*     */   public ESBEnvelopeResultESBHeader(String ESBHdVer, Date srvDate, Time srvTime, String senderID, String receiverID, String srvOpName, String srvOpVer, String msgID, String corrID, String ESBRspCode, String ESBRspDec, String resField1, String resField2, String resField3, String resField4, String resField5)
/*     */   {
...
/*     */   {
/* 277 */     if (!(obj instanceof ESBEnvelopeResultESBHeader)) return false;
/* 278 */     ESBEnvelopeResultESBHeader other = (ESBEnvelopeResultESBHeader)obj;
 ...
 * Qualified Name:     com.sinosoft.banklns.lnsmodel.webservice.eai.ESBEnvelopeResultESBHeader
