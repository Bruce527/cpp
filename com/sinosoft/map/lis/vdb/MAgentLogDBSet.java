...
/*  28 */     this.db = new DBOper(this.con, "MAgentLog");
/*  29 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public MAgentLogDBSet()
/*     */   {
/*  34 */     this.db = new DBOper("MAgentLog");
...
/*  49 */     tError.moduleName = "MAgentLogDBSet";
...
/*     */     {
/*  68 */       int tCount = size();
/*  69 */       pstmt = this.con.prepareStatement("DELETE FROM MAgentLog WHERE  ID = ?");
...
/*  86 */       tError.moduleName = "MAgentLogDBSet";
...
/*     */     {
/* 124 */       int tCount = size();
/* 125 */       pstmt = this.con.prepareStatement("UPDATE MAgentLog SET  ID = ? , AgentCode = ? , UserType = ? , TraceType = ? , MenuID = ? , MenuName = ? , Operation = ? , Discription = ? , CientIP = ? , MakeDate = ? , MakeTime = ? WHERE  ID = ?");
...
/* 198 */       tError.moduleName = "MAgentLogDBSet";
...
/*     */     {
/* 236 */       int tCount = size();
/* 237 */       pstmt = this.con.prepareStatement("INSERT INTO MAgentLog VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/*     */         }
/* 245 */         if ((get(i).getAgentCode() == null) || (get(i).getAgentCode().equals("null")))
/* 246 */           pstmt.setString(2, null);
/*     */         else {
/* 248 */           pstmt.setString(2, get(i).getAgentCode());
/*     */         }
...
/* 304 */       tError.moduleName = "MAgentLogDBSet";
 ...
 * Qualified Name:     com.sinosoft.map.lis.vdb.MAgentLogDBSet
