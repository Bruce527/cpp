...
/*  28 */     this.db = new DBOper(this.con, "MAgentLoginLog");
/*  29 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public MAgentLoginLogDBSet()
/*     */   {
/*  34 */     this.db = new DBOper("MAgentLoginLog");
...
/*  49 */     tError.moduleName = "MAgentLoginLogDBSet";
...
/*     */     {
/*  68 */       int tCount = size();
/*  69 */       pstmt = this.con.prepareStatement("DELETE FROM MAgentLoginLog WHERE  ID = ?");
...
/*  86 */       tError.moduleName = "MAgentLoginLogDBSet";
...
/*     */     {
/* 124 */       int tCount = size();
/* 125 */       pstmt = this.con.prepareStatement("UPDATE MAgentLoginLog SET  ID = ? , AgentCode = ? , UserType = ? , ClientName = ? , ClientType = ? , ClientIP = ? , LoginDate = ? , LoginTime = ? , LogoutDate = ? , LogoutTime = ? WHERE  ID = ?");
...
/* 183 */       tError.moduleName = "MAgentLoginLogDBSet";
...
/*     */     {
/* 221 */       int tCount = size();
/* 222 */       pstmt = this.con.prepareStatement("INSERT INTO MAgentLoginLog VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/* 274 */       tError.moduleName = "MAgentLoginLogDBSet";
 ...
 * Qualified Name:     com.sinosoft.map.lis.vdb.MAgentLoginLogDBSet
