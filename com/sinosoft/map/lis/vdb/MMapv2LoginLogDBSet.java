...
/*     */ 
/*     */ public class MMapv2LoginLogDBSet extends MMapv2LoginLogSet
/*     */ {
/*     */   private Connection con;
/*     */   private DBOper db;
/*  21 */   private boolean mflag = false;
/*     */ 
/*     */   public MMapv2LoginLogDBSet(Connection tConnection)
/*     */   {
/*  27 */     this.con = tConnection;
/*  28 */     this.db = new DBOper(this.con, "MMapv2LoginLog");
/*  29 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public MMapv2LoginLogDBSet()
/*     */   {
/*  34 */     this.db = new DBOper("MMapv2LoginLog");
...
/*  49 */     tError.moduleName = "MMapv2LoginLogDBSet";
...
/*     */     {
/*  68 */       int tCount = size();
/*  69 */       pstmt = this.con.prepareStatement("DELETE FROM MMapv2LoginLog WHERE  ID = ?");
...
/*  86 */       tError.moduleName = "MMapv2LoginLogDBSet";
...
/*     */     {
/* 124 */       int tCount = size();
/* 125 */       pstmt = this.con.prepareStatement("UPDATE MMapv2LoginLog SET  ID = ? , UserCode = ? , UserType = ? , ClientName = ? , ClientType = ? , ClientIP = ? , LoginDate = ? , LoginTime = ? , LogoutDate = ? , LogoutTime = ? WHERE  ID = ?");
...
/* 193 */       tError.moduleName = "MMapv2LoginLogDBSet";
...
/*     */     {
/* 231 */       int tCount = size();
/* 232 */       pstmt = this.con.prepareStatement("INSERT INTO MMapv2LoginLog VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/*     */         }
/* 240 */         if ((get(i).getUserCode() == null) || (get(i).getUserCode().equals("null")))
/* 241 */           pstmt.setString(2, null);
/*     */         else {
/* 243 */           pstmt.setString(2, get(i).getUserCode());
/*     */         }
...
/* 294 */       tError.moduleName = "MMapv2LoginLogDBSet";
 ...
 * Qualified Name:     com.sinosoft.map.lis.vdb.MMapv2LoginLogDBSet
