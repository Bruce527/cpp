...
/*  28 */     this.db = new DBOper(this.con, "MAdminLoginLog");
/*  29 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public MAdminLoginLogDBSet()
/*     */   {
/*  34 */     this.db = new DBOper("MAdminLoginLog");
...
/*  49 */     tError.moduleName = "MAdminLoginLogDBSet";
...
/*     */     {
/*  68 */       int tCount = size();
/*  69 */       pstmt = this.con.prepareStatement("DELETE FROM MAdminLoginLog WHERE  ID = ?");
...
/*  86 */       tError.moduleName = "MAdminLoginLogDBSet";
...
/*     */     {
/* 124 */       int tCount = size();
/* 125 */       pstmt = this.con.prepareStatement("UPDATE MAdminLoginLog SET  ID = ? , AgentCode = ? , UserType = ? , ClientName = ? , ClientType = ? , ClientIP = ? , LoginDate = ? , LoginTime = ? , LogoutDate = ? , LogoutTime = ? WHERE  ID = ?");
...
/* 193 */       tError.moduleName = "MAdminLoginLogDBSet";
...
/*     */     {
/* 231 */       int tCount = size();
/* 232 */       pstmt = this.con.prepareStatement("INSERT INTO MAdminLoginLog VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/* 294 */       tError.moduleName = "MAdminLoginLogDBSet";
 ...
 * Qualified Name:     com.sinosoft.map.lis.vdb.MAdminLoginLogDBSet
