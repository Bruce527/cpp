...
/*   32 */     this.db = new DBOper(this.con, "MMapv2AdminLoginLog");
/*   33 */     this.mflag = true;
/*      */   }
/*      */ 
...
/*      */   {
/*   38 */     this.con = null;
/*   39 */     this.db = new DBOper("MMapv2AdminLoginLog");
/*   40 */     this.mflag = false;
/*      */   }
/*      */ 
/*      */   public boolean deleteSQL()
/*      */   {
/*   46 */     MMapv2AdminLoginLogSchema tSchema = getSchema();
...
/*   56 */     tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*      */   public int getCount()
/*      */   {
/*   66 */     MMapv2AdminLoginLogSchema tSchema = getSchema();
/*      */ 
...
/*   74 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*      */     try
/*      */     {
/*   95 */       pstmt = this.con.prepareStatement("DELETE FROM MMapv2AdminLoginLog WHERE  ID = ?");
...
/*  107 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*      */     try
/*      */     {
/*  144 */       pstmt = this.con.prepareStatement("UPDATE MMapv2AdminLoginLog SET  ID = ? , AgentCode = ? , UserType = ? , ClientName = ? , ClientType = ? , ClientIP = ? , LoginDate = ? , LoginTime = ? , LogoutDate = ? , LogoutTime = ? WHERE  ID = ?");
...
/*  207 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*      */     try
/*      */     {
/*  244 */       pstmt = this.con.prepareStatement("INSERT INTO MMapv2AdminLoginLog VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
/*  245 */       if ((getID() == null) || (getID().equals("null")))
/*  246 */         pstmt.setNull(1, 12);
/*      */       else {
/*  248 */         pstmt.setString(1, getID());
/*      */       }
/*  250 */       if ((getAgentCode() == null) || (getAgentCode().equals("null")))
/*  251 */         pstmt.setNull(2, 12);
/*      */       else {
/*  253 */         pstmt.setString(2, getAgentCode());
/*      */       }
...
/*  302 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*      */     try
/*      */     {
/*  340 */       pstmt = this.con.prepareStatement("SELECT * FROM MMapv2AdminLoginLog WHERE  ID = ?", 
/*  341 */         1003, 1007);
...
/*  356 */           tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*  396 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*  431 */     MMapv2AdminLoginLogSet aMMapv2AdminLoginLogSet = new MMapv2AdminLoginLogSet();
/*      */ 
/*  433 */     if (!this.mflag) {
...
/*  440 */       SQLString sqlObj = new SQLString("MMapv2AdminLoginLog");
/*  441 */       MMapv2AdminLoginLogSchema aSchema = getSchema();
...
/*      */       {
/*  449 */         i++;
/*  450 */         MMapv2AdminLoginLogSchema s1 = new MMapv2AdminLoginLogSchema();
/*  451 */         s1.setSchema(rs, i);
/*  452 */         aMMapv2AdminLoginLogSet.add(s1);
/*      */       }try {
...
/*  461 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*      */       }
/*      */     }
/*  488 */     return aMMapv2AdminLoginLogSet;
/*      */   }
/*      */ 
...
/*  495 */     MMapv2AdminLoginLogSet aMMapv2AdminLoginLogSet = new MMapv2AdminLoginLogSet();
/*      */ 
/*  497 */     if (!this.mflag) {
...
/*  529 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*      */       }
/*      */     }
/*  556 */     return aMMapv2AdminLoginLogSet;
/*      */   }
/*      */ 
...
/*  563 */     MMapv2AdminLoginLogSet aMMapv2AdminLoginLogSet = new MMapv2AdminLoginLogSet();
/*      */ 
/*  565 */     if (!this.mflag) {
...
/*  572 */       SQLString sqlObj = new SQLString("MMapv2AdminLoginLog");
/*  573 */       MMapv2AdminLoginLogSchema aSchema = getSchema();
...
/*      */           break;
/*      */         }
/*  591 */         MMapv2AdminLoginLogSchema s1 = new MMapv2AdminLoginLogSchema();
/*  592 */         s1.setSchema(rs, i);
/*  593 */         aMMapv2AdminLoginLogSet.add(s1);
/*      */       }try {
...
/*  602 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*      */       }
/*      */     }
/*  629 */     return aMMapv2AdminLoginLogSet;
/*      */   }
/*      */ 
...
/*  636 */     MMapv2AdminLoginLogSet aMMapv2AdminLoginLogSet = new MMapv2AdminLoginLogSet();
/*      */ 
/*  638 */     if (!this.mflag) {
...
/*  679 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*      */       }
/*      */     }
/*  706 */     return aMMapv2AdminLoginLogSet;
/*      */   }
/*      */ 
...
/*  720 */       SQLString sqlObj = new SQLString("MMapv2AdminLoginLog");
/*  721 */       MMapv2AdminLoginLogSchema aSchema = getSchema();
/*  722 */       sqlObj.setSQL(2, aSchema);
/*  723 */       String sql = "update MMapv2AdminLoginLog " + sqlObj.getUpdPart() + " where " + strWherePart;
/*      */ 
/*  725 */       int operCount = stmt.executeUpdate(sql);
/*  726 */       if (operCount == 0)
/*      */       {
/*  729 */         CError tError = new CError();
/*  730 */         tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*  750 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*  787 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*  807 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*  854 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*  867 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*      */   {
/*  901 */     int tCount = 0;
/*  902 */     MMapv2AdminLoginLogSet tMMapv2AdminLoginLogSet = new MMapv2AdminLoginLogSet();
/*  903 */     MMapv2AdminLoginLogSchema tMMapv2AdminLoginLogSchema = null;
/*  904 */     if (this.mResultSet == null)
/*      */     {
/*  906 */       CError tError = new CError();
/*  907 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*      */     {
/*  915 */       tCount = 1;
/*  916 */       tMMapv2AdminLoginLogSchema = new MMapv2AdminLoginLogSchema();
/*  917 */       tMMapv2AdminLoginLogSchema.setSchema(this.mResultSet, 1);
/*  918 */       tMMapv2AdminLoginLogSet.add(tMMapv2AdminLoginLogSchema);
/*      */ 
/*  920 */       while (tCount++ < 5000)
/*      */       {
/*  922 */         if (!this.mResultSet.next())
/*      */           continue;
/*  924 */         tMMapv2AdminLoginLogSchema = new MMapv2AdminLoginLogSchema();
/*  925 */         tMMapv2AdminLoginLogSchema.setSchema(this.mResultSet, 1);
/*  926 */         tMMapv2AdminLoginLogSet.add(tMMapv2AdminLoginLogSchema);
/*      */       }
/*      */ 
/*      */     }
/*      */     catch (Exception ex)
...
/*  933 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*  960 */       return null;
/*      */     }
/*  962 */     return tMMapv2AdminLoginLogSet;
/*      */   }
/*      */ 
...
/*  973 */         tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*  988 */       tError.moduleName = "MMapv2AdminLoginLogDB";
...
/*  999 */         tError.moduleName = "MMapv2AdminLoginLogDB";
...
/* 1014 */       tError.moduleName = "MMapv2AdminLoginLogDB";
 ...
 * Qualified Name:     com.sinosoft.map.lis.db.MMapv2AdminLoginLogDB
