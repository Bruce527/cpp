...
/*   32 */     this.db = new DBOper(this.con, "MAdminLoginLog");
/*   33 */     this.mflag = true;
/*      */   }
/*      */ 
...
/*      */   {
/*   38 */     this.con = null;
/*   39 */     this.db = new DBOper("MAdminLoginLog");
/*   40 */     this.mflag = false;
/*      */   }
/*      */ 
/*      */   public boolean deleteSQL()
/*      */   {
/*   46 */     MAdminLoginLogSchema tSchema = getSchema();
...
/*   56 */     tError.moduleName = "MAdminLoginLogDB";
...
/*      */   public int getCount()
/*      */   {
/*   66 */     MAdminLoginLogSchema tSchema = getSchema();
/*      */ 
...
/*   74 */       tError.moduleName = "MAdminLoginLogDB";
...
/*      */     try
/*      */     {
/*   95 */       pstmt = this.con.prepareStatement("DELETE FROM MAdminLoginLog WHERE  ID = ?");
...
/*  107 */       tError.moduleName = "MAdminLoginLogDB";
...
/*      */     try
/*      */     {
/*  144 */       pstmt = this.con.prepareStatement("UPDATE MAdminLoginLog SET  ID = ? , AgentCode = ? , UserType = ? , ClientName = ? , ClientType = ? , ClientIP = ? , LoginDate = ? , LoginTime = ? , LogoutDate = ? , LogoutTime = ? WHERE  ID = ?");
...
/*  207 */       tError.moduleName = "MAdminLoginLogDB";
...
/*      */     try
/*      */     {
/*  244 */       pstmt = this.con.prepareStatement("INSERT INTO MAdminLoginLog VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
...
/*  302 */       tError.moduleName = "MAdminLoginLogDB";
...
/*      */     try
/*      */     {
/*  340 */       pstmt = this.con.prepareStatement("SELECT * FROM MAdminLoginLog WHERE  ID = ?", 
/*  341 */         1003, 1007);
...
/*  356 */           tError.moduleName = "MAdminLoginLogDB";
...
/*  396 */       tError.moduleName = "MAdminLoginLogDB";
...
/*  431 */     MAdminLoginLogSet aMAdminLoginLogSet = new MAdminLoginLogSet();
/*      */ 
/*  433 */     if (!this.mflag) {
...
/*  440 */       SQLString sqlObj = new SQLString("MAdminLoginLog");
/*  441 */       MAdminLoginLogSchema aSchema = getSchema();
...
/*      */       {
/*  449 */         i++;
/*  450 */         MAdminLoginLogSchema s1 = new MAdminLoginLogSchema();
/*  451 */         s1.setSchema(rs, i);
/*  452 */         aMAdminLoginLogSet.add(s1);
/*      */       }try {
...
/*  461 */       tError.moduleName = "MAdminLoginLogDB";
...
/*  495 */     MAdminLoginLogSet aMAdminLoginLogSet = new MAdminLoginLogSet();
/*      */ 
/*  497 */     if (!this.mflag) {
...
/*  529 */       tError.moduleName = "MAdminLoginLogDB";
...
/*  563 */     MAdminLoginLogSet aMAdminLoginLogSet = new MAdminLoginLogSet();
/*      */ 
/*  565 */     if (!this.mflag) {
...
/*  572 */       SQLString sqlObj = new SQLString("MAdminLoginLog");
/*  573 */       MAdminLoginLogSchema aSchema = getSchema();
...
/*      */           break;
/*      */         }
/*  591 */         MAdminLoginLogSchema s1 = new MAdminLoginLogSchema();
/*  592 */         s1.setSchema(rs, i);
/*  593 */         aMAdminLoginLogSet.add(s1);
/*      */       }try {
...
/*  602 */       tError.moduleName = "MAdminLoginLogDB";
...
/*  636 */     MAdminLoginLogSet aMAdminLoginLogSet = new MAdminLoginLogSet();
/*      */ 
/*  638 */     if (!this.mflag) {
...
/*  679 */       tError.moduleName = "MAdminLoginLogDB";
...
/*  720 */       SQLString sqlObj = new SQLString("MAdminLoginLog");
/*  721 */       MAdminLoginLogSchema aSchema = getSchema();
/*  722 */       sqlObj.setSQL(2, aSchema);
/*  723 */       String sql = "update MAdminLoginLog " + sqlObj.getUpdPart() + " where " + strWherePart;
/*      */ 
/*  725 */       int operCount = stmt.executeUpdate(sql);
/*  726 */       if (operCount == 0)
/*      */       {
/*  729 */         CError tError = new CError();
/*  730 */         tError.moduleName = "MAdminLoginLogDB";
...
/*  750 */       tError.moduleName = "MAdminLoginLogDB";
...
/*  787 */       tError.moduleName = "MAdminLoginLogDB";
...
/*  807 */       tError.moduleName = "MAdminLoginLogDB";
...
/*  854 */       tError.moduleName = "MAdminLoginLogDB";
...
/*  867 */       tError.moduleName = "MAdminLoginLogDB";
...
/*      */   {
/*  901 */     int tCount = 0;
/*  902 */     MAdminLoginLogSet tMAdminLoginLogSet = new MAdminLoginLogSet();
/*  903 */     MAdminLoginLogSchema tMAdminLoginLogSchema = null;
/*  904 */     if (this.mResultSet == null)
/*      */     {
/*  906 */       CError tError = new CError();
/*  907 */       tError.moduleName = "MAdminLoginLogDB";
...
/*      */     {
/*  915 */       tCount = 1;
/*  916 */       tMAdminLoginLogSchema = new MAdminLoginLogSchema();
/*  917 */       tMAdminLoginLogSchema.setSchema(this.mResultSet, 1);
/*  918 */       tMAdminLoginLogSet.add(tMAdminLoginLogSchema);
/*      */ 
/*  920 */       while (tCount++ < 5000)
/*      */       {
/*  922 */         if (!this.mResultSet.next())
/*      */           continue;
/*  924 */         tMAdminLoginLogSchema = new MAdminLoginLogSchema();
/*  925 */         tMAdminLoginLogSchema.setSchema(this.mResultSet, 1);
/*  926 */         tMAdminLoginLogSet.add(tMAdminLoginLogSchema);
/*      */       }
/*      */ 
/*      */     }
/*      */     catch (Exception ex)
...
/*  933 */       tError.moduleName = "MAdminLoginLogDB";
...
/*  973 */         tError.moduleName = "MAdminLoginLogDB";
...
/*  988 */       tError.moduleName = "MAdminLoginLogDB";
...
/*  999 */         tError.moduleName = "MAdminLoginLogDB";
...
/* 1014 */       tError.moduleName = "MAdminLoginLogDB";
 ...
 * Qualified Name:     com.sinosoft.map.lis.db.MAdminLoginLogDB
