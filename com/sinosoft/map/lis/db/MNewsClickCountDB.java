...
/*     */ 
/*     */ public class MNewsClickCountDB extends MNewsClickCountSchema
/*     */ {
...
/*     */ 
/*     */   public MNewsClickCountDB(Connection tConnection)
/*     */   {
/*  31 */     this.con = tConnection;
/*  32 */     this.db = new DBOper(this.con, "MNewsClickCount");
/*  33 */     this.mflag = true;
/*     */   }
/*     */ 
/*     */   public MNewsClickCountDB()
/*     */   {
/*  38 */     this.con = null;
/*  39 */     this.db = new DBOper("MNewsClickCount");
/*  40 */     this.mflag = false;
/*     */   }
/*     */ 
/*     */   public boolean deleteSQL()
/*     */   {
/*  46 */     MNewsClickCountSchema tSchema = getSchema();
...
/*  56 */     tError.moduleName = "MNewsClickCountDB";
...
/*     */   public int getCount()
/*     */   {
/*  66 */     MNewsClickCountSchema tSchema = getSchema();
/*     */ 
...
/*  74 */       tError.moduleName = "MNewsClickCountDB";
...
/*     */     try
/*     */     {
/*  95 */       pstmt = this.con.prepareStatement("DELETE FROM MNewsClickCount WHERE  NewsID = ?");
/*  96 */       if ((getNewsID() == null) || (getNewsID().equals("null")))
/*  97 */         pstmt.setNull(1, 12);
/*     */       else {
/*  99 */         pstmt.setString(1, getNewsID());
/*     */       }
...
/* 107 */       tError.moduleName = "MNewsClickCountDB";
...
/*     */     try
/*     */     {
/* 144 */       pstmt = this.con.prepareStatement("UPDATE MNewsClickCount SET  NewsID = ? , ClickRate = ? WHERE  NewsID = ?");
/* 145 */       if ((getNewsID() == null) || (getNewsID().equals("null")))
/* 146 */         pstmt.setNull(1, 12);
/*     */       else {
/* 148 */         pstmt.setString(1, getNewsID());
/*     */       }
/* 150 */       pstmt.setDouble(2, getClickRate());
/*     */ 
/* 152 */       if ((getNewsID() == null) || (getNewsID().equals("null")))
/* 153 */         pstmt.setNull(3, 12);
/*     */       else {
/* 155 */         pstmt.setString(3, getNewsID());
/*     */       }
...
/* 163 */       tError.moduleName = "MNewsClickCountDB";
...
/*     */     try
/*     */     {
/* 200 */       pstmt = this.con.prepareStatement("INSERT INTO MNewsClickCount VALUES( ? , ?)");
/* 201 */       if ((getNewsID() == null) || (getNewsID().equals("null")))
/* 202 */         pstmt.setNull(1, 12);
/*     */       else {
/* 204 */         pstmt.setString(1, getNewsID());
/*     */       }
/* 206 */       pstmt.setDouble(2, getClickRate());
/*     */ 
...
/* 214 */       tError.moduleName = "MNewsClickCountDB";
...
/*     */     try
/*     */     {
/* 252 */       pstmt = this.con.prepareStatement("SELECT * FROM MNewsClickCount WHERE  NewsID = ?", 
/* 253 */         1003, 1007);
/* 254 */       if ((getNewsID() == null) || (getNewsID().equals("null")))
/* 255 */         pstmt.setNull(1, 12);
/*     */       else {
/* 257 */         pstmt.setString(1, getNewsID());
/*     */       }
...
/* 268 */           tError.moduleName = "MNewsClickCountDB";
...
/* 308 */       tError.moduleName = "MNewsClickCountDB";
...
/*     */   }
/*     */ 
/*     */   public MNewsClickCountSet query()
/*     */   {
/* 341 */     Statement stmt = null;
/* 342 */     ResultSet rs = null;
/* 343 */     MNewsClickCountSet aMNewsClickCountSet = new MNewsClickCountSet();
/*     */ 
/* 345 */     if (!this.mflag) {
...
/* 352 */       SQLString sqlObj = new SQLString("MNewsClickCount");
/* 353 */       MNewsClickCountSchema aSchema = getSchema();
...
/*     */       {
/* 361 */         i++;
/* 362 */         MNewsClickCountSchema s1 = new MNewsClickCountSchema();
/* 363 */         s1.setSchema(rs, i);
/* 364 */         aMNewsClickCountSet.add(s1);
/*     */       }try {
...
/* 373 */       tError.moduleName = "MNewsClickCountDB";
...
/*     */       }
/*     */     }
/* 400 */     return aMNewsClickCountSet;
/*     */   }
/*     */ 
/*     */   public MNewsClickCountSet executeQuery(String sql)
/*     */   {
/* 405 */     Statement stmt = null;
/* 406 */     ResultSet rs = null;
/* 407 */     MNewsClickCountSet aMNewsClickCountSet = new MNewsClickCountSet();
/*     */ 
/* 409 */     if (!this.mflag) {
...
/* 441 */       tError.moduleName = "MNewsClickCountDB";
...
/*     */       }
/*     */     }
/* 468 */     return aMNewsClickCountSet;
/*     */   }
/*     */ 
/*     */   public MNewsClickCountSet query(int nStart, int nCount)
/*     */   {
/* 473 */     Statement stmt = null;
/* 474 */     ResultSet rs = null;
/* 475 */     MNewsClickCountSet aMNewsClickCountSet = new MNewsClickCountSet();
/*     */ 
/* 477 */     if (!this.mflag) {
...
/* 484 */       SQLString sqlObj = new SQLString("MNewsClickCount");
/* 485 */       MNewsClickCountSchema aSchema = getSchema();
...
/*     */           break;
/*     */         }
/* 503 */         MNewsClickCountSchema s1 = new MNewsClickCountSchema();
/* 504 */         s1.setSchema(rs, i);
/* 505 */         aMNewsClickCountSet.add(s1);
/*     */       }try {
...
/* 514 */       tError.moduleName = "MNewsClickCountDB";
...
/*     */       }
/*     */     }
/* 541 */     return aMNewsClickCountSet;
/*     */   }
/*     */ 
/*     */   public MNewsClickCountSet executeQuery(String sql, int nStart, int nCount)
/*     */   {
/* 546 */     Statement stmt = null;
/* 547 */     ResultSet rs = null;
/* 548 */     MNewsClickCountSet aMNewsClickCountSet = new MNewsClickCountSet();
/*     */ 
/* 550 */     if (!this.mflag) {
...
/* 591 */       tError.moduleName = "MNewsClickCountDB";
...
/*     */       }
/*     */     }
/* 618 */     return aMNewsClickCountSet;
/*     */   }
/*     */ 
...
/* 632 */       SQLString sqlObj = new SQLString("MNewsClickCount");
/* 633 */       MNewsClickCountSchema aSchema = getSchema();
/* 634 */       sqlObj.setSQL(2, aSchema);
/* 635 */       String sql = "update MNewsClickCount " + sqlObj.getUpdPart() + " where " + strWherePart;
/*     */ 
/* 637 */       int operCount = stmt.executeUpdate(sql);
/* 638 */       if (operCount == 0)
/*     */       {
/* 641 */         CError tError = new CError();
/* 642 */         tError.moduleName = "MNewsClickCountDB";
...
/* 662 */       tError.moduleName = "MNewsClickCountDB";
...
/* 699 */       tError.moduleName = "MNewsClickCountDB";
...
/* 719 */       tError.moduleName = "MNewsClickCountDB";
...
/* 766 */       tError.moduleName = "MNewsClickCountDB";
...
/* 779 */       tError.moduleName = "MNewsClickCountDB";
...
/*     */   }
/*     */ 
/*     */   public MNewsClickCountSet getData()
/*     */   {
/* 813 */     int tCount = 0;
/* 814 */     MNewsClickCountSet tMNewsClickCountSet = new MNewsClickCountSet();
/* 815 */     MNewsClickCountSchema tMNewsClickCountSchema = null;
/* 816 */     if (this.mResultSet == null)
/*     */     {
/* 818 */       CError tError = new CError();
/* 819 */       tError.moduleName = "MNewsClickCountDB";
...
/*     */     {
/* 827 */       tCount = 1;
/* 828 */       tMNewsClickCountSchema = new MNewsClickCountSchema();
/* 829 */       tMNewsClickCountSchema.setSchema(this.mResultSet, 1);
/* 830 */       tMNewsClickCountSet.add(tMNewsClickCountSchema);
/*     */ 
/* 832 */       while (tCount++ < 5000)
/*     */       {
/* 834 */         if (!this.mResultSet.next())
/*     */           continue;
/* 836 */         tMNewsClickCountSchema = new MNewsClickCountSchema();
/* 837 */         tMNewsClickCountSchema.setSchema(this.mResultSet, 1);
/* 838 */         tMNewsClickCountSet.add(tMNewsClickCountSchema);
/*     */       }
/*     */ 
/*     */     }
/*     */     catch (Exception ex)
...
/* 845 */       tError.moduleName = "MNewsClickCountDB";
...
/* 872 */       return null;
/*     */     }
/* 874 */     return tMNewsClickCountSet;
/*     */   }
/*     */ 
...
/* 885 */         tError.moduleName = "MNewsClickCountDB";
...
/* 900 */       tError.moduleName = "MNewsClickCountDB";
...
/* 911 */         tError.moduleName = "MNewsClickCountDB";
...
/* 926 */       tError.moduleName = "MNewsClickCountDB";
 ...
 * Qualified Name:     com.sinosoft.map.lis.db.MNewsClickCountDB
