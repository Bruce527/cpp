...
/*    */ 
/*    */ public class MRoleInfoBSet extends SchemaSet
/*    */ {
/*    */   public boolean add(MRoleInfoBSchema aSchema)
/*    */   {
/* 17 */     return super.add(aSchema);
/*    */   }
/*    */ 
/*    */   public boolean add(MRoleInfoBSet aSet)
/*    */   {
/* 22 */     return super.add(aSet);
/*    */   }
/*    */ 
/*    */   public boolean remove(MRoleInfoBSchema aSchema)
/*    */   {
/* 27 */     return super.remove(aSchema);
/*    */   }
/*    */ 
/*    */   public MRoleInfoBSchema get(int index)
/*    */   {
/* 32 */     MRoleInfoBSchema tSchema = (MRoleInfoBSchema)super.getObj(index);
/* 33 */     return tSchema;
/*    */   }
/*    */ 
/*    */   public boolean set(int index, MRoleInfoBSchema aSchema)
/*    */   {
/* 38 */     return super.set(index, aSchema);
/*    */   }
/*    */ 
/*    */   public boolean set(MRoleInfoBSet aSet)
/*    */   {
...
/*    */     {
/* 53 */       MRoleInfoBSchema aSchema = get(i);
...
/* 68 */     while (nEndPos != -1)
/*    */     {
/* 70 */       MRoleInfoBSchema aSchema = new MRoleInfoBSchema();
...
/*    */       }
/*    */     }
/* 84 */     MRoleInfoBSchema tSchema = new MRoleInfoBSchema();
 ...
 * Qualified Name:     com.sinosoft.map.lis.vschema.MRoleInfoBSet
