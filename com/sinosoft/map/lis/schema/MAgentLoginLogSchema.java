...
/*     */ 
/*     */ import com.sinosoft.map.lis.db.MAgentLoginLogDB;
...
/*     */ 
/*     */ public class MAgentLoginLogSchema
...
/*     */   {
/*  63 */     MAgentLoginLogSchema cloned = (MAgentLoginLogSchema)super.clone();
...
/*     */   }
/*     */ 
/*     */   public void setSchema(MAgentLoginLogSchema aMAgentLoginLogSchema)
/*     */   {
/* 185 */     this.iD = aMAgentLoginLogSchema.getID();
/* 186 */     this.agentCode = aMAgentLoginLogSchema.getAgentCode();
/* 187 */     this.userType = aMAgentLoginLogSchema.getUserType();
/* 188 */     this.clientName = aMAgentLoginLogSchema.getClientName();
/* 189 */     this.clientType = aMAgentLoginLogSchema.getClientType();
/* 190 */     this.clientIP = aMAgentLoginLogSchema.getClientIP();
/* 191 */     this.loginDate = this.fDate.getDate(aMAgentLoginLogSchema.getLoginDate());
/* 192 */     this.loginTime = aMAgentLoginLogSchema.getLoginTime();
/* 193 */     this.logoutDate = this.fDate.getDate(aMAgentLoginLogSchema.getLogoutDate());
/* 194 */     this.logoutTime = aMAgentLoginLogSchema.getLogoutTime();
/*     */   }
/*     */ 
...
/*     */     {
/* 248 */       System.out.println("\u6570\u636E\u5E93\u4E2D\u7684MAgentLoginLog\u8868\u5B57\u6BB5\u4E2A\u6570\u548CSchema\u4E2D\u7684\u5B57\u6BB5\u4E2A\u6570\u4E0D\u4E00\u81F4\uFF0C\u6216\u8005\u6267\u884Cdb.executeQuery\u67E5\u8BE2\u65F6\u6CA1\u6709\u4F7F\u7528select * from tables");
/*     */ 
/* 250 */       CError tError = new CError();
/* 251 */       tError.moduleName = "MAgentLoginLogSchema";
...
/*     */   }
/*     */ 
/*     */   public MAgentLoginLogSchema getSchema()
/*     */   {
/* 262 */     MAgentLoginLogSchema aMAgentLoginLogSchema = new MAgentLoginLogSchema();
/* 263 */     aMAgentLoginLogSchema.setSchema(this);
/* 264 */     return aMAgentLoginLogSchema;
/*     */   }
/*     */ 
/*     */   public MAgentLoginLogDB getDB()
/*     */   {
/* 269 */     MAgentLoginLogDB aDBOper = new MAgentLoginLogDB();
...
/* 312 */       tError.moduleName = "MAgentLoginLogSchema";
...
/* 523 */     MAgentLoginLogSchema other = (MAgentLoginLogSchema)otherObject;
 ...
 * Qualified Name:     com.sinosoft.map.lis.schema.MAgentLoginLogSchema
