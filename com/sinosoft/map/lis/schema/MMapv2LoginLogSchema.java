...
/*     */ 
/*     */ import com.sinosoft.map.lis.db.MMapv2LoginLogDB;
...
/*     */ 
/*     */ public class MMapv2LoginLogSchema
...
/*     */   {
/*  63 */     MMapv2LoginLogSchema cloned = (MMapv2LoginLogSchema)super.clone();
...
/*     */   }
/*     */ 
/*     */   public void setSchema(MMapv2LoginLogSchema aMMapv2LoginLogSchema)
/*     */   {
/* 185 */     this.iD = aMMapv2LoginLogSchema.getID();
/* 186 */     this.userCode = aMMapv2LoginLogSchema.getUserCode();
/* 187 */     this.userType = aMMapv2LoginLogSchema.getUserType();
/* 188 */     this.clientName = aMMapv2LoginLogSchema.getClientName();
/* 189 */     this.clientType = aMMapv2LoginLogSchema.getClientType();
/* 190 */     this.clientIP = aMMapv2LoginLogSchema.getClientIP();
/* 191 */     this.loginDate = this.fDate.getDate(aMMapv2LoginLogSchema.getLoginDate());
/* 192 */     this.loginTime = aMMapv2LoginLogSchema.getLoginTime();
/* 193 */     this.logoutDate = this.fDate.getDate(aMMapv2LoginLogSchema.getLogoutDate());
/* 194 */     this.logoutTime = aMMapv2LoginLogSchema.getLogoutTime();
/*     */   }
/*     */ 
...
/*     */     {
/* 248 */       System.out.println("\u6570\u636E\u5E93\u4E2D\u7684MMapv2LoginLog\u8868\u5B57\u6BB5\u4E2A\u6570\u548CSchema\u4E2D\u7684\u5B57\u6BB5\u4E2A\u6570\u4E0D\u4E00\u81F4\uFF0C\u6216\u8005\u6267\u884Cdb.executeQuery\u67E5\u8BE2\u65F6\u6CA1\u6709\u4F7F\u7528select * from tables");
/*     */ 
/* 250 */       CError tError = new CError();
/* 251 */       tError.moduleName = "MMapv2LoginLogSchema";
...
/*     */   }
/*     */ 
/*     */   public MMapv2LoginLogSchema getSchema()
/*     */   {
/* 262 */     MMapv2LoginLogSchema aMMapv2LoginLogSchema = new MMapv2LoginLogSchema();
/* 263 */     aMMapv2LoginLogSchema.setSchema(this);
/* 264 */     return aMMapv2LoginLogSchema;
/*     */   }
/*     */ 
/*     */   public MMapv2LoginLogDB getDB()
/*     */   {
/* 269 */     MMapv2LoginLogDB aDBOper = new MMapv2LoginLogDB();
...
/* 312 */       tError.moduleName = "MMapv2LoginLogSchema";
...
/* 523 */     MMapv2LoginLogSchema other = (MMapv2LoginLogSchema)otherObject;
 ...
 * Qualified Name:     com.sinosoft.map.lis.schema.MMapv2LoginLogSchema
