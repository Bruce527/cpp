...
/*     */ 
/*     */ import com.sinosoft.map.lis.db.MAdminLoginLogDB;
...
/*     */ 
/*     */ public class MAdminLoginLogSchema
...
/*     */   {
/*  63 */     MAdminLoginLogSchema cloned = (MAdminLoginLogSchema)super.clone();
...
/*     */   }
/*     */ 
/*     */   public void setSchema(MAdminLoginLogSchema aMAdminLoginLogSchema)
/*     */   {
/* 185 */     this.iD = aMAdminLoginLogSchema.getID();
/* 186 */     this.agentCode = aMAdminLoginLogSchema.getAgentCode();
/* 187 */     this.userType = aMAdminLoginLogSchema.getUserType();
/* 188 */     this.clientName = aMAdminLoginLogSchema.getClientName();
/* 189 */     this.clientType = aMAdminLoginLogSchema.getClientType();
/* 190 */     this.clientIP = aMAdminLoginLogSchema.getClientIP();
/* 191 */     this.loginDate = this.fDate.getDate(aMAdminLoginLogSchema.getLoginDate());
/* 192 */     this.loginTime = aMAdminLoginLogSchema.getLoginTime();
/* 193 */     this.logoutDate = this.fDate.getDate(aMAdminLoginLogSchema.getLogoutDate());
/* 194 */     this.logoutTime = aMAdminLoginLogSchema.getLogoutTime();
/*     */   }
/*     */ 
...
/*     */     {
/* 248 */       System.out.println("\u6570\u636E\u5E93\u4E2D\u7684MAdminLoginLog\u8868\u5B57\u6BB5\u4E2A\u6570\u548CSchema\u4E2D\u7684\u5B57\u6BB5\u4E2A\u6570\u4E0D\u4E00\u81F4\uFF0C\u6216\u8005\u6267\u884Cdb.executeQuery\u67E5\u8BE2\u65F6\u6CA1\u6709\u4F7F\u7528select * from tables");
/*     */ 
/* 250 */       CError tError = new CError();
/* 251 */       tError.moduleName = "MAdminLoginLogSchema";
...
/*     */   }
/*     */ 
/*     */   public MAdminLoginLogSchema getSchema()
/*     */   {
/* 262 */     MAdminLoginLogSchema aMAdminLoginLogSchema = new MAdminLoginLogSchema();
/* 263 */     aMAdminLoginLogSchema.setSchema(this);
/* 264 */     return aMAdminLoginLogSchema;
/*     */   }
/*     */ 
/*     */   public MAdminLoginLogDB getDB()
/*     */   {
/* 269 */     MAdminLoginLogDB aDBOper = new MAdminLoginLogDB();
...
/* 312 */       tError.moduleName = "MAdminLoginLogSchema";
...
/* 523 */     MAdminLoginLogSchema other = (MAdminLoginLogSchema)otherObject;
 ...
 * Qualified Name:     com.sinosoft.map.lis.schema.MAdminLoginLogSchema
