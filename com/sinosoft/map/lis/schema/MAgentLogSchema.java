...
/*     */   {
/*  65 */     MAgentLogSchema cloned = (MAgentLogSchema)super.clone();
...
/*  87 */     return this.agentCode;
/*     */   }
/*     */ 
/*     */   public void setAgentCode(String aAgentCode) {
/*  91 */     this.agentCode = aAgentCode;
/*     */   }
/*     */ 
...
/*     */   {
/* 182 */     this.iD = aMAgentLogSchema.getID();
/* 183 */     this.agentCode = aMAgentLogSchema.getAgentCode();
/* 184 */     this.userType = aMAgentLogSchema.getUserType();
/* 185 */     this.traceType = aMAgentLogSchema.getTraceType();
/* 186 */     this.menuID = aMAgentLogSchema.getMenuID();
/* 187 */     this.menuName = aMAgentLogSchema.getMenuName();
/* 188 */     this.operation = aMAgentLogSchema.getOperation();
/* 189 */     this.discription = aMAgentLogSchema.getDiscription();
/* 190 */     this.cientIP = aMAgentLogSchema.getCientIP();
/* 191 */     this.makeDate = this.fDate.getDate(aMAgentLogSchema.getMakeDate());
/* 192 */     this.makeTime = aMAgentLogSchema.getMakeTime();
/*     */   }
/*     */ 
...
/*     */       }
/* 206 */       if (rs.getString("AgentCode") == null)
/* 207 */         this.agentCode = null;
/*     */       else {
/* 209 */         this.agentCode = rs.getString("AgentCode").trim();
/*     */       }
...
/*     */     {
/* 255 */       System.out.println("\u6570\u636E\u5E93\u4E2D\u7684MAgentLog\u8868\u5B57\u6BB5\u4E2A\u6570\u548CSchema\u4E2D\u7684\u5B57\u6BB5\u4E2A\u6570\u4E0D\u4E00\u81F4\uFF0C\u6216\u8005\u6267\u884Cdb.executeQuery\u67E5\u8BE2\u65F6\u6CA1\u6709\u4F7F\u7528select * from tables");
/*     */ 
/* 257 */       CError tError = new CError();
/* 258 */       tError.moduleName = "MAgentLogSchema";
...
/*     */   {
/* 269 */     MAgentLogSchema aMAgentLogSchema = new MAgentLogSchema();
/* 270 */     aMAgentLogSchema.setSchema(this);
/* 271 */     return aMAgentLogSchema;
/*     */   }
/*     */ 
/*     */   public MAgentLogDB getDB()
/*     */   {
/* 276 */     MAgentLogDB aDBOper = new MAgentLogDB();
...
/* 287 */     strReturn.append(StrTool.cTrim(this.agentCode)); strReturn.append("|");
...
/* 306 */       this.agentCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, "|");
...
/* 321 */       tError.moduleName = "MAgentLogSchema";
...
/*     */     }
/* 339 */     if (FCode.equalsIgnoreCase("agentCode"))
/*     */     {
/* 341 */       strReturn = StrTool.GBKToUnicode(String.valueOf(this.agentCode));
/*     */     }
...
/* 395 */       break;
/*     */     case 1:
/* 397 */       strFieldValue = StrTool.GBKToUnicode(this.agentCode);
/* 398 */       break;
/*     */     case 2:
...
/* 448 */         this.iD = null;
/*     */     }
/* 450 */     if (FCode.equalsIgnoreCase("agentCode"))
/*     */     {
/* 452 */       if ((FValue != null) && (!FValue.equals("")))
/*     */       {
/* 454 */         this.agentCode = FValue.trim();
/*     */       }
/*     */       else
/* 457 */         this.agentCode = null;
/*     */     }
...
/* 548 */     MAgentLogSchema other = (MAgentLogSchema)otherObject;
/* 549 */     if ((this.iD == null) && (other.getID() != null)) return false;
/* 550 */     if ((this.iD != null) && (!this.iD.equals(other.getID()))) return false;
/* 551 */     if ((this.agentCode == null) && (other.getAgentCode() != null)) return false;
/* 552 */     if ((this.agentCode != null) && (!this.agentCode.equals(other.getAgentCode()))) return false;
...
/* 584 */       return 0;
/*     */     }
/* 586 */     if (strFieldName.equals("agentCode")) {
/* 587 */       return 1;
/*     */     }
...
/* 667 */       return 0;
/*     */     }
/* 669 */     if (strFieldName.equals("agentCode")) {
/* 670 */       return 0;
/*     */     }
 ...
 * Qualified Name:     com.sinosoft.map.lis.schema.MAgentLogSchema
