...
/*     */ 
/*     */   public ECDBOper(Connection tConnection, String t)
/*     */   {
/*  25 */     this.con = tConnection;
/*  26 */     this.tableName = t;
/*     */   }
/*     */ 
/*     */   public ECDBOper(String t)
/*     */   {
/*  32 */     this.tableName = t;
/*  33 */     this.con = null;
/*  34 */     this.cflag = true;
...
/*     */   {
/*  41 */     return ECDBConnPool.getECConnection();
/*     */   }
/*     */ 
...
/*  51 */     if (this.cflag)
/*     */     {
/*  53 */       this.con = ECDBConnPool.getECConnection();
/*     */     }
/*     */ 
/*  56 */     if (this.con == null)
/*     */     {
...
/* 139 */     if (this.cflag)
/*     */     {
/* 141 */       this.con = ECDBConnPool.getECConnection();
/*     */     }
...
/* 239 */     if (this.cflag)
/*     */     {
/* 241 */       this.con = ECDBConnPool.getECConnection();
/*     */     }
/*     */ 
...
/* 327 */     if (this.cflag)
/*     */     {
/* 329 */       this.con = ECDBConnPool.getECConnection();
/*     */     }
/*     */ 
...
/* 417 */     if (this.cflag)
/*     */     {
/* 419 */       this.con = ECDBConnPool.getECConnection();
/*     */     }
/*     */ 
...
/* 519 */     if (this.cflag)
/*     */     {
/* 521 */       this.con = ECDBConnPool.getECConnection();
/*     */     }
/*     */ 
...
/* 637 */     if (this.cflag)
/*     */     {
/* 639 */       this.con = ECDBConnPool.getECConnection();
/*     */     }
/*     */ 
...
/* 711 */     if (this.cflag)
/*     */     {
/* 713 */       this.con = ECDBConnPool.getECConnection();
/*     */     }
/*     */ 
...
/* 801 */     if (this.cflag)
/*     */     {
/* 803 */       this.con = ECDBConnPool.getECConnection();
/*     */     }
/*     */ 
 ...
 * Qualified Name:     com.sinosoft.map.utility.ECDBOper
